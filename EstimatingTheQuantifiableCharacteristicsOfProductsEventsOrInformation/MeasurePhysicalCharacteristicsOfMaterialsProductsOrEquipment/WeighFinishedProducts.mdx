...
```mermaid
erDiagram
    FinishedProduct ||--o{ WeightReading : "contains"
    WeightReading }o--|| WeightSpecification : "tracks"
    WeightSpecification ||--o{ TareWeight : "references"
    TareWeight }o--|| WeightBatch : "generates"
    WeightBatch ||--o{ NonConformanceReport : "validates"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : productWeighed
    InProgress --> InProgress : netWeightCalculated
    InProgress --> InProgress : weightConformanceChecked
    InProgress --> Review : productRejected
    Review --> InProgress
    InProgress --> InProgress : batchWeightsRecorded
    InProgress --> InProgress : weightReportGenerated
