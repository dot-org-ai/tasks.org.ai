...
```mermaid
erDiagram
    Workpiece ||--o{ DimensionalMeasurement : "contains"
    DimensionalMeasurement }o--|| InspectionPlan : "tracks"
    InspectionPlan ||--o{ Tolerance : "references"
    Tolerance }o--|| GaugingInstrument : "generates"
    GaugingInstrument ||--o{ ConformanceReport : "validates"
```
...
stateDiagram-v2
    ...
    InProgress --> InProgress : conformanceEvaluated
    InProgress --> InProgress : nonConformanceRecorded
    InProgress --> Review : workpieceDispositioned
    Review --> InProgress
    InProgress --> InProgress : conformanceReportGenerated
    InProgress --> InProgress : inspectionPlanCreated
    InProgress --> Completed : instrumentCalibrated
    Completed --> [*]
```
## Workflow
