...
```mermaid
erDiagram
    Measurement ||--o{ MeasurementPoint : "contains"
    MeasurementPoint }o--|| ReferencePlan : "tracks"
    ReferencePlan ||--o{ MeasuringInstrument : "references"
    MeasuringInstrument }o--|| MeasurementSet : "generates"
    MeasurementSet ||--o{ Deviation : "validates"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : distanceMeasured
    InProgress --> InProgress : dimensionMeasured
    InProgress --> InProgress : comparedToPlan
    InProgress --> Review : measurementRecorded
    Review --> InProgress
    InProgress --> InProgress : measurementSetCreated
    InProgress --> InProgress : measurementSummaryGenerated
