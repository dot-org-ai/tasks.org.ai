...
```mermaid
erDiagram
    Sample ||--o{ TestResult : "contains"
    TestResult }o--|| TestMethod : "tracks"
    TestMethod ||--o{ Instrument : "references"
    Instrument }o--|| Specification : "generates"
    Specification ||--o{ CertificateOfAnalysis : "validates"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : sampleCollected
    InProgress --> InProgress : testPerformed
    InProgress --> InProgress : resultRecorded
    InProgress --> Review : resultValidated
    Review --> InProgress
    InProgress --> InProgress : specificationFailed
    InProgress --> InProgress : certificateIssued
