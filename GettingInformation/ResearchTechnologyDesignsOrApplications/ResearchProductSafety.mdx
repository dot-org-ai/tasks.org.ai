...
```mermaid
erDiagram
    SafetyHazard ||--o{ TestProtocol : contains
    TestProtocol ||--o{ RiskAssessment : contains
    RiskAssessment ||--o{ MitigationStrategy : contains
    MitigationStrategy }o--|| ComplianceReport : contains
    ComplianceReport ||--o{ IncidentRecord : contains
```
...
stateDiagram-v2
    [*] --> hazardsIdentifiing
    hazardsIdentifiing --> protocolDeveloping : hazardsIdentified
    protocolDeveloping --> testingInProgress : protocolDeveloped
    testingInProgress --> riskAssessing : testingConducted
    riskAssessing --> mitigationDesigning : riskAssessed
    mitigationDesigning --> protocolDeveloping : revisionNeeded
    mitigationDesigning --> [*] : completed
```
