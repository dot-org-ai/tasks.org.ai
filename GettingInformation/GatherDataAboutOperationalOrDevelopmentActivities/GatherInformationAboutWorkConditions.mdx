...
```mermaid
erDiagram
    SiteProfile ||--o{ ConditionAssessment : contains
    ConditionAssessment }o--|| HazardReport : contains
    HazardReport ||--o{ EnvironmentalReading : contains
    EnvironmentalReading ||--o{ SitePhotograph : contains
    SitePhotograph }o--|| AccessibilityReport : contains
    AccessibilityReport }o--|| ConditionSummary : contains
```
...
stateDiagram-v2
    [*] --> siteIdentifiing
    siteIdentifiing --> siteVisitInProgress : siteIdentified
    siteVisitInProgress --> environmentMeasuring : siteVisitConducted
    environmentMeasuring --> hazardsIdentifiing : environmentMeasured
    hazardsIdentifiing --> accessibilityAssessing : hazardsIdentified
    accessibilityAssessing --> siteVisitInProgress : revisionNeeded
    accessibilityAssessing --> [*] : completed
```
