...
erDiagram
    ...
    Part ||--o{ Movement : contains
    Movement ||--o{ TempoMarking : contains
    TempoMarking ||--o{ DynamicMarking : contains
    DynamicMarking }o--|| HarmonicAnalysis : contains
    HarmonicAnalysis ||--o{ PerformanceNote : contains
    PerformanceNote ||--|{ ReferenceRecording : contains
```
...
stateDiagram-v2
    [*] --> scoreAcquiring
    scoreAcquiring --> harmonyAnalyzing : scoreAcquired
    harmonyAnalyzing --> tempoMarking : harmonyAnalyzed
    tempoMarking --> dynamicsReviewing : tempoMarked
    dynamicsReviewing --> interpretationsComparing : dynamicsReviewed
    interpretationsComparing --> harmonyAnalyzing : revisionNeeded
    interpretationsComparing --> [*] : completed
```
