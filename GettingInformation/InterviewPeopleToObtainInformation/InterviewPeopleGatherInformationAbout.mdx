...
```mermaid
erDiagram
    CriminalInvestigation ||--o{ InvestigativeInterview : contains
    InvestigativeInterview ||--o{ WitnessAccount : contains
    WitnessAccount ||--o{ InformantIntelligence : contains
    InformantIntelligence ||--|{ SuspectStatement : contains
    SuspectStatement ||--o{ EvidenceCorroboration : contains
```
...
```mermaid
stateDiagram-v2
    [*] --> intervieweeIdentifiing
    intervieweeIdentifiing --> interviewInProgress : intervieweeIdentified
    interviewInProgress --> statementRecording : interviewConducted
    statementRecording --> evidenceCorroborating : statementRecorded
    evidenceCorroborating --> credibilityAssessing : evidenceCorroborated
    credibilityAssessing --> interviewInProgress : revisionNeeded
    credibilityAssessing --> [*] : completed
```
