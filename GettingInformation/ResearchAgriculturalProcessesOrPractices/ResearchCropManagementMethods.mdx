...
```mermaid
erDiagram
    ResearchProject ||--o{ FieldTrial : contains
    FieldTrial ||--o{ CropSample : contains
    CropSample ||--o{ YieldDataset : contains
    YieldDataset ||--o{ ManagementProtocol : contains
    ManagementProtocol ||--o{ EnvironmentalCondition : contains
```
...
stateDiagram-v2
    [*] --> researchPending
    researchPending --> fieldTrialDesigning : researchInitiated
    fieldTrialDesigning --> samplesCollecting : fieldTrialDesigned
    samplesCollecting --> yieldMeasuring : samplesCollected
    yieldMeasuring --> performanceAnalyzing : yieldMeasured
    performanceAnalyzing --> fieldTrialDesigning : revisionNeeded
    performanceAnalyzing --> [*] : completed
```
