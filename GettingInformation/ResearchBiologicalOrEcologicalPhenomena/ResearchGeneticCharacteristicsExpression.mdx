...
erDiagram
    ...
    Variant ||--o{ Expression : contains
    Expression ||--o{ Trait : contains
    Trait ||--o{ Pedigree : contains
```
...
stateDiagram-v2
    [*] --> genomeSequencing
    genomeSequencing --> genesIdentifiing : genomeSequenced
    genesIdentifiing --> expressionMeasuring : genesIdentified
    expressionMeasuring --> variantsDetecting : expressionMeasured
    variantsDetecting --> traitsAssociating : variantsDetected
    traitsAssociating --> genesIdentifiing : revisionNeeded
    traitsAssociating --> [*] : completed
```
