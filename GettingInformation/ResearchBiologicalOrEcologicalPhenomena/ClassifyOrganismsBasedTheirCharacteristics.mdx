...
```mermaid
erDiagram
    Specimen ||--o{ TaxonomicKey : contains
    TaxonomicKey ||--o{ TraitProfile : contains
    TraitProfile ||--o{ GeneticSequence : contains
    GeneticSequence ||--o{ TaxonomicAssignment : contains
    TaxonomicAssignment ||--o{ VoucherRecord : contains
```
...
stateDiagram-v2
    [*] --> specimenCollecting
    specimenCollecting --> characteristicsExamining : specimenCollected
    characteristicsExamining --> genomeSequencing : characteristicsExamined
    genomeSequencing --> taxonomicKeyAppliing : genomeSequenced
    taxonomicKeyAppliing --> taxonomyAssigning : taxonomicKeyApplied
    taxonomyAssigning --> characteristicsExamining : revisionNeeded
    taxonomyAssigning --> [*] : completed
```
