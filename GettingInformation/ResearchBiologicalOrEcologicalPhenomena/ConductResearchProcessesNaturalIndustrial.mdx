...
```mermaid
erDiagram
    EcosystemStudy ||--o{ ProcessMeasurement : contains
    ProcessMeasurement ||--o{ NutrientCycle : contains
    NutrientCycle ||--o{ EnergyBudget : contains
    EnergyBudget ||--o{ FunctionalAssessment : contains
    FunctionalAssessment }o--|| ComparativeAnalysis : contains
```
...
```mermaid
stateDiagram-v2
    [*] --> studySiteEstablishing
    studySiteEstablishing --> processRatesMeasuring : studySiteEstablished
    processRatesMeasuring --> nutrientsTracing : processRatesMeasured
    nutrientsTracing --> energyFlowsCalculating : nutrientsTraced
    energyFlowsCalculating --> functionsAssessing : energyFlowsCalculated
    functionsAssessing --> processRatesMeasuring : revisionNeeded
    functionsAssessing --> [*] : completed
```
