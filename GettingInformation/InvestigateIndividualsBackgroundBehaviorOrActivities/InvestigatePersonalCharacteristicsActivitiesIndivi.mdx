...
```mermaid
erDiagram
    InvestigationRequest ||--|{ SubjectProfile : contains
    SubjectProfile ||--o{ CredentialVerification : contains
    CredentialVerification ||--o{ ReferenceCheck : contains
    ReferenceCheck ||--o{ CriminalRecordSearch : contains
    CriminalRecordSearch ||--o{ FinancialReview : contains
    FinancialReview }o--|| InvestigationReport : contains
```
...
stateDiagram-v2
    ...
    investigationPending --> credentialsVerifiing : investigationInitiated
    credentialsVerifiing --> referenceCheckInProgress : credentialsVerified
    referenceCheckInProgress --> criminalRecordsSearching : referenceCheckConducted
    criminalRecordsSearching --> financialsReviewing : criminalRecordsSearched
    financialsReviewing --> credentialsVerifiing : revisionNeeded
    financialsReviewing --> [*] : completed
```
