...
```mermaid
erDiagram
    Observation ||--o{ Evidence : contains
    Evidence ||--o{ Pattern : contains
    Pattern }o--|| Report : contains
    Report ||--o{ Timeline : contains
    Timeline ||--o{ Incident : contains
```
...
stateDiagram-v2
    [*] --> observationPlanning
    observationPlanning --> surveillanceInProgress : observationPlanned
    surveillanceInProgress --> findingsDocumenting : surveillanceConducted
    findingsDocumenting --> evidenceCapturing : findingsDocumented
    evidenceCapturing --> patternsAnalyzing : evidenceCaptured
    patternsAnalyzing --> surveillanceInProgress : revisionNeeded
    patternsAnalyzing --> [*] : completed
```
