...
```mermaid
erDiagram
    FireScene ||--o{ DebrisSample : contains
    DebrisSample ||--o{ BurnPattern : contains
    BurnPattern ||--o{ IgnitionSource : contains
    IgnitionSource }o--|| AccelerantAnalysis : contains
    AccelerantAnalysis }o--|| InvestigationReport : contains
```
...
stateDiagram-v2
    ...
    sceneDocumenting --> debrisCollecting : sceneDocumented
    debrisCollecting --> patternsAnalyzing : debrisCollected
    patternsAnalyzing --> ignitionIdentifiing : patternsAnalyzed
    ignitionIdentifiing --> sceneDocumenting : revisionNeeded
    ignitionIdentifiing --> [*] : completed
```
