...
```mermaid
erDiagram
    Incident ||--o{ EvidenceItem : contains
    EvidenceItem ||--o{ WitnessStatement : contains
    WitnessStatement }o--|| RootCauseAnalysis : contains
    RootCauseAnalysis }o--|| InvestigationReport : contains
    InvestigationReport ||--o{ CorrectiveAction : contains
```
...
stateDiagram-v2
    ...
    investigationPending --> evidenceCollecting : investigationInitiated
    evidenceCollecting --> witnessStatementRecording : evidenceCollected
    witnessStatementRecording --> rootCauseIdentifiing : witnessStatementRecorded
    rootCauseIdentifiing --> sequenceReconstructing : rootCauseIdentified
    sequenceReconstructing --> evidenceCollecting : revisionNeeded
    sequenceReconstructing --> [*] : completed
```
