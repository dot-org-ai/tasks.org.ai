...
erDiagram
    ...
    Evidence ||--o{ Interview : contains
    Interview ||--o{ Finding : contains
    Finding ||--o{ CorrectiveAction : contains
```
...
stateDiagram-v2
    [*] --> complaintReceiving
    complaintReceiving --> severityAssessing : complaintReceived
    severityAssessing --> investigatorAssigning : severityAssessed
    investigatorAssigning --> evidenceCollecting : investigatorAssigned
    evidenceCollecting --> interviewsInProgress : evidenceCollected
    interviewsInProgress --> severityAssessing : revisionNeeded
    interviewsInProgress --> [*] : completed
```
