...
```mermaid
erDiagram
    Opportunity ||--|| Assessment : "uses"
    Opportunity ||--|| Benchmark : "uses"
    Opportunity ||--|| InitiativePipeline : "uses"
    Opportunity ||--|| CarbonFootprint : "uses"
    Opportunity ||--|| ResourceUsageProfile : "uses"
```
