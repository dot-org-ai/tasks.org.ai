...
```mermaid
erDiagram
    Prospect ||--|| IdealCustomerProfile : "uses"
    LeadSource ||--o{ Prospect : "presents"
    Prospect ||--|| QualificationScore : "uses"
    Prospect ||--|| MarketSegment : "uses"
    ProspectList ||--o{ Prospect : "defines"
```
