...
```mermaid
erDiagram
    TechnologyAsset ||--|| UseCase : "uses"
    TechnologyAsset ||--|| FeasibilityReport : "uses"
    TechnologyAsset ||--|| ProofOfConcept : "uses"
    TechnologyAsset ||--|| PatentLandscape : "uses"
    MarketOpportunity ||--o{ TechnologyAsset : "presents"
```
