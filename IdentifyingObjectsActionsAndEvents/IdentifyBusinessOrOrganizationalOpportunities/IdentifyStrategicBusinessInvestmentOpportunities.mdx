...
```mermaid
erDiagram
    Opportunity ||--|| StrategicFitAssessment : "uses"
    Opportunity ||--|| SynergyModel : "uses"
    Opportunity ||--|| DueDiligencePackage : "uses"
    Opportunity ||--|| InvestmentCase : "uses"
    Opportunity ||--|| CompetitiveLandscape : "uses"
```
