...
```mermaid
erDiagram
    Practice ||--|| MaterialityAssessment : "uses"
    Practice ||--|| ESGScorecard : "uses"
    Practice ||--|| SustainabilityFramework : "uses"
    Practice ||--|| AdoptionRoadmap : "uses"
    Practice ||--|| StakeholderReport : "uses"
```
