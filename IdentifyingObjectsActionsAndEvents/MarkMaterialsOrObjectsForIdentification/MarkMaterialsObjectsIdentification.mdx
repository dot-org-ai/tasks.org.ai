...
```mermaid
erDiagram
    IdentificationMark ||--o{ MaterialRecord : "generates"
    MarkingSpecification ||--o{ IdentificationMark : "defines"
    IdentificationMark ||--|| BatchIdentifier : "uses"
    IdentificationMark ||--o{ TraceabilityLog : "generates"
    IdentificationMark ||--|| MarkingEquipment : "uses"
```
