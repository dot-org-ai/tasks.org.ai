...
```mermaid
erDiagram
    ProductMark ||--|| GradeClassification : "uses"
    ProductMark ||--|| MarkingStandard : "uses"
    ProductMark ||--|| ProductLot : "uses"
    ProductMark ||--o{ HarvestRecord : "generates"
    ProductMark ||--|| MarkingEquipment : "uses"
```
