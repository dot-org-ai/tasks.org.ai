...
```mermaid
erDiagram
    SerialNumber ||--|| Barcode : "uses"
    SerialNumber ||--|| RFIDTag : "uses"
    SerialNumber ||--|| MarkingTemplate : "uses"
    SerialNumber ||--o{ ProductRecord : "generates"
    SerialNumber ||--|| EquipmentAssetTag : "uses"
```
