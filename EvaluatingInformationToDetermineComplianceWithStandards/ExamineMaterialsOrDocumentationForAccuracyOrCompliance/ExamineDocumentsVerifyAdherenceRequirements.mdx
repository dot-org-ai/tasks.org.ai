...
erDiagram
    ...
    Requirement }o--|| TraceabilityMatrix : "tracks"
    TraceabilityMatrix ||--o{ AdherenceGap : "references"
    AdherenceGap }o--|| ReviewChecklist : "generates"
    ReviewChecklist ||--o{ DispositionRecord : "validates"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : documentSubmitted
    InProgress --> InProgress : requirementsMapped
    InProgress --> InProgress : adherenceEvaluated
    InProgress --> Review : gapIdentified
    Review --> InProgress
    InProgress --> InProgress : revisionRequested
    InProgress --> InProgress : documentAccepted
