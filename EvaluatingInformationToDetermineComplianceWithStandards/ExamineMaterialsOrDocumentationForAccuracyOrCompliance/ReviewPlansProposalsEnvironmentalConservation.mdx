...
```mermaid
erDiagram
    ConservationPlan ||--o{ HabitatAssessment : "contains"
    HabitatAssessment }o--|| SpeciesImpactAnalysis : "tracks"
    SpeciesImpactAnalysis ||--o{ MitigationStrategy : "references"
    MitigationStrategy }o--|| ConservationEasement : "generates"
    ConservationEasement ||--o{ StakeholderComment : "validates"
    StakeholderComment }o--|| ReviewDetermination : "supports"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : proposalSubmitted
    InProgress --> InProgress : ecologicalSoundnessAssessed
    InProgress --> InProgress : speciesImpactReviewed
    InProgress --> Review : mitigationAdequacyEvaluated
    Review --> InProgress
    InProgress --> InProgress : stakeholderInputCollected
    InProgress --> InProgress : proposalApproved
    InProgress --> Completed : proposalReturnedForRevision
    Completed --> [*]
```
## Workflow
