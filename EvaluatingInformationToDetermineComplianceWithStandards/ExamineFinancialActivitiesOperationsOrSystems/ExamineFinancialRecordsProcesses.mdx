...
```mermaid
erDiagram
    FinancialProcess ||--o{ ControlPoint : "contains"
    ControlPoint }o--|| TransactionSample : "tracks"
    TransactionSample ||--o{ ProcessMap : "references"
    ProcessMap }o--|| ControlDeficiency : "generates"
    ControlDeficiency ||--o{ ProcessEffectivenessRating : "validates"
    ProcessEffectivenessRating }o--|| ExaminationWorkpaper : "supports"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : examinationScoped
    InProgress --> InProgress : processMapped
    InProgress --> InProgress : controlDesignEvaluated
    InProgress --> Review : transactionsSampled
    Review --> InProgress
    InProgress --> InProgress : processEffectivenessAssessed
    InProgress --> InProgress : controlDeficiencyDocumented
    InProgress --> Completed : improvementRecommended
    Completed --> [*]
```
## Workflow
