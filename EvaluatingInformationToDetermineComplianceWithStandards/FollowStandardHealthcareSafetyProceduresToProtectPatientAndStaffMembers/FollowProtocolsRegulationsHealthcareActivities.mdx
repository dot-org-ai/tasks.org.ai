...
```mermaid
erDiagram
    ClinicalProtocol ||--o{ RegulatoryRequirement : "contains"
    RegulatoryRequirement }o--|| ComplianceChecklist : "tracks"
    ComplianceChecklist ||--o{ ProtocolDeviation : "references"
    ProtocolDeviation }o--|| CorrectiveAction : "generates"
    CorrectiveAction ||--o{ ComplianceDashboard : "validates"
    ComplianceDashboard }o--|| PolicyUpdate : "supports"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : protocolsIdentified
    InProgress --> InProgress : protocolAdherenceVerified
    InProgress --> InProgress : deviationDocumented
    InProgress --> Review : deviationInvestigated
    Review --> InProgress
    InProgress --> InProgress : correctiveActionImplemented
    InProgress --> InProgress : protocolUpdated
    InProgress --> Completed : complianceMetricsReported
    Completed --> [*]
```
## Workflow
