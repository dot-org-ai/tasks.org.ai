...
```mermaid
erDiagram
    ApplicationSpec ||--|| ClinicalWorkflow : "supports"
    ApplicationSpec ||--|| DataModel : "structures"
    ApplicationSpec ||--|{ ComplianceRequirement : "satisfies"
    DataModel ||--|{ IntegrationInterface : "exposes"
    ApplicationSpec ||--o{ UsabilityStudy : "validated in"
    ClinicalWorkflow }o--|| DataModel : "informed by"
```
...
stateDiagram-v2
    ...
    RequirementsGathered --> DataModelDesigned : dataModelDesigned
    DataModelDesigned --> IntegrationsSpecified : integrationsSpecified
    IntegrationsSpecified --> WireframesCompleted : wireframesCompleted
    WireframesCompleted --> UsabilityTested : usabilityTestCompleted
    UsabilityTested --> WireframesCompleted : wireframesCompleted
    UsabilityTested --> ComplianceAssessed : complianceAssessed
    ComplianceAssessed --> DataModelDesigned : dataModelDesigned
    ComplianceAssessed --> DesignFinalized : designFinalized
    DesignFinalized --> [*]
```
