...
```mermaid
erDiagram
    CreativeBrief ||--|| MoodBoard : "inspires"
    MoodBoard ||--|| ColorScheme : "establishes"
    MoodBoard ||--|| ConceptPresentation : "rendered in"
    ColorScheme ||--|| MaterialPalette : "guides"
    MaterialPalette ||--|| FurnitureSchedule : "coordinates with"
    FurnitureSchedule ||--|| DesignDevelopmentPackage : "compiled in"
    ConceptPresentation }o--|| DesignDevelopmentPackage : "finalized as"
```
...
stateDiagram-v2
    [*] --> Researched
    Researched --> MoodBoardReady : moodBoardAssembled
    MoodBoardReady --> ColorDefined : colorSchemeDefined
    ColorDefined --> Presented : conceptPresented
    Presented --> MoodBoardReady : moodBoardAssembled
    Presented --> MaterialsSpec : materialsSpecified
    MaterialsSpec --> FurnishingsSpec : furnishingsScheduled
    FurnishingsSpec --> PackageDelivered : designPackageDelivered
    PackageDelivered --> [*]
```
