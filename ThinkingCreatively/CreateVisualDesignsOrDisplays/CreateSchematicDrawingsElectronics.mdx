...
```mermaid
erDiagram
    Schematic ||--|{ SchematicSheet : "composed of"
    Schematic ||--|{ ComponentSymbol : "uses"
    Schematic ||--|| Netlist : "exports as"
    Schematic ||--|| BillOfMaterials : "generates"
    Schematic ||--|| DesignRuleSet : "validated by"
    Schematic ||--o{ RevisionHistory : "tracked in"
    ComponentSymbol }o--|| BillOfMaterials : "listed in"
```
...
stateDiagram-v2
    ...
    RequirementsCaptured --> ComponentsSelected : componentsSelected
    ComponentsSelected --> SchematicEntered : schematicEntered
    SchematicEntered --> DRCPassed : designRuleCheckPassed
    SchematicEntered --> SchematicEntered : schematicEntered
    DRCPassed --> NetlistReady : netlistGenerated
    NetlistReady --> BOMReady : bomGenerated
    BOMReady --> Released : schematicReleased
    Released --> [*]
```
