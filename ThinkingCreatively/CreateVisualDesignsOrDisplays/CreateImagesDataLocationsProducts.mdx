...
```mermaid
erDiagram
    DataVisualization }o--|| VisualAssetLibrary : "stored in"
    LocationImage }o--|| VisualAssetLibrary : "stored in"
    ProductImage }o--|| VisualAssetLibrary : "stored in"
    RenderingProject ||--o{ ProductImage : "produces"
    RenderingProject ||--o{ LocationImage : "produces"
    VisualAssetLibrary ||--|{ DataVisualization : "catalogs"
```
...
stateDiagram-v2
    [*] --> DataIngested
    DataIngested --> VisualizationCreated : visualizationCreated
    [*] --> SubjectPhotographed
    SubjectPhotographed --> ImageRefined : imageRefined
    [*] --> SceneRendered
    SceneRendered --> ImageRefined : imageRefined
    VisualizationCreated --> ImageRefined : imageRefined
    ImageRefined --> AssetCataloged : assetCataloged
    AssetCataloged --> Distributed : imageDistributed
    Distributed --> [*]
```
