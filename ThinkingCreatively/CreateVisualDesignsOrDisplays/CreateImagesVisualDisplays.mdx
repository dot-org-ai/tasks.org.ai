...
```mermaid
erDiagram
    CreativeBrief ||--|| DesignDraft : "guides"
    DesignDraft ||--|| VisualAsset : "finalized as"
    VisualAsset ||--|| ProductionFile : "exported as"
    BrandGuideline ||--|| CreativeBrief : "constrains"
    DesignDraft }o--|| BrandGuideline : "follows"
    ProductionFile }o--|| VisualAsset : "derived from"
```
...
stateDiagram-v2
    [*] --> BriefCreated
    BriefCreated --> ConceptDeveloped : conceptDeveloped
    ConceptDeveloped --> AssetDesigned : assetDesigned
    AssetDesigned --> DraftReviewed : draftReviewed
    DraftReviewed --> DesignRevised : designRevised
    DesignRevised --> DraftReviewed : draftReviewed
    DraftReviewed --> ProductionReady : productionPrepared
    ProductionReady --> Delivered : assetDelivered
    Delivered --> [*]
```
