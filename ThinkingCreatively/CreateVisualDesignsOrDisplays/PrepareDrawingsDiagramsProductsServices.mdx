...
```mermaid
erDiagram
    DesignRequirement ||--|| ConceptSketch : "visualized as"
    ConceptSketch ||--|| ProductionDrawing : "detailed in"
    ProductionDrawing ||--o| AssemblyDiagram : "assembled in"
    ProductionDrawing ||--o{ DrawingRevision : "versioned as"
    AssemblyDiagram }o--|| ReleasePackage : "included in"
    ProductionDrawing }o--|| ReleasePackage : "compiled in"
    ServiceFlowDiagram }o--|| ReleasePackage : "included in"
```
...
stateDiagram-v2
    ...
    RequirementsGathered --> ConceptSketched : conceptSketchCreated
    ConceptSketched --> ProductionDrafted : productionDrawingDrafted
    ProductionDrafted --> AssemblyPrepared : assemblyDiagramPrepared
    AssemblyPrepared --> Annotated : drawingAnnotated
    Annotated --> Reviewed : drawingReviewed
    Reviewed --> ProductionDrafted : productionDrawingDrafted
    Reviewed --> Released : drawingPackageReleased
    Released --> [*]
```
