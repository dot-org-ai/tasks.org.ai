...
```mermaid
erDiagram
    FurnitureItem ||--|| MaterialType : "made of"
    Fixture ||--|| MaterialType : "made of"
    CleaningSchedule ||--o{ CleaningTask : contains
    CleaningTask ||--o{ FurnitureItem : targets
    CleaningTask ||--o{ Fixture : targets
    FurnitureItem ||--o{ CleaningTask : "cleaned by"
```
...
stateDiagram-v2
    [*] --> Dusty
    Dusty --> Dusted : surfacesDusted
    Dusted --> Disinfected : surfacesDisinfected
    Disinfected --> Polished : woodPolished
    Disinfected --> UpholsteryCleaned : upholsteryCleaned
    Disinfected --> Descaled : fixturesDescaled
    Polished --> Inspected : inspectCondition
    UpholsteryCleaned --> Inspected : inspectCondition
    Descaled --> Inspected : inspectCondition
    Inspected --> Damaged : damageDetected
    Damaged --> Dusted : Re-clean after repair
    Inspected --> [*]
```
