...
```mermaid
erDiagram
    CareAssessment ||--o{ IndividualizedPlan : contains
    CareAssessment ||--o{ DailyRoutine : contains
    CareAssessment ||--o{ AdaptiveEquipment : contains
    CareAssessment ||--o{ SkillsProgress : contains
    CareAssessment ||--o{ IncidentReport : generates
```
