...
```mermaid
erDiagram
    ResuscitationEvent ||--o{ CardiacRhythm : contains
    ResuscitationEvent ||--o{ AirwayIntervention : contains
    ResuscitationEvent ||--o{ MedicationDose : contains
    ResuscitationEvent ||--o{ DefibrillationAttempt : contains
    ResuscitationEvent ||--o{ ResuscitationOutcome : contains
```
...
stateDiagram-v2
    ...
    Processing --> UnderReview : rhythmAnalyzed
    UnderReview --> [*]
```
## Workflow
