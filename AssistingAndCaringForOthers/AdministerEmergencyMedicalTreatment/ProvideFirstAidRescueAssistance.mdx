...
```mermaid
erDiagram
    RescueIncident ||--o{ HazardAssessment : contains
    RescueIncident ||--o{ RescuePlan : contains
    RescueIncident ||--o{ FirstAidIntervention : contains
    RescueIncident ||--o{ PersonalProtectiveEquipment : contains
    RescueIncident ||--o{ IncidentCommandSystem : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : hazardsAssessed
    Processing --> [*]
```
## Workflow
