...
```mermaid
erDiagram
    EmergencyCase ||--o{ Triage : contains
    EmergencyCase ||--o{ Resuscitation : contains
    EmergencyCase ||--o{ CrashCart : contains
    EmergencyCase ||--o{ AdvancedAirway : contains
    EmergencyCase ||--o{ EmergencyProtocol : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : patientTriaged
    Processing --> [*]
```
## Workflow
