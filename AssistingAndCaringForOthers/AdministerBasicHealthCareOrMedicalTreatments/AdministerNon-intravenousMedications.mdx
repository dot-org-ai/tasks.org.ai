...
```mermaid
erDiagram
    MedicationOrder ||--|| Route : specifies
    MedicationOrder ||--|| Schedule : follows
    MedicationOrder ||--|{ Dose : prescribes
    Dose ||--|| MedicationAdministrationRecord : "recorded in"
    MedicationAdministrationRecord ||--o| AdverseReaction : "may trigger"
```
...
stateDiagram-v2
    ...
    PrescriptionVerified --> DosePrepared : dosePrepared
    DosePrepared --> PatientEducated : patientEducated
    PatientEducated --> Administered : medicationAdministered
    Administered --> ResponseChecked : responseObserved
    ResponseChecked --> ReactionReported : reactionReported
    ReactionReported --> PrescriptionVerified : prescriptionVerified
    ResponseChecked --> Documented : administrationDocumented
    Documented --> [*]
```
## Workflow
