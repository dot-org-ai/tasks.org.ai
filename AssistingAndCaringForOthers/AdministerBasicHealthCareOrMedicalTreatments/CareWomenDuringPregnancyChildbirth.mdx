...
```mermaid
erDiagram
    PregnatalRecord ||--o{ LaborPlan : contains
    PregnatalRecord ||--o{ ContractionLog : contains
    PregnatalRecord ||--o{ DeliveryOutcome : contains
    PregnatalRecord ||--o{ PostpartumAssessment : contains
    PregnatalRecord ||--o{ BreastfeedingPlan : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : prenatalAssessed
    Processing --> [*]
```
## Workflow
