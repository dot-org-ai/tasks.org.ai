...
```mermaid
erDiagram
    IVOrder ||--o{ IVLine : contains
    IVOrder ||--o{ Infusion : contains
    IVOrder ||--o{ InfusionPump : contains
    IVOrder ||--o{ IVSite : contains
    IVOrder ||--o{ MedicationBag : contains
```
...
stateDiagram-v2
    ...
    Validated --> Processing : accessEstablished
    Processing --> Prepared : medicationPrepared
    Prepared --> [*]
```
## Workflow
