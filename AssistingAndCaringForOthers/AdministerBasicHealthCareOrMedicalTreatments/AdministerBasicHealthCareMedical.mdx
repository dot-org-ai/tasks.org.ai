...
```mermaid
erDiagram
    Treatment ||--o{ VitalSigns : contains
    Treatment ||--o{ MedicalRecord : generates
    Treatment ||--o{ CarePlan : contains
    Treatment ||--o{ Assessment : contains
    Treatment ||--o{ Protocol : contains
```
