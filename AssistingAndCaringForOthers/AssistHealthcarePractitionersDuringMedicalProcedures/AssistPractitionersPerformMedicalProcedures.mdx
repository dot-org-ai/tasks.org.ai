...
```mermaid
erDiagram
    ProcedureSchedule ||--o{ ConsentForm : contains
    ProcedureSchedule ||--o{ ProcedureSetup : contains
    PatientPositioning ||--o{ ProcedureSchedule : provides
    ProcedureSchedule ||--o{ SpecimenCollection : contains
    ProcedureSchedule ||--o{ ProcedureNote : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Prepared : procedureRoomPrepared
    Prepared --> Processing : consentObtained
    Processing --> [*]
```
## Workflow
