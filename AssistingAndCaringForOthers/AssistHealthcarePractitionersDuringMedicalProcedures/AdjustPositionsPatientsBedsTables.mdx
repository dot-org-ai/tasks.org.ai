...
```mermaid
erDiagram
    PositioningOrder ||--o{ BodyAlignment : contains
    PositioningOrder ||--o{ PressurePoint : contains
    PositioningOrder ||--o{ PositioningDevice : contains
    PositioningOrder ||--o{ RepositioningSchedule : contains
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : positionAssessed
    Processing --> Prepared : repositioningPlanned
