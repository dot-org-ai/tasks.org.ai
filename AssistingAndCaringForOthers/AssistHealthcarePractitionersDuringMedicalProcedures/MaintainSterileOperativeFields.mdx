...
```mermaid
erDiagram
    SterileField ||--o{ InstrumentTray : contains
    SterileField ||--o{ SterileDrape : contains
    SterileField ||--o{ ContaminationBreach : contains
    SterileField ||--o{ SterileSupply : contains
    SterileField ||--o{ FieldInspection : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Prepared : sterileFieldPrepared
    Prepared --> Validated : sterilityVerified
    Validated --> Processing : sterilePackageOpened
    Processing --> [*]
```
## Workflow
