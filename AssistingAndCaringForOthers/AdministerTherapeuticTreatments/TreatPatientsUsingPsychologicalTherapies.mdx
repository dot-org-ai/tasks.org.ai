...
```mermaid
erDiagram
    IntakeAssessment ||--o{ TreatmentPlan : contains
    IntakeAssessment ||--o{ TherapySession : contains
    IntakeAssessment ||--o{ ProgressNote : contains
    IntakeAssessment ||--o{ TherapeuticIntervention : contains
    IntakeAssessment ||--o{ OutcomeMeasure : contains
```
