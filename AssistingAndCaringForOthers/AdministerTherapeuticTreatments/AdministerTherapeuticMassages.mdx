...
```mermaid
erDiagram
    ClientIntake ||--o{ MassageSession : contains
    ClientIntake ||--o{ TreatmentPlan : contains
    ClientIntake ||--o{ TechniqueProtocol : contains
    ClientIntake ||--o{ SessionNote : contains
    ClientIntake ||--o{ OutcomeMeasure : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : intakeConducted
    Processing --> [*]
```
## Workflow
