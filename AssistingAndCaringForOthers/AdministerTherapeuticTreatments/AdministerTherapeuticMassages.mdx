...
erDiagram
    ...
    TreatmentPlan ||--|{ MassageSession : schedules
    MassageSession ||--|{ TechniqueProtocol : applies
    MassageSession ||--|| SessionNote : "documented in"
...
stateDiagram-v2
    [*] --> IntakeComplete
    IntakeComplete --> Planned : treatmentPlanned
    Planned --> TechniquesChosen : techniquesSelected
    TechniquesChosen --> MassageDelivered : massagePerformed
    MassageDelivered --> Documented : sessionDocumented
    Documented --> OutcomesTracked : outcomesMeasured
    OutcomesTracked --> Planned : followUpScheduled
    OutcomesTracked --> [*]
```
## Workflow
