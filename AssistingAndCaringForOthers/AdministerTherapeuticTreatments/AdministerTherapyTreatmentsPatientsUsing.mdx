...
```mermaid
erDiagram
    TherapyPlan ||--|{ TreatmentSession : schedules
    TreatmentSession ||--|{ ManualTechnique : applies
    TreatmentSession ||--o| TherapeuticModality : "may use"
    TreatmentSession ||--o| TreatmentAid : "may use"
    TreatmentSession ||--|| ProgressNote : "documented in"
```
...
stateDiagram-v2
    [*] --> FunctionalAssessed
    FunctionalAssessed --> ManualApplied : manualTherapyApplied
    FunctionalAssessed --> ModalityUsed : therapeuticModalityUtilized
    FunctionalAssessed --> ExerciseGuided : therapeuticExerciseGuided
    ManualApplied --> ProgressTracked : progressMeasured
    ModalityUsed --> ProgressTracked : progressMeasured
    ExerciseGuided --> ProgressTracked : progressMeasured
    ProgressTracked --> EquipmentFitted : adaptiveEquipmentFitted
    ProgressTracked --> Documented : treatmentDocumented
    EquipmentFitted --> Documented : treatmentDocumented
    Documented --> FunctionalAssessed : nextSessionScheduled
    Documented --> [*]
```
## Workflow
