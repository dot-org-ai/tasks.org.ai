...
```mermaid
erDiagram
    ComplaintRecord ||--|| InvestigationReport : "examined by"
    ComplaintRecord ||--o{ WitnessStatement : "supported by"
    InvestigationReport ||--|| CorrectiveActionPlan : "generates"
    CorrectiveActionPlan ||--o| PerformanceImprovement : "includes"
    CorrectiveActionPlan ||--o| DisciplinaryAction : "includes"
    ComplaintRecord ||--o| ResolutionAgreement : "resolved by"
    ResolutionAgreement ||--|| CorrectiveActionPlan : "implements"
```
...
stateDiagram-v2
    ...
    Received --> Investigated : issueInvestigated
    Investigated --> SeverityRated : severityAssessed
    SeverityRated --> InDiscussion : discussionFacilitated
    InDiscussion --> ActionPlanned : correctiveActionDeveloped
    ActionPlanned --> Implemented : resolutionImplemented
    Implemented --> Monitoring : outcomeMonitored
    Monitoring --> InDiscussion : not resolved
