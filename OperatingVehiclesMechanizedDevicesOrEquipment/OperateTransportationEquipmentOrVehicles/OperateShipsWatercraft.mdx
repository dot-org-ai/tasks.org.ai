...
erDiagram
    ...
    Voyage ||--|| NavigationChart : "plotted on"
    Voyage ||--o{ BerthAssignment : "starts or ends at"
    Vessel ||--|| CrewManifest : carries
    Vessel ||--o{ CargoManifest : transports
    BerthAssignment }o--|| Voyage : "assigned for"
```
...
stateDiagram-v2
    ...
    Planned --> PreChecked : conductPreDepartureCheck
    PreChecked --> Departed : vesselDeparted
    Departed --> Navigating : waypointReached
    Navigating --> Adjusting : courseAdjusted
    Adjusting --> Navigating : waypointReached
    Navigating --> HazardFound : hazardDetected
    HazardFound --> Adjusting : courseAdjusted
    Navigating --> Docked : vesselDocked
    Docked --> Completed : voyageCompleted
    Completed --> [*]
```
