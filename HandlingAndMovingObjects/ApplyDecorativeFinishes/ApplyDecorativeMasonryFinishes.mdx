...
```mermaid
erDiagram
    MasonryContractor ||--|| FinishingCraftsman : follows
    MasonryContractor }o--|| Architect : generates
    MasonryContractor ||--|{ ProjectManager : requires
    MasonryContractor ||--o{ MaterialSupplier : tracks
    MasonryContractor ||--|| BuildingInspector : validates
    FinishingCraftsman ||--|{ MasonryContractor : creates
    Architect ||--o{ MasonryContractor : documents
    ProjectManager ||--|| MasonryContractor : supports
```
...
stateDiagram-v2
    [*] --> Masonry_Contractor
    Masonry_Contractor --> Finishing_Craftsman: FinishingCraftsman
    Finishing_Craftsman --> Architect: Architect
    Architect --> Project_Manager: ProjectManager
    Project_Manager --> Material_Supplier: MaterialSupplier
    Material_Supplier --> Building_Inspector: BuildingInspector
    Project_Manager --> Finishing_Craftsman: Architect
    Building_Inspector --> [*]
```
