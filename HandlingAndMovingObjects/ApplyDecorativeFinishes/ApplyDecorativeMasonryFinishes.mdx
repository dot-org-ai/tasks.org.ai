...
```mermaid
erDiagram
    MasonrySurface ||--|| FinishSpecification : "finished according to"
    FinishingMaterial ||--|| MasonrySurface : "applied to"
    ApplicationMethod ||--|| FinishingMaterial : "delivers"
    QualityStandard ||--|| FinishSpecification : "defines acceptance for"
    CuringProtocol ||--|| FinishingMaterial : "hardens"
    MasonrySurface ||--o{ CuringProtocol : "undergoes"
```
...
stateDiagram-v2
    ...
    BaseCoatApplied --> DecorativeFinishApplied : decorativeFinishApplied
    DecorativeFinishApplied --> TextureCreated : textureCreated
    TextureCreated --> SealerApplied : sealerApplied
    SealerApplied --> CoverageInspected : coverageInspected
    CoverageInspected --> DecorativeFinishApplied : decorativeFinishApplied
    CoverageInspected --> CuringCompleted : curingCompleted
    CuringCompleted --> [*]
```
