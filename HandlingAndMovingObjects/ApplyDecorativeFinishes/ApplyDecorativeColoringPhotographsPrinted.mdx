...
```mermaid
erDiagram
    Photograph ||--|| ColorProfile : "colored according to"
    ColorProfile ||--o{ ColoringMedium : "applied using"
    ColorSample ||--|| Photograph : "previews treatment for"
    ColoringProject ||--o{ Photograph : "encompasses"
    QualityStandard ||--|| ColoringProject : "defines acceptance for"
    ColoringMedium ||--|| QualityStandard : "evaluated against"
```
...
stateDiagram-v2
    [*] --> ImageAssessed
    ImageAssessed --> PaletteSelected : paletteSelected
    PaletteSelected --> BaseColorApplied : baseColorApplied
    BaseColorApplied --> DetailColoringAdded : detailColoringAdded
    DetailColoringAdded --> TransitionsBlended : transitionsBlended
    TransitionsBlended --> ColorBalanceCorrected : colorBalanceCorrected
    ColorBalanceCorrected --> ClientReviewCompleted : clientReviewCompleted
    ClientReviewCompleted --> PaletteSelected : paletteSelected
    ClientReviewCompleted --> [*]
```
