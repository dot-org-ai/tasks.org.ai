...
```mermaid
erDiagram
    PaintingContractor ||--|| FinishingTechnician : follows
    PaintingContractor }o--|| WallcoveringInstaller : generates
    PaintingContractor ||--|{ InteriorDesigner : requires
    PaintingContractor ||--o{ PropertyOwner : tracks
    PaintingContractor ||--|| MaterialSupplier : validates
    FinishingTechnician ||--|{ PaintingContractor : creates
    WallcoveringInstaller ||--o{ PaintingContractor : documents
    InteriorDesigner ||--|| PaintingContractor : supports
```
...
stateDiagram-v2
    [*] --> Painting_Contractor
    Painting_Contractor --> Finishing_Technician: FinishingTechnician
    Finishing_Technician --> Wallcovering_Installer: WallcoveringInstaller
    Wallcovering_Installer --> Interior_Designer: InteriorDesigner
    Interior_Designer --> Property_Owner: PropertyOwner
    Property_Owner --> Material_Supplier: MaterialSupplier
    Interior_Designer --> Finishing_Technician: WallcoveringInstaller
    Material_Supplier --> [*]
```
