...
```mermaid
erDiagram
    Equipment ||--|| AlignmentSpec : "governed-by"
    AlignmentJob ||--|| Equipment : "targets"
    AlignmentJob ||--o{ Measurement : "captures"
    AlignmentJob ||--|| AlignmentReport : "documented-in"
    Equipment ||--|| CalibrationCertificate : "certified-by"
```
...
stateDiagram-v2
    [*] --> AlignmentJobCreated
    AlignmentJobCreated --> MeasurementsRecorded : measurementsRecorded
    MeasurementsRecorded --> EquipmentAdjusted : equipmentAdjusted
    EquipmentAdjusted --> AlignmentVerified : alignmentVerified
    AlignmentVerified --> MeasurementsRecorded : toleranceExceeded
    AlignmentVerified --> AlignmentApproved : alignmentApproved
    AlignmentApproved --> RealignmentScheduled : realignmentScheduled
    RealignmentScheduled --> [*]
```
## Workflow
