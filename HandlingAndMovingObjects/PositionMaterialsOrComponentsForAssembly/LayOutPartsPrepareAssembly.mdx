...
```mermaid
erDiagram
    PartKit ||--o{ BillOfMaterials : "defines"
    PartKit ||--|{ WorkInstruction : "generates"
    PartKit }o--|| LayoutStation : "uses"
    PartKit ||--|| Component : "tracked-by"
    PartKit ||--o{ LayoutVerification : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : partsRetrieved
    InProgress --> Verified : partKitVerified
    Verified --> Approved : componentsArranged
    Approved --> Active : positionsLabeled
    Active --> Complete : partsInspected
