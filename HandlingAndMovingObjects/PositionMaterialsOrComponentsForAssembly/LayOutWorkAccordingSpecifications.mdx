...
```mermaid
erDiagram
    Specification ||--o{ LayoutJob : "defines"
    Specification ||--|{ ReferencePoint : "generates"
    Specification }o--|| Component : "uses"
    Specification ||--|| LayoutPlan : "tracked-by"
    Specification ||--o{ Verification : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : layoutJobCreated
    InProgress --> Verified : specsInterpreted
    Verified --> Approved : datumsEstablished
    Approved --> Active : componentsPositioned
    Active --> Complete : layoutVerified
