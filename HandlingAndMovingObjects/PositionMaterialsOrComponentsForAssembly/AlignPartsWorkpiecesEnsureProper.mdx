...
```mermaid
erDiagram
    Workpiece ||--o{ Fixture : "defines"
    Workpiece ||--|{ AlignmentTolerance : "generates"
    Workpiece }o--|| AssemblyDrawing : "uses"
    Workpiece ||--|| MeasurementRecord : "tracked-by"
    Workpiece ||--o{ JointConfiguration : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : fixtureLoaded
    InProgress --> Verified : workpiecePositioned
    Verified --> Approved : alignmentMeasured
    Approved --> Active : shimApplied
    Active --> Complete : positionLocked
