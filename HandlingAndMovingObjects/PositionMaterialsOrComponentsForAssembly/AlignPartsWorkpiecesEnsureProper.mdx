...
```mermaid
erDiagram
    AssemblyDrawing ||--o{ JointConfiguration : "specifies"
    Workpiece ||--|| Fixture : "held-in"
    Workpiece ||--|| AlignmentTolerance : "constrained-by"
    Workpiece ||--o{ MeasurementRecord : "measured-in"
    JointConfiguration ||--o{ Workpiece : "mates"
```
...
stateDiagram-v2
    [*] --> FixtureLoaded
    FixtureLoaded --> WorkpiecePositioned : workpiecePositioned
    WorkpiecePositioned --> AlignmentMeasured : alignmentMeasured
    AlignmentMeasured --> ShimApplied : toleranceExceeded
    ShimApplied --> AlignmentMeasured : alignmentMeasured
    AlignmentMeasured --> FitUpVerified : fitUpVerified
    FitUpVerified --> PositionLocked : positionLocked
    PositionLocked --> [*]
```
## Workflow
