...
```mermaid
erDiagram
    LayoutPlan ||--o{ ReferencePoint : "specifies"
    BenchmarkElevation ||--o{ ReferencePoint : "anchors"
    MaterialPiece ||--o{ ReferencePoint : "marked-with"
    CutList ||--o{ MaterialPiece : "schedules"
    MarkingTool ||--o{ ReferencePoint : "creates"
```
...
stateDiagram-v2
    ...
    BenchmarkEstablished --> DimensionsTransferred : dimensionsTransferred
    DimensionsTransferred --> CutLinesMarked : cutLinesMarked
    CutLinesMarked --> HoleCentersMarked : holeCentersMarked
    HoleCentersMarked --> MarksVerified : marksVerified
    MarksVerified --> DimensionsTransferred : markingErrorDetected
    MarksVerified --> ComponentsLabeled : componentsLabeled
    ComponentsLabeled --> [*]
```
## Workflow
