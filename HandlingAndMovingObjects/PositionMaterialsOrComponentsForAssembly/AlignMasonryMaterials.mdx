...
```mermaid
erDiagram
    WallSection ||--o{ CourseLine : "divided-into"
    CourseLine ||--o{ MasonryUnit : "positions"
    MasonryUnit ||--|| JointProfile : "joined-by"
    WallSection ||--|| BondPattern : "laid-in"
    CourseLine ||--o{ AlignmentCheck : "measured-by"
```
...
stateDiagram-v2
    [*] --> CourseLineSet
    CourseLineSet --> UnitPositioned : unitPositioned
    UnitPositioned --> AlignmentChecked : alignmentChecked
    AlignmentChecked --> UnitAdjusted : alignmentDeviationDetected
    UnitAdjusted --> AlignmentChecked : alignmentChecked
    AlignmentChecked --> BondPatternVerified : bondPatternVerified
    BondPatternVerified --> CourseCompleted : courseCompleted
    CourseCompleted --> CourseLineSet : courseLineSet
    CourseCompleted --> [*]
```
## Workflow
