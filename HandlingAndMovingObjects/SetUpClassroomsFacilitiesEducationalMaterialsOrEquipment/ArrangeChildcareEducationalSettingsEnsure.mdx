...
```mermaid
erDiagram
    SafetyInspection ||--|| HazardReport : "uses"
    SafetyInspection ||--|| RoomConfiguration : "has"
    SafetyInspection ||--|| SafetyEquipment : "uses"
    SafetyInspection ||--|| ComplianceCertificate : "uses"
    SafetyInspection ||--|| AgeGroup : "uses"
```
