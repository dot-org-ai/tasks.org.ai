...
```mermaid
erDiagram
    InstructionalMaterial ||--o{ ClassroomLayout : "defines"
    ClassroomLayout ||--|| EquipmentItem : "uses"
    ClassroomLayout ||--|| SetupChecklist : "uses"
    ClassroomLayout ||--|| RoomAssignment : "uses"
    ClassroomLayout ||--|| SupplyInventory : "uses"
```
