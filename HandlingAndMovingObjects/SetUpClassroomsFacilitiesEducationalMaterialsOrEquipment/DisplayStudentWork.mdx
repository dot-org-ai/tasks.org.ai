...
```mermaid
erDiagram
    StudentWork ||--|| DisplaySpace : "uses"
    StudentWork ||--|| Exhibition : "uses"
    StudentWork ||--|| MountingMaterial : "uses"
    StudentWork ||--|| DisplaySchedule : "uses"
    StudentWork ||--o{ RecognitionRecord : "generates"
```
