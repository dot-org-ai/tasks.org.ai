...
```mermaid
erDiagram
    DockAppointment ||--|| LoadPlan : "schedules"
    LoadPlan ||--o{ CargoUnit : "positions"
    CargoUnit ||--|| SecurementDevice : "restrained-by"
    LoadPlan ||--|| BillOfLading : "documented-on"
    LoadPlan ||--|| WeightTicket : "weighed-on"
    CargoUnit }o--|| BillOfLading : "listed-on"
```
...
stateDiagram-v2
    ...
    Scheduled --> Planned : loadPlanCreated
    Planned --> Loading : cargoLoaded
    Loading --> Secured : cargoSecured
    Secured --> Counted : loadCountVerified
    Counted --> Weighed : weightRecorded
    Weighed --> Planned : overweightDetected
    Weighed --> [*]
```
## Workflow
