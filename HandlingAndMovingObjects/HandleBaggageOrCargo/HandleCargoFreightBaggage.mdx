...
```mermaid
erDiagram
    Shipment ||--o{ BaggagePiece : "contains"
    Shipment ||--|| ManifestRecord : "listed-on"
    Shipment ||--|| StagingArea : "held-in"
    BaggagePiece ||--o{ HandlingEvent : "tracked-by"
    BaggagePiece ||--o| DamageReport : "documented-in"
    HandlingEvent }o--|| StagingArea : "occurs-at"
```
...
stateDiagram-v2
    ...
    Received --> Identified : cargoIdentified
    Identified --> Staged : freightStaged
    Staged --> Transferred : cargoTransferred
    Transferred --> Routed : baggageRouted
    Routed --> Dispatched : shipmentDispatched
    Routed --> Staged : damageDetected
    Dispatched --> [*]
```
## Workflow
