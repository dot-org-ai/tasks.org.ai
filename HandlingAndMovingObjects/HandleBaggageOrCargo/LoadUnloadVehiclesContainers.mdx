...
```mermaid
erDiagram
    Vehicle ||--o{ Container : "defines"
    Vehicle ||--|{ PalletLoad : "generates"
    Vehicle }o--|| DockDoor : "uses"
    Vehicle ||--|| SealRecord : "tracked-by"
    Vehicle ||--o{ YardLocation : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : dockDoorAssigned
    InProgress --> Verified : sealBroken
    Verified --> Approved : vehicleUnloaded
    Approved --> Active : vehicleLoaded
    Active --> Complete : sealApplied
