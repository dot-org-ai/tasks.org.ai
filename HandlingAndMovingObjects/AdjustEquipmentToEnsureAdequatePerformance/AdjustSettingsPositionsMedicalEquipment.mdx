...
```mermaid
erDiagram
    ClinicalEngineer ||--|| Nurse : follows
    ClinicalEngineer }o--|| Physician : generates
    ClinicalEngineer ||--|{ Patient : requires
    ClinicalEngineer ||--o{ Manufacturer : tracks
    ClinicalEngineer ||--|| RegulatoryBody : validates
    Nurse ||--|{ ClinicalEngineer : creates
    Physician ||--o{ ClinicalEngineer : documents
    Patient ||--|| ClinicalEngineer : supports
```
...
stateDiagram-v2
    [*] --> Clinical_Engineer
    Clinical_Engineer --> Nurse: Nurse
    Nurse --> Physician: Physician
    Physician --> Patient: Patient
    Patient --> Manufacturer: Manufacturer
    Manufacturer --> Regulatory_Body: RegulatoryBody
