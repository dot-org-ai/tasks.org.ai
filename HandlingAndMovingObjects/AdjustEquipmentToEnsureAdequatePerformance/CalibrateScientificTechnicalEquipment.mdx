...
```mermaid
erDiagram
    LabTechnician ||--|| MetrologySpecialist : follows
    LabTechnician }o--|| QualityAssuranceOfficer : generates
    LabTechnician ||--|{ Researcher : requires
    LabTechnician ||--o{ AccreditationAuditor : tracks
    LabTechnician ||--|| ManufacturerSupport : validates
    MetrologySpecialist ||--|{ LabTechnician : creates
    QualityAssuranceOfficer ||--o{ LabTechnician : documents
    Researcher ||--|| LabTechnician : supports
```
...
stateDiagram-v2
    [*] --> Lab_Technician
    Lab_Technician --> Metrology_Specialist: MetrologySpecialist
    Metrology_Specialist --> Quality_Assurance_Officer: QualityAssuranceOfficer
    Quality_Assurance_Officer --> Researcher: Researcher
    Researcher --> Accreditation_Auditor: AccreditationAuditor
    Accreditation_Auditor --> Manufacturer_Support: ManufacturerSupport
    Researcher --> Metrology_Specialist: QualityAssuranceOfficer
