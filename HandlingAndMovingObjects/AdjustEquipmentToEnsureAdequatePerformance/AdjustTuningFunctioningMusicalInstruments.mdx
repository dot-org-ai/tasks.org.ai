...
```mermaid
erDiagram
    PianoTechnician ||--|| StringTechnician : follows
    PianoTechnician }o--|| WindTechnician : generates
    PianoTechnician ||--|{ Musician : requires
    PianoTechnician ||--o{ StageManager : tracks
    PianoTechnician ||--|| MusicDirector : validates
    StringTechnician ||--|{ PianoTechnician : creates
    WindTechnician ||--o{ PianoTechnician : documents
    Musician ||--|| PianoTechnician : supports
```
...
stateDiagram-v2
    [*] --> Piano_Technician
    Piano_Technician --> String_Technician: StringTechnician
    String_Technician --> Wind_Technician: WindTechnician
    Wind_Technician --> Musician: Musician
    Musician --> Stage_Manager: StageManager
    Stage_Manager --> Music_Director: MusicDirector
    Musician --> String_Technician: WindTechnician
    Music_Director --> [*]
```
