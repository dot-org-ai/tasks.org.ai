...
```mermaid
erDiagram
    Fastener ||--|| TorqueSpecification : "governed by"
    Fastener ||--o{ TensionReading : "verified with"
    TorqueSequence ||--o{ Fastener : "orders"
    CalibrationCertificate ||--|| TorqueSequence : "certifies tool for"
    JointRecord ||--o{ TensionReading : "documents"
    JointRecord ||--o{ Fastener : "tracks history of"
```
...
stateDiagram-v2
    [*] --> TorqueApplied
    TorqueApplied --> SequenceCompleted : sequenceCompleted
    SequenceCompleted --> TensionVerifying : tensionVerified
    TensionVerifying --> FastenerMarked : fastenerMarked
    FastenerMarked --> TorqueDocumented : torqueDocumented
    TorqueDocumented --> RetorqueCompleting : retorqueCompleted
    RetorqueCompleting --> TensionVerifying : tensionVerified
    TorqueDocumented --> ToolCalibrated : toolCalibrated
    ToolCalibrated --> TorqueApplied : torqueApplied
    TorqueDocumented --> [*]
```
