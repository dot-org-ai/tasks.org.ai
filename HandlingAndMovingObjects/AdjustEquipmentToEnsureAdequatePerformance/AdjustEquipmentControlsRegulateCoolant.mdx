...
```mermaid
erDiagram
    EquipmentOperator ||--|| MaintenanceTechnician : follows
    EquipmentOperator }o--|| CoolantSupplier : generates
    EquipmentOperator ||--|{ ProcessEngineer : requires
    EquipmentOperator ||--o{ SafetyOfficer : tracks
    EquipmentOperator ||--|| EnvironmentalCompliance : validates
    MaintenanceTechnician ||--|{ EquipmentOperator : creates
    CoolantSupplier ||--o{ EquipmentOperator : documents
    ProcessEngineer ||--|| EquipmentOperator : supports
```
...
stateDiagram-v2
    [*] --> Equipment_Operator
    Equipment_Operator --> Maintenance_Technician: MaintenanceTechnician
    Maintenance_Technician --> Coolant_Supplier: CoolantSupplier
    Coolant_Supplier --> Process_Engineer: ProcessEngineer
    Process_Engineer --> Safety_Officer: SafetyOfficer
    Safety_Officer --> Environmental_Compliance: EnvironmentalCompliance
    Process_Engineer --> Maintenance_Technician: CoolantSupplier
