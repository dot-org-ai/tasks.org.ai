...
```mermaid
erDiagram
    Equipment ||--o{ PerformanceMetric : "measured by"
    Equipment ||--o{ Adjustment : "modified through"
    Adjustment ||--|| CalibrationRecord : "documented in"
    PerformanceTest ||--|| Equipment : "validates"
    MaintenanceLog ||--o{ Adjustment : "archives"
    CalibrationRecord ||--o{ PerformanceTest : "verified by"
```
...
stateDiagram-v2
    [*] --> Inspected
    Inspected --> DeviationFound : deviationIdentified
    DeviationFound --> ParametersAdjusted : parametersAdjusted
    ParametersAdjusted --> Testing : performanceTested
    Testing --> Documented : changesDocumented
    Testing --> DeviationFound : deviationIdentified
    Documented --> Certified : readinessCertified
    Certified --> Inspected : equipmentInspected
    Certified --> [*]
```
