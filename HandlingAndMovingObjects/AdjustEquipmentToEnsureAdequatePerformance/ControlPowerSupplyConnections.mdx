...
```mermaid
erDiagram
    Electrician ||--|| FacilitiesOperator : follows
    Electrician }o--|| ProductionSupervisor : generates
    Electrician ||--|{ SafetyOfficer : requires
    Electrician ||--o{ UtilityProvider : tracks
    Electrician ||--|| EquipmentVendor : validates
    FacilitiesOperator ||--|{ Electrician : creates
    ProductionSupervisor ||--o{ Electrician : documents
    SafetyOfficer ||--|| Electrician : supports
```
...
stateDiagram-v2
    [*] --> Electrician
    Electrician --> Facilities_Operator: FacilitiesOperator
    Facilities_Operator --> Production_Supervisor: ProductionSupervisor
    Production_Supervisor --> Safety_Officer: SafetyOfficer
    Safety_Officer --> Utility_Provider: UtilityProvider
    Utility_Provider --> Equipment_Vendor: EquipmentVendor
    Safety_Officer --> Facilities_Operator: ProductionSupervisor
    Equipment_Vendor --> [*]
```
