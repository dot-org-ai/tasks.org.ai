...
```mermaid
erDiagram
    CalibrationTechnician ||--|| MetrologyLab : follows
    CalibrationTechnician }o--|| QualityManager : generates
    CalibrationTechnician ||--|{ EquipmentOperator : requires
    CalibrationTechnician ||--o{ Auditor : tracks
    CalibrationTechnician ||--|| AccreditationBody : validates
    MetrologyLab ||--|{ CalibrationTechnician : creates
    QualityManager ||--o{ CalibrationTechnician : documents
    EquipmentOperator ||--|| CalibrationTechnician : supports
```
...
stateDiagram-v2
    ...
    Calibration_Technician --> Metrology_Lab: MetrologyLab
    Metrology_Lab --> Quality_Manager: QualityManager
    Quality_Manager --> Equipment_Operator: EquipmentOperator
    Equipment_Operator --> Auditor: Auditor
    Auditor --> Accreditation_Body: AccreditationBody
    Equipment_Operator --> Metrology_Lab: QualityManager
    Accreditation_Body --> [*]
```
