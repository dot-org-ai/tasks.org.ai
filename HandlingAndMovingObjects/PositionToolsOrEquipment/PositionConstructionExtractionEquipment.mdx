...
```mermaid
erDiagram
    Equipment ||--o{ PositioningPlan : "requires"
    PositioningPlan ||--|| SiteLocation : "targets"
    Equipment ||--|| SetupConfiguration : "has"
    Equipment ||--o{ SafetyZone : "generates"
    SiteLocation ||--o{ SafetyZone : "contains"
    Equipment ||--o{ UtilizationRecord : "generates"
```
...
stateDiagram-v2
    [*] --> Scheduled
    Scheduled --> TransportReady
    TransportReady --> InTransit
    InTransit --> OnSite
    OnSite --> Positioning
    Positioning --> Configured
    Positioning --> GroundIssue
    GroundIssue --> Positioning
    Configured --> Operational
    Operational --> Maintenance
    Maintenance --> Operational
    Operational --> Relocated
    Relocated --> Positioning
    Operational --> [*]
```
