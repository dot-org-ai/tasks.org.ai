...
```mermaid
erDiagram
    Trap ||--o{ TrapLocation : "defines"
    Trap ||--|{ Deployment : "generates"
    Trap }o--|| TargetSpecies : "uses"
    Trap ||--|| Capture : "tracked-by"
    Trap ||--o{ Inspection : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : deploymentPlanned
    InProgress --> Verified : trapPositioned
    Verified --> Approved : trapActivated
    Approved --> Active : trapMonitored
    Active --> Complete : captureRecorded
