...
```mermaid
erDiagram
    Mold ||--o{ ProcessRun : "defines"
    Mold ||--|{ Adjustment : "generates"
    Mold }o--|| ProcessParameter : "uses"
    Mold ||--|| AdjustmentRecord : "tracked-by"
    Mold ||--o{ QualityMeasurement : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : driftDetected
    InProgress --> Verified : adjustmentCalculated
    Verified --> Approved : moldAdjusted
    Approved --> Active : adjustmentVerified
    Active --> Complete : adjustmentDocumented
