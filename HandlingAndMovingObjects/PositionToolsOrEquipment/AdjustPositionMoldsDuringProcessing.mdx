...
```mermaid
erDiagram
    ProcessRun ||--|| Mold : "operates"
    Mold ||--o{ Adjustment : "repositioned-by"
    ProcessParameter ||--|| Mold : "monitored-for"
    Adjustment ||--|| AdjustmentRecord : "logged-in"
    Adjustment ||--o{ QualityMeasurement : "validated-by"
```
...
stateDiagram-v2
    [*] --> DriftDetected
    DriftDetected --> AdjustmentCalculated : adjustmentCalculated
    AdjustmentCalculated --> MoldAdjusted : moldAdjusted
    MoldAdjusted --> AdjustmentVerified : adjustmentVerified
    AdjustmentVerified --> MoldAdjusted : adjustmentCalculated
    AdjustmentVerified --> ProcessStabilized : processStabilized
    ProcessStabilized --> DriftDetected : driftDetected
    ProcessStabilized --> AdjustmentDocumented : adjustmentDocumented
