...
```mermaid
erDiagram
    MaterialHandlingEquipment ||--|| EquipmentPosition : "located-at"
    PositioningPlan ||--o{ MaterialHandlingEquipment : "assigns"
    EquipmentPosition ||--|| TrafficZone : "within"
    MaterialHandlingEquipment ||--o{ UtilizationRecord : "generates"
    MaterialHandlingEquipment ||--o{ ChargingStation : "charges-at"
    TrafficZone ||--o{ EquipmentPosition : "contains"
```
...
stateDiagram-v2
    [*] --> Available
    Available --> Assigned
    Assigned --> InOperation
    InOperation --> Parked
    Parked --> Charging
    Charging --> Available
    InOperation --> Maintenance
    Maintenance --> Available
    InOperation --> Relocated
    Relocated --> Assigned
    InOperation --> [*]
```
