...
```mermaid
erDiagram
    PositioningJob ||--|| Equipment : "positions"
    PositioningJob ||--|| PlacementSpec : "follows"
    PositioningJob ||--o{ Tool : "uses"
    ToolSelection ||--o{ Tool : "includes"
    PositioningJob ||--|| ToolSelection : "requires"
    PositioningJob ||--o{ Verification : "undergoes"
```
...
stateDiagram-v2
    [*] --> Scheduled
    Scheduled --> ToolsSelected
    ToolsSelected --> Prepared
    Prepared --> Positioning
    Positioning --> Verification
    Verification --> OutOfSpec
    OutOfSpec --> Positioning
