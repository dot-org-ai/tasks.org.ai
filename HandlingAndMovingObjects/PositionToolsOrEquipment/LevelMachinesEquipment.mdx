...
```mermaid
erDiagram
    Equipment ||--|| LevelingSpec : "governed-by"
    LevelingJob ||--|| Equipment : "targets"
    LevelingJob ||--o{ Measurement : "captures"
    LevelingJob ||--|| LevelingReport : "documented-in"
    Equipment ||--|| LevelCertificate : "certified-by"
```
...
stateDiagram-v2
    [*] --> LevelingJobCreated
    LevelingJobCreated --> LevelMeasured : levelMeasured
    LevelMeasured --> FootingAdjusted : levelExceeded
    FootingAdjusted --> LevelMeasured : levelMeasured
    LevelMeasured --> LevelVerified : levelVerified
    LevelVerified --> LevelApproved : levelApproved
    LevelApproved --> RelevelScheduled : relevelScheduled
    RelevelScheduled --> [*]
```
## Workflow
