...
```mermaid
erDiagram
    Workpiece ||--|| ProductionMachine : "uses"
    Workpiece ||--|| ExtractionProcedure : "uses"
    Workpiece ||--o{ CycleRecord : "generates"
    Workpiece ||--|| StagingArea : "uses"
    HandlingSpec ||--o{ Workpiece : "defines"
```
