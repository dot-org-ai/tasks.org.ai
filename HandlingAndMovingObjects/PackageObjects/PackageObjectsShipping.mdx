...
erDiagram
    ...
    Order ||--|| ShippingBox : "packed-into"
    ShippingBox ||--|| ShippingLabel : "addressed-by"
    Order ||--|| CarrierService : "shipped-via"
    ShippingLabel ||--|| TrackingNumber : "assigned"
```
...
stateDiagram-v2
    [*] --> OrderFulfilled
    OrderFulfilled --> CarrierServiceSelected : carrierServiceSelected
    CarrierServiceSelected --> BoxSizeSelected : boxSizeSelected
    BoxSizeSelected --> ProtectionWrapped : protectionWrapped
    ProtectionWrapped --> ItemsPacked : itemsPacked
    ItemsPacked --> LabelGenerated : labelGenerated
    LabelGenerated --> PickupScheduled : pickupScheduled
    PickupScheduled --> OrderFulfilled : orderFulfilled
    PickupScheduled --> [*]
```
## Workflow
