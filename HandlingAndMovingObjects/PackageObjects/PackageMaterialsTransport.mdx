...
```mermaid
erDiagram
    Shipment ||--o{ TransportMode : "defines"
    Shipment ||--|{ ProtectivePackaging : "generates"
    Shipment }o--|| Pallet : "uses"
    Shipment ||--|| BillOfLading : "tracked-by"
    Shipment ||--o{ HazmatDeclaration : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : transportNeedsAssessed
    InProgress --> Verified : protectionSelected
    Verified --> Approved : shockAbsorptionApplied
    Approved --> Active : loadSecured
    Active --> Complete : documentationGenerated
