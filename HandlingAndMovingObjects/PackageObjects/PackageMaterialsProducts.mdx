...
erDiagram
    ...
    Material ||--|{ Container : "generates"
    Material }o--|| Cushioning : "uses"
    Material ||--|| Label : "tracked-by"
    Material ||--o{ PackagingOrder : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : orderCreated
    InProgress --> Verified : packagingSelected
    Verified --> Approved : itemsPrepared
    Approved --> Active : cushioningInserted
    Active --> Complete : itemsPlaced
