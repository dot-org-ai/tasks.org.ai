...
```mermaid
erDiagram
    FoodItem ||--o{ Supply : "defines"
    FoodItem ||--|{ Portion : "generates"
    FoodItem }o--|| Package : "uses"
    FoodItem ||--|| NutritionLabel : "tracked-by"
    FoodItem ||--o{ Batch : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : workspaceSanitized
    InProgress --> Verified : itemPortioned
    Verified --> Approved : packageFilled
    Approved --> Active : containerSealed
    Active --> Complete : labelAttached
