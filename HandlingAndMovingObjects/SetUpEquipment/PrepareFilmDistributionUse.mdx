...
```mermaid
erDiagram
    FilmReel ||--|| DigitalCinemaPackage : "uses"
    PrintInspectionReport ||--o{ FilmReel : "defines"
    FilmReel ||--|| ShipmentManifest : "uses"
    DistributionOrder ||--o{ FilmReel : "contains"
    FilmReel ||--o{ PreservationRecord : "generates"
```
