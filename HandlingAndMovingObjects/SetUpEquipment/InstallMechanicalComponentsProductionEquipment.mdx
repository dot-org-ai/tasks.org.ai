...
```mermaid
erDiagram
    MechanicalComponent ||--|| Equipment : "uses"
    MechanicalComponent ||--|| InstallationProcedure : "uses"
    TorqueSpecification ||--o{ MechanicalComponent : "defines"
    MechanicalComponent ||--o{ AlignmentRecord : "generates"
    WorkOrder ||--o{ MechanicalComponent : "contains"
```
