...
```mermaid
erDiagram
    SetupSheet ||--|| ToolingKit : "uses"
    ProductionOrder ||--o{ SetupSheet : "contains"
    SetupSheet ||--|| FirstArticle : "uses"
    SetupSheet ||--|| MachineParameter : "uses"
    SetupSheet ||--o{ ChangeoverLog : "generates"
```
