...
```mermaid
erDiagram
    Attachment ||--|| BaseEquipment : "uses"
    Attachment ||--|| CouplingSystem : "uses"
    Attachment ||--|| InstallationChecklist : "uses"
    Attachment ||--|| LoadRating : "uses"
    Attachment ||--|| ConnectionPoint : "uses"
```
