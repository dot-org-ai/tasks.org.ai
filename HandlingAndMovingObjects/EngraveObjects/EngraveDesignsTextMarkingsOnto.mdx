...
```mermaid
erDiagram
    EngravingDesign ||--o{ Workpiece : "defines"
    EngravingDesign ||--|{ EngravingTool : "generates"
    EngravingDesign }o--|| FixtureSetup : "uses"
    EngravingDesign ||--|| DepthSetting : "tracked-by"
    EngravingDesign ||--o{ ProofApproval : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : designPrepared
    InProgress --> Verified : proofApproved
    Verified --> Approved : workpieceFixtured
    Approved --> Active : parametersConfigured
    Active --> Complete : engravingCompleted
