...
```mermaid
erDiagram
    EngravingDesign ||--|| ProofApproval : "approved-via"
    EngravingDesign ||--o{ Workpiece : "applied-to"
    Workpiece ||--|| FixtureSetup : "secured-in"
    EngravingTool ||--|| DepthSetting : "calibrated-to"
    EngravingTool ||--o{ Workpiece : "marks"
    Workpiece ||--|| QualityReport : "verified-in"
```
...
```mermaid
stateDiagram-v2
    [*] --> Designed : designPrepared
    Designed --> ProofApproved : proofApproved
    ProofApproved --> Fixtured : workpieceFixtured
    Fixtured --> Configured : parametersConfigured
    Configured --> Engraved : engravingCompleted
    Engraved --> Verified : qualityVerified
    Verified --> Finished : surfaceFinished
    Verified --> Configured : qualityVerified
    Finished --> [*]
```
## Workflow
