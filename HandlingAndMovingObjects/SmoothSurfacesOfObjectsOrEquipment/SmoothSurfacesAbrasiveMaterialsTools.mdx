...
```mermaid
erDiagram
    AbrasiveProduct ||--|| Workpiece : "uses"
    AbrasiveProduct ||--|| GritSequence : "uses"
    AbrasiveProduct ||--|| SurfacePrep : "uses"
    AbrasiveProduct ||--|| DustCollection : "uses"
    AbrasiveProduct ||--|| RoughnessReading : "uses"
```
