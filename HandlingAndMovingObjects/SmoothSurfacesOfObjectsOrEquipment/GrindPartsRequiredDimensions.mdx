...
```mermaid
erDiagram
    GrindingMachine ||--|| GrindingWheel : "uses"
    GrindingMachine ||--|| Workpiece : "uses"
    DimensionalSpec ||--o{ GrindingMachine : "defines"
    SurfaceFinishSpec ||--o{ GrindingMachine : "defines"
    GrindingMachine ||--|| SetupSheet : "uses"
```
