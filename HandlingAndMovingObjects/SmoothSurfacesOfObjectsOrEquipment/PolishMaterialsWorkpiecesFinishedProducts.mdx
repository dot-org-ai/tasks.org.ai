...
```mermaid
erDiagram
    Workpiece ||--|| PolishingCompound : "uses"
    Workpiece ||--|| BuffingWheel : "uses"
    LusterSpec ||--o{ Workpiece : "defines"
    Workpiece ||--|| PolishingSequence : "uses"
    Workpiece ||--o{ FinishRecord : "generates"
```
