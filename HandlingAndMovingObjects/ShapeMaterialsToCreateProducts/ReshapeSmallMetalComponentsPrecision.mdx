...
```mermaid
erDiagram
    Component ||--|| MicroTolerance : "uses"
    Component ||--|| FormingStation : "uses"
    Component ||--|| CoiningOperation : "uses"
    Component ||--|| OpticalMeasurement : "uses"
    Component ||--|| ProcessCapability : "uses"
```
