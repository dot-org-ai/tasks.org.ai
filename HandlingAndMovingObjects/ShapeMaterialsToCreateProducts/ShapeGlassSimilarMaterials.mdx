...
```mermaid
erDiagram
    Workpiece ||--|| Mold : "cast-in"
    Workpiece ||--o{ BatchRecord : "tracked-by"
    QualitySpec ||--|| Workpiece : "governs"
    Workpiece ||--|| FiringSchedule : "annealed-per"
    Inventory ||--|{ Workpiece : "stores"
```
...
stateDiagram-v2
    ...
    Prepared --> Heated : materialHeated
    Heated --> Formed : shapeFormed
    Formed --> Annealing : pieceAnnealed
    Annealing --> Finished : surfaceFinished
    Finished --> Inspected : qualityInspected
    Inspected --> Recorded : batchRecorded
    Inspected --> Heated : reheatRequired
    Recorded --> [*]
```
