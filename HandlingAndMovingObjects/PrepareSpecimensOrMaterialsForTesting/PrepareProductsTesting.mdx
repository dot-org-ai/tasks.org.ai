...
```mermaid
erDiagram
    TestSpecimen ||--o{ TestProduct : "defines"
    TestProduct ||--|| TestPlan : "uses"
    TestProduct ||--|| Conditioning : "uses"
    TestProduct ||--|| SamplingPlan : "uses"
    PreTestInspection ||--o{ TestProduct : "defines"
```
