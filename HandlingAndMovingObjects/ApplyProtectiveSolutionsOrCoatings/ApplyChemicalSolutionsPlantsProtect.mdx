...
```mermaid
erDiagram
    TreatmentPlan ||--o{ Application : "schedules"
    Application ||--|| ChemicalProduct : "delivers"
    ChemicalProduct ||--|| TargetPest : "controls"
    TreatmentArea ||--o{ Application : "receives"
    SafetyRecord ||--|| Application : "documents compliance of"
    TreatmentPlan ||--|| TargetPest : "addresses"
```
...
stateDiagram-v2
    [*] --> TreatmentPlanned
    TreatmentPlanned --> PestIdentified : pestIdentified
    PestIdentified --> ChemicalSelected : chemicalSelected
    ChemicalSelected --> ApplicationScheduled : applicationScheduled
    ApplicationScheduled --> ChemicalApplied : chemicalApplied
    ChemicalApplied --> EffectivenessMonitored : effectivenessMonitored
    EffectivenessMonitored --> ComplianceRecorded : complianceRecorded
    EffectivenessMonitored --> TreatmentPlanned : treatmentPlanned
    ComplianceRecorded --> [*]
```
