...
```mermaid
erDiagram
    Equipment ||--|| Solution : "treated with"
    ApplicationSchedule ||--|| Equipment : "plans service for"
    ApplicationRecord ||--|| Solution : "documents usage of"
    PerformanceMetric ||--|| Solution : "measures effectiveness of"
    SafetyProcedure ||--|| Solution : "governs handling of"
    ApplicationRecord ||--|| Equipment : "tracks treatment of"
```
...
stateDiagram-v2
    [*] --> SolutionSelected
    SolutionSelected --> EquipmentPrepared : equipmentPrepared
    EquipmentPrepared --> SolutionApplied : solutionApplied
    SolutionApplied --> CoverageVerified : coverageVerified
    CoverageVerified --> EffectivenessMonitored : effectivenessMonitored
    EffectivenessMonitored --> UsageRecorded : usageRecorded
    UsageRecorded --> SolutionDisposed : solutionDisposed
    EffectivenessMonitored --> SolutionSelected : solutionSelected
    SolutionDisposed --> [*]
```
