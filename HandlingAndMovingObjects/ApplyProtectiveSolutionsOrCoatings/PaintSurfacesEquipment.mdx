...
```mermaid
erDiagram
    PaintingProject ||--o{ AssetToCoat : "encompasses"
    AssetToCoat ||--|| IndustrialCoating : "protected by"
    SurfacePreparation ||--|| AssetToCoat : "readies"
    ApplicationSpecification ||--|| IndustrialCoating : "defines parameters for"
    InspectionCertificate ||--|| PaintingProject : "certifies quality of"
    AssetToCoat ||--|| InspectionCertificate : "verified in"
```
...
stateDiagram-v2
    [*] --> ConditionAssessed
    ConditionAssessed --> CoatingSpecified : coatingSpecified
    CoatingSpecified --> AssetPrepared : assetPrepared
    AssetPrepared --> PrimerApplied : primerApplied
    PrimerApplied --> TopcoatApplied : topcoatApplied
    TopcoatApplied --> ThicknessMeasured : thicknessMeasured
    ThicknessMeasured --> TopcoatApplied : topcoatApplied
    ThicknessMeasured --> CompletionCertified : completionCertified
    CompletionCertified --> [*]
```
