...
```mermaid
erDiagram
    PaintJob ||--o{ Surface : "encompasses"
    Surface ||--|| Coating : "covered with"
    ColorSpecification ||--|| Coating : "defines color for"
    ApplicationMethod ||--|| Coating : "delivers"
    InspectionReport ||--|| PaintJob : "verifies quality of"
    Surface ||--|| InspectionReport : "evaluated in"
```
...
stateDiagram-v2
    [*] --> SurfacePrepared
    SurfacePrepared --> PaintSelected : paintSelected
    PaintSelected --> CoverageCalculated : coverageCalculated
    CoverageCalculated --> PrimerApplied : primerApplied
    PrimerApplied --> PaintApplied : paintApplied
    PaintApplied --> FinishInspected : finishInspected
    FinishInspected --> DefectsCorrected : defectsCorrected
    DefectsCorrected --> FinishInspected : finishInspected
    FinishInspected --> [*]
```
