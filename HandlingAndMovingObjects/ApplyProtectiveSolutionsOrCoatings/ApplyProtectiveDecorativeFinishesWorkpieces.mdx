...
```mermaid
erDiagram
    CoatingSupplier ||--|| QualityLab : follows
    CoatingSupplier }o--|| Customer : generates
    CoatingSupplier ||--|{ EnvironmentalAgency : requires
    CoatingSupplier ||--o{ EquipmentManufacturer : tracks
    CoatingSupplier ||--|| PretreatmentChemicalSupplier : validates
    QualityLab ||--|{ CoatingSupplier : creates
    Customer ||--o{ CoatingSupplier : documents
    EnvironmentalAgency ||--|| CoatingSupplier : supports
```
...
stateDiagram-v2
    [*] --> Coating_Supplier
    Coating_Supplier --> Quality_Lab: QualityLab
    Quality_Lab --> Customer: Customer
    Customer --> Environmental_Agency: EnvironmentalAgency
    Environmental_Agency --> Equipment_Manufacturer: EquipmentManufacturer
    Equipment_Manufacturer --> Pretreatment_Chemical_Supplier: PretreatmentChemicalSupplier
    Environmental_Agency --> Quality_Lab: Customer
    Pretreatment_Chemical_Supplier --> [*]
```
