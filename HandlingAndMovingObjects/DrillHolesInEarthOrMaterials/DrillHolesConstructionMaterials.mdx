...
```mermaid
erDiagram
    DrillingPlan ||--o{ HoleLocation : "defines"
    DrillingPlan ||--|{ DrillBit : "generates"
    DrillingPlan }o--|| Hole : "uses"
    DrillingPlan ||--|| DebrisCollection : "tracked-by"
    DrillingPlan ||--o{ InspectionReport : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : holesLaidOut
    InProgress --> Verified : drillBitSelected
    Verified --> Approved : holeDrilled
    Approved --> Active : dimensionsVerified
    Active --> Complete : debrisCleaned
