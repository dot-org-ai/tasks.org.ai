...
```mermaid
erDiagram
    WorkOrder ||--o{ Workpiece : "defines"
    WorkOrder ||--|{ DrillFixture : "generates"
    WorkOrder }o--|| DrillBit : "uses"
    WorkOrder ||--|| DrilledHole : "tracked-by"
    WorkOrder ||--o{ InspectionReport : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : workOrderLoaded
    InProgress --> Verified : fixtureSetup
    Verified --> Approved : toolingSelected
    Approved --> Active : holeDrilled
    Active --> Complete : holeDenurred
