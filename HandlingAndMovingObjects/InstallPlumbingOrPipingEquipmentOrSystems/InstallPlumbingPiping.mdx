...
```mermaid
erDiagram
    PipeRun ||--o{ Fitting : "defines"
    PipeRun ||--|{ Fixture : "generates"
    PipeRun }o--|| Valve : "uses"
    PipeRun ||--|| PressureTest : "tracked-by"
    PipeRun ||--o{ WorkOrder : "includes"
```
...
stateDiagram-v2
    ...
    InProgress --> Verified : pipeCut
    Verified --> Approved : pipingAssembled
    Approved --> Active : fixturesConnected
    Active --> Complete : pressureTestPassed
