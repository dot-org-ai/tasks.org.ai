...
```mermaid
erDiagram
    Impression ||--o{ CastModel : "defines"
    Impression ||--|{ ImpressionMaterial : "generates"
    Impression }o--|| CastingStone : "uses"
    Impression ||--|| DevicePrescription : "tracked-by"
    Impression ||--o{ DimensionalReport : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : patientPrepared
    InProgress --> Verified : impressionTaken
    Verified --> Approved : castPoured
    Approved --> Active : modelTrimmed
    Active --> Complete : accuracyVerified
