...
```mermaid
erDiagram
    CustomDevice ||--o{ WaxPattern : "defines"
    CustomDevice ||--|{ CastFramework : "generates"
    CustomDevice }o--|| AcrylicBase : "uses"
    CustomDevice ||--|| TryInRecord : "tracked-by"
    CustomDevice ||--o{ ShadeMatch : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : orderInterpreted
    InProgress --> Verified : waxupCreated
    Verified --> Approved : frameworkCast
    Approved --> Active : materialLayered
    Active --> Complete : tryInCompleted
