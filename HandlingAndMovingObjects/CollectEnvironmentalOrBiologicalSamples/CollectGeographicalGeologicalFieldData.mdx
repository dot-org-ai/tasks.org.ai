...
```mermaid
erDiagram
    FieldCampaign ||--o{ SurveySite : "defines"
    FieldCampaign ||--|{ Measurement : "generates"
    FieldCampaign }o--|| FieldNotebook : "uses"
    FieldCampaign ||--|| GeospatialDataset : "tracked-by"
    FieldCampaign ||--o{ Instrument : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : campaignPlanned
    InProgress --> Verified : instrumentCalibrated
    Verified --> Approved : measurementRecorded
    Approved --> Active : observationLogged
    Active --> Complete : dataValidated
