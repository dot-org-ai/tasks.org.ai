...
```mermaid
erDiagram
    Specimen ||--o{ CollectionSite : "defines"
    Specimen ||--|{ Permit : "generates"
    Specimen }o--|| PreservationMethod : "uses"
    Specimen ||--|| Catalog : "tracked-by"
    Specimen ||--o{ ChainOfCustody : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : collectionPlanned
    InProgress --> Verified : permitsObtained
    Verified --> Approved : specimenCollected
    Approved --> Active : specimenPreserved
    Active --> Complete : specimenLabeled
