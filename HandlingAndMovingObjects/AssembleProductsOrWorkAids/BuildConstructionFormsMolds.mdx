...
```mermaid
erDiagram
    LumberYard ||--|| ConcreteContractor : follows
    LumberYard }o--|| EngineeringFirm : generates
    LumberYard ||--|{ SafetyInspector : requires
    LumberYard ||--o{ EquipmentRental : tracks
    LumberYard ||--|| MaterialRecycler : validates
    ConcreteContractor ||--|{ LumberYard : creates
    EngineeringFirm ||--o{ LumberYard : documents
    SafetyInspector ||--|| LumberYard : supports
```
...
stateDiagram-v2
    [*] --> Lumber_Yard
    Lumber_Yard --> Concrete_Contractor: ConcreteContractor
    Concrete_Contractor --> Engineering_Firm: EngineeringFirm
    Engineering_Firm --> Safety_Inspector: SafetyInspector
    Safety_Inspector --> Equipment_Rental: EquipmentRental
    Equipment_Rental --> Material_Recycler: MaterialRecycler
    Safety_Inspector --> Concrete_Contractor: EngineeringFirm
    Material_Recycler --> [*]
```
