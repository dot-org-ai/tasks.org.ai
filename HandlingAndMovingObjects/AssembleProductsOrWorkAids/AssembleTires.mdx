...
```mermaid
erDiagram
    RubberSupplier ||--|| ReinforcementVendor : follows
    RubberSupplier }o--|| TireDesigner : generates
    RubberSupplier ||--|{ QualityLab : requires
    RubberSupplier ||--o{ DistributionCenter : tracks
    RubberSupplier ||--|| VehicleManufacturer : validates
    ReinforcementVendor ||--|{ RubberSupplier : creates
    TireDesigner ||--o{ RubberSupplier : documents
    QualityLab ||--|| RubberSupplier : supports
```
...
stateDiagram-v2
    [*] --> Rubber_Supplier
    Rubber_Supplier --> Reinforcement_Vendor: ReinforcementVendor
    Reinforcement_Vendor --> Tire_Designer: TireDesigner
    Tire_Designer --> Quality_Lab: QualityLab
    Quality_Lab --> Distribution_Center: DistributionCenter
    Distribution_Center --> Vehicle_Manufacturer: VehicleManufacturer
    Quality_Lab --> Reinforcement_Vendor: TireDesigner
