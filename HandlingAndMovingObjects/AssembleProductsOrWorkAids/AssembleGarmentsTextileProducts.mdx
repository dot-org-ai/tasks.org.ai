...
```mermaid
erDiagram
    FabricSupplier ||--|| PatternDesigner : follows
    FabricSupplier }o--|| ProductionPlanner : generates
    FabricSupplier ||--|{ QualityControl : requires
    FabricSupplier ||--o{ Retailer : tracks
    FabricSupplier ||--|| BrandOwner : validates
    PatternDesigner ||--|{ FabricSupplier : creates
    ProductionPlanner ||--o{ FabricSupplier : documents
    QualityControl ||--|| FabricSupplier : supports
```
...
stateDiagram-v2
    [*] --> Fabric_Supplier
    Fabric_Supplier --> Pattern_Designer: PatternDesigner
    Pattern_Designer --> Production_Planner: ProductionPlanner
    Production_Planner --> Quality_Control: QualityControl
    Quality_Control --> Retailer: Retailer
    Retailer --> Brand_Owner: BrandOwner
    Quality_Control --> Pattern_Designer: ProductionPlanner
    Brand_Owner --> [*]
```
