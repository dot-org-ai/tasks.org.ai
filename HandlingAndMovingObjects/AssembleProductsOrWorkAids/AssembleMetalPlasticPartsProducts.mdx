...
```mermaid
erDiagram
    ComponentManufacturer ||--|| ProductEngineer : follows
    ComponentManufacturer }o--|| ProductionScheduler : generates
    ComponentManufacturer ||--|{ QualityAssurance : requires
    ComponentManufacturer ||--o{ PackagingOperations : tracks
    ComponentManufacturer ||--|| EndCustomer : validates
    ProductEngineer ||--|{ ComponentManufacturer : creates
    ProductionScheduler ||--o{ ComponentManufacturer : documents
    QualityAssurance ||--|| ComponentManufacturer : supports
```
...
stateDiagram-v2
    ...
    Component_Manufacturer --> Product_Engineer: ProductEngineer
    Product_Engineer --> Production_Scheduler: ProductionScheduler
    Production_Scheduler --> Quality_Assurance: QualityAssurance
    Quality_Assurance --> Packaging_Operations: PackagingOperations
    Packaging_Operations --> End_Customer: EndCustomer
    Quality_Assurance --> Product_Engineer: ProductionScheduler
    End_Customer --> [*]
```
