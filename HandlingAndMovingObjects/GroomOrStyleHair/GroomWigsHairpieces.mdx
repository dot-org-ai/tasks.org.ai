...
```mermaid
erDiagram
    Wig ||--o{ Hairpiece : "defines"
    Wig ||--|{ ServiceOrder : "generates"
    Wig }o--|| CleaningProtocol : "uses"
    Wig ||--|| StyleSpecification : "tracked-by"
    Wig ||--o{ MaintenanceRecord : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : wigIntaken
    InProgress --> Verified : conditionAssessed
    Verified --> Approved : hairpieceCleaned
    Approved --> Active : hairDetangled
    Active --> Complete : hairpieceStyled
