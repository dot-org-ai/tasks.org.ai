...
```mermaid
erDiagram
    Appointment ||--o{ Consultation : "defines"
    Appointment ||--|{ HairProfile : "generates"
    Appointment }o--|| TrimSpecification : "uses"
    Appointment ||--|| ServiceRecord : "tracked-by"
    Appointment ||--o{ StylePhoto : "includes"
```
...
stateDiagram-v2
    ...
    InProgress --> Verified : consultationConducted
    Verified --> Approved : hairSectioned
    Approved --> Active : lengthTrimmed
    Active --> Complete : styleShaped
