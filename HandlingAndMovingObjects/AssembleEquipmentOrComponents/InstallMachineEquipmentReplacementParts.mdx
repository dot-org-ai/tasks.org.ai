...
```mermaid
erDiagram
    PartsVendor ||--|| MaintenancePlanner : follows
    PartsVendor }o--|| EquipmentManufacturer : generates
    PartsVendor ||--|{ QualityAssurance : requires
    PartsVendor ||--o{ ProductionControl : tracks
    PartsVendor ||--|| WarehouseOperations : validates
    MaintenancePlanner ||--|{ PartsVendor : creates
    EquipmentManufacturer ||--o{ PartsVendor : documents
    QualityAssurance ||--|| PartsVendor : supports
```
...
stateDiagram-v2
    [*] --> Parts_Vendor
    Parts_Vendor --> Maintenance_Planner: MaintenancePlanner
    Maintenance_Planner --> Equipment_Manufacturer: EquipmentManufacturer
    Equipment_Manufacturer --> Quality_Assurance: QualityAssurance
    Quality_Assurance --> Production_Control: ProductionControl
    Production_Control --> Warehouse_Operations: WarehouseOperations
    Quality_Assurance --> Maintenance_Planner: EquipmentManufacturer
