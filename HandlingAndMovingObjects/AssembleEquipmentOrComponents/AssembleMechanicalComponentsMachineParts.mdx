...
```mermaid
erDiagram
    PartsSupplier ||--|| EngineeringTeam : follows
    PartsSupplier }o--|| ProductionControl : generates
    PartsSupplier ||--|{ QualityAssurance : requires
    PartsSupplier ||--o{ EquipmentManufacturer : tracks
    PartsSupplier ||--|| WarehouseOperations : validates
    EngineeringTeam ||--|{ PartsSupplier : creates
    ProductionControl ||--o{ PartsSupplier : documents
...
stateDiagram-v2
    [*] --> Parts_Supplier
    Parts_Supplier --> Engineering_Team: EngineeringTeam
    Engineering_Team --> Production_Control: ProductionControl
    Production_Control --> Quality_Assurance: QualityAssurance
    Quality_Assurance --> Equipment_Manufacturer: EquipmentManufacturer
    Equipment_Manufacturer --> Warehouse_Operations: WarehouseOperations
    Quality_Assurance --> Engineering_Team: ProductionControl
