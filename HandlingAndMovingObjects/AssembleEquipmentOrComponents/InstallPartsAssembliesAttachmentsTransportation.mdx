...
```mermaid
erDiagram
    TransportationEquipment ||--o{ Attachment : "receives"
    Attachment ||--|| MountingHardware : "secured-with"
    Attachment ||--|| HydraulicConnection : "powered-by"
    TransportationEquipment ||--|| SafetyCertification : "certified-by"
    Attachment ||--|| OperatorManual : "documented-in"
    SafetyCertification ||--|| Attachment : "covers"
```
...
stateDiagram-v2
    [*] --> Preparing
    Preparing --> Mounting : equipmentPrepared
    Mounting --> HydraulicConnect : attachmentMounted
    HydraulicConnect --> ElectricalConnect : hydraulicsConnected
    ElectricalConnect --> Adjusting : electricalConnected
    Adjusting --> SafetyCheck : settingsAdjusted
    SafetyCheck --> Training : safetyCheckPerformed
    SafetyCheck --> Adjusting : safetyFailed
    Training --> [*] : operatorTrained
```
