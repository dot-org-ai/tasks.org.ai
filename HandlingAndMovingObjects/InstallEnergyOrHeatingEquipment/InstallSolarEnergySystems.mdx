...
```mermaid
erDiagram
    SystemDesign ||--o{ PVPanel : "specifies"
    PVPanel }o--|| RackingSystem : "mounted-on"
    PVPanel }o--|| Inverter : "converts-through"
    InstallationPermit ||--|| SystemDesign : "authorizes"
    InterconnectionAgreement ||--|| Inverter : "grid-ties"
    ProductionEstimate ||--|| SystemDesign : "forecasts"
```
...
stateDiagram-v2
    ...
    Assessed --> Designed : systemDesigned
    Designed --> Permitted : permitObtained
    Permitted --> RackingUp : rackingMounted
    RackingUp --> PanelsSet : panelsInstalled
    PanelsSet --> Wired : systemWired
