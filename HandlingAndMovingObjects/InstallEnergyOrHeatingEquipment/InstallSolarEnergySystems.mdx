...
```mermaid
erDiagram
    PVPanel ||--o{ Inverter : "defines"
    PVPanel ||--|{ RackingSystem : "generates"
    PVPanel }o--|| InterconnectionAgreement : "uses"
    PVPanel ||--|| SystemDesign : "tracked-by"
    PVPanel ||--o{ InstallationPermit : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : siteAssessed
    InProgress --> Verified : systemDesigned
    Verified --> Approved : permitObtained
    Approved --> Active : rackingMounted
    Active --> Complete : panelsInstalled
