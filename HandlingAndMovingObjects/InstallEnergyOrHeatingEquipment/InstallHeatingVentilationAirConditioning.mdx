...
erDiagram
    ...
    HVACUnit ||--|{ RefrigerantCharge : "generates"
    HVACUnit }o--|| Thermostat : "uses"
    HVACUnit ||--|| MechanicalPermit : "tracked-by"
    HVACUnit ||--o{ StartupChecklist : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : systemSurveyed
    InProgress --> Verified : permitObtained
    Verified --> Approved : equipmentMounted
    Approved --> Active : ductworkInstalled
    Active --> Complete : refrigerantConnected
