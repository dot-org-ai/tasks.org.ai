...
```mermaid
erDiagram
    DisplayArrangement ||--o{ DisplayCase : "defines"
    DisplayArrangement ||--|{ Garnish : "generates"
    DisplayArrangement }o--|| Planogram : "uses"
    DisplayArrangement ||--|| RotationSchedule : "tracked-by"
    DisplayArrangement ||--o{ TemperatureLog : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : arrangementDesigned
    InProgress --> Verified : itemsSelected
    Verified --> Approved : itemsPositioned
    Approved --> Active : garnishApplied
    Active --> Complete : temperatureSet
