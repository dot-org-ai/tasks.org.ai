...
```mermaid
erDiagram
    PackageUnit ||--o{ PackagingMaterial : "defines"
    PackageUnit ||--|{ ProductLabel : "generates"
    PackageUnit }o--|| SealIntegrityTest : "uses"
    PackageUnit ||--|| BatchLabel : "tracked-by"
    PackageUnit ||--o{ ShippingCase : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : packagingFormatSelected
    InProgress --> Verified : productPortioned
    Verified --> Approved : packageSealed
