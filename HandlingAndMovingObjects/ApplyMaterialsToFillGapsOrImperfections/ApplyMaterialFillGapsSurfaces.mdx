...
```mermaid
erDiagram
    MaterialManufacturer ||--|| BuildingOwner : follows
    MaterialManufacturer }o--|| Distributor : generates
    MaterialManufacturer ||--|{ CodeOfficial : requires
    MaterialManufacturer ||--o{ SubstrateManufacturer : tracks
    BuildingOwner ||--|{ MaterialManufacturer : creates
    Distributor ||--o{ MaterialManufacturer : documents
    CodeOfficial ||--|| MaterialManufacturer : supports
```
...
stateDiagram-v2
    ...
    Material_Manufacturer --> Building_Owner: BuildingOwner
    Building_Owner --> Distributor: Distributor
    Distributor --> Code_Official: CodeOfficial
    Code_Official --> Substrate_Manufacturer: SubstrateManufacturer
    Distributor --> Building_Owner: Distributor
