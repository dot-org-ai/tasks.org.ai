...
```mermaid
erDiagram
    SealantManufacturer ||--|| BuildingOwner : follows
    SealantManufacturer }o--|| RoofingSupplier : generates
    SealantManufacturer ||--|{ InsuranceAdjuster : requires
    BuildingOwner ||--|{ SealantManufacturer : creates
    RoofingSupplier ||--o{ SealantManufacturer : documents
    InsuranceAdjuster ||--|| SealantManufacturer : supports
```
...
stateDiagram-v2
    ...
    Sealant_Manufacturer --> Building_Owner: BuildingOwner
    Building_Owner --> Roofing_Supplier: RoofingSupplier
    Roofing_Supplier --> Insurance_Adjuster: InsuranceAdjuster
    Roofing_Supplier --> Building_Owner: RoofingSupplier
    Insurance_Adjuster --> [*]
```
