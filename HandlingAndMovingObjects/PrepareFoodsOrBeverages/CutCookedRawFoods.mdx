...
```mermaid
erDiagram
    CutSpecification ||--|| FoodItem : "uses"
    CutSpecification ||--|| CuttingBatch : "uses"
    CutSpecification ||--|| CuttingTool : "uses"
    CutSpecification ||--o{ WasteLog : "generates"
    CutSpecification ||--o{ SanitationRecord : "generates"
```
