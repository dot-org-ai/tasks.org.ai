...
```mermaid
erDiagram
    Recipe ||--o{ Meal : "instructs"
    MealPlan ||--o{ Recipe : "schedules"
    ProductionBatch ||--o{ Meal : "produces"
    Meal ||--|| NutritionalProfile : "analyzed-in"
    ServiceTicket ||--o{ Meal : "orders"
```
