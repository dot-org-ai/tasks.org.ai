...
```mermaid
erDiagram
    DrinkOrder ||--o{ BeverageRecipe : "contains"
    BeverageRecipe ||--|| BrewBatch : "uses"
    BeverageRecipe ||--|| Ingredient : "uses"
    BeverageRecipe ||--|| EquipmentSetting : "uses"
    BeverageRecipe ||--|| QualityCheck : "uses"
```
