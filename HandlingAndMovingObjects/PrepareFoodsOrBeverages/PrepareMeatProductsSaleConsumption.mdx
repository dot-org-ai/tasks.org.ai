...
```mermaid
erDiagram
    ProcessingSpec ||--o{ MeatProduct : "defines"
    MeatProduct ||--|| ProductionLot : "uses"
    MeatProduct ||--o{ CureRecord : "generates"
    MeatProduct ||--|| PackageLabel : "uses"
    MeatProduct ||--|| DisplayInventory : "uses"
```
