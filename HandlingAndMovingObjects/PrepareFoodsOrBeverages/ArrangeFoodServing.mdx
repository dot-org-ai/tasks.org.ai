...
```mermaid
erDiagram
    ServiceTicket ||--o{ PlateComposition : "contains"
    PlateComposition ||--|| PlatingStandard : "uses"
    PlateComposition ||--|| BuffetDisplay : "uses"
    PlateComposition ||--|| Serviceware : "uses"
    PlateComposition ||--|| TemperatureHold : "uses"
```
