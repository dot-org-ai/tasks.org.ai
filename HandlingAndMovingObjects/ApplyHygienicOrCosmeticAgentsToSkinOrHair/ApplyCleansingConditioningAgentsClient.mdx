...
```mermaid
erDiagram
    Client ||--|| ProductManufacturer : follows
    Client }o--|| SalonOwner : generates
    Client ||--|{ Dermatologist : requires
    Client ||--o{ StateLicensingBoard : tracks
    ProductManufacturer ||--|{ Client : creates
...
stateDiagram-v2
    [*] --> Client
    Client --> Product_Manufacturer: ProductManufacturer
    Product_Manufacturer --> Salon_Owner: SalonOwner
    Salon_Owner --> Dermatologist: Dermatologist
    Dermatologist --> State_Licensing_Board: StateLicensingBoard
    Salon_Owner --> Product_Manufacturer: SalonOwner
