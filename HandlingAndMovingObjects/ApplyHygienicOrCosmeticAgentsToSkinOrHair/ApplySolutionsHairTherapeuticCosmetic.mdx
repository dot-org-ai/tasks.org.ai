...
```mermaid
erDiagram
    ChemicalFormulation ||--|| StrandTest : "validated by"
    PatchTest ||--|| ChemicalFormulation : "screens allergens for"
    ProcessingTimer ||--|| ChemicalFormulation : "controls duration of"
    NeutralizingAgent ||--|| ChemicalFormulation : "stabilizes"
    ColorFormula ||--|| ChemicalFormulation : "records recipe of"
    AftercarePlan ||--|| ColorFormula : "maintains results from"
```
...
stateDiagram-v2
    ...
    ConsultationCompleted --> StrandTestPassed : strandTestPassed
    StrandTestPassed --> SolutionFormulated : solutionFormulated
    SolutionFormulated --> SolutionApplied : solutionApplied
    SolutionApplied --> ProcessingMonitored : processingMonitored
    ProcessingMonitored --> SolutionNeutralized : solutionNeutralized
    ProcessingMonitored --> SolutionApplied : solutionApplied
    SolutionNeutralized --> FormulaDocumented : formulaDocumented
    FormulaDocumented --> [*]
```
