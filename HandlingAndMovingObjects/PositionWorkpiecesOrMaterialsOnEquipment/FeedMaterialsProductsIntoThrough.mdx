...
```mermaid
erDiagram
    FeedStock ||--|| Hopper : "loaded-into"
    RunSheet ||--|| FeedStock : "specifies"
    FeedMechanism ||--|| FeedRate : "controls"
    FeedStock ||--o{ SplicePoint : "joined-at"
    RunSheet ||--|| FeedRate : "defines"
    Hopper ||--|| FeedMechanism : "feeds"
```
