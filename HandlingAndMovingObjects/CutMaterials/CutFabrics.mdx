...
```mermaid
erDiagram
    CuttingOrder ||--o{ CuttingPattern : "specifies"
    CuttingPattern ||--|{ Marker : "arranges-into"
    FabricRoll ||--o{ FabricLay : "spreads-into"
    FabricLay ||--o{ CutPiece : "yields"
    Marker ||--|| FabricLay : "guides"
    CutPiece }o--|| CuttingOrder : "fulfills"
```
...
stateDiagram-v2
    [*] --> Spread : fabricSpread
    Spread --> MarkerSet : markerPositioned
    MarkerSet --> Marked : fabricMarked
    Marked --> Cut : fabricCut
    Cut --> Inspected : cutPiecesInspected
    Inspected --> Bundled : piecesBundled
    Inspected --> Marked : cutPiecesInspected
    Bundled --> Calculated : yieldCalculated
    Calculated --> [*]
```
## Workflow
