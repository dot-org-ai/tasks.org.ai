...
```mermaid
erDiagram
    FabricRoll ||--o{ CuttingPattern : "defines"
    FabricRoll ||--|{ Marker : "generates"
    FabricRoll }o--|| CutPiece : "uses"
    FabricRoll ||--|| CuttingOrder : "tracked-by"
    FabricRoll ||--o{ FabricLay : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : fabricSpread
    InProgress --> Verified : markerPositioned
    Verified --> Approved : fabricMarked
    Approved --> Active : fabricCut
    Active --> Complete : piecesBundled
