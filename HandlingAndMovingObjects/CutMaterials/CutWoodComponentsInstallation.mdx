...
```mermaid
erDiagram
    CutList ||--o{ LumberStock : "defines"
    CutList ||--|{ CutPiece : "generates"
    CutList }o--|| BladeAssembly : "uses"
    CutList ||--|| WasteLog : "tracked-by"
    CutList ||--o{ QualityMeasurement : "includes"
```
...
stateDiagram-v2
    ...
    InProgress --> Verified : stockSelected
    Verified --> Approved : pieceMarked
    Approved --> Active : cutCompleted
    Active --> Complete : dimensionsVerified
