...
```mermaid
erDiagram
    Installation ||--o{ TrimTask : "defines"
    Installation ||--|{ ExcessMaterial : "generates"
    Installation }o--|| TrimmingTool : "uses"
    Installation ||--|| FinishStandard : "tracked-by"
    Installation ||--o{ PunchListItem : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : excessIdentified
    InProgress --> Verified : trimmingToolSelected
    Verified --> Approved : trimLineMarked
    Approved --> Active : trimCompleted
    Active --> Complete : finishInspected
