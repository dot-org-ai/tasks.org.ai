...
```mermaid
erDiagram
    RawStock ||--o{ CutList : "defines"
    RawStock ||--|{ CuttingProgram : "generates"
    RawStock }o--|| CutPiece : "uses"
    RawStock ||--|| Kerf : "tracked-by"
    RawStock ||--o{ MaterialCertification : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : cutListReviewed
    InProgress --> Verified : materialSelected
    Verified --> Approved : cutsLaidOut
    Approved --> Active : machineProgrammed
    Active --> Complete : cutExecuted
