...
```mermaid
erDiagram
    CutList ||--o{ CuttingProgram : "drives"
    CuttingProgram ||--|| Kerf : "accounts-for"
    RawStock ||--|| MaterialCertification : "certified-by"
    RawStock ||--o{ CutPiece : "yields"
    CutList ||--|{ CutPiece : "specifies"
    CutPiece }o--|| CutList : "fulfills"
```
...
stateDiagram-v2
    ...
    Reviewed --> MaterialReady : materialSelected
    MaterialReady --> LaidOut : cutsLaidOut
    LaidOut --> Programmed : machineProgrammed
    Programmed --> Cut : cutExecuted
    Cut --> Deburred : piecesDeburred
    Deburred --> Inspected : piecesInspected
    Inspected --> LaidOut : piecesInspected
    Inspected --> [*]
```
## Workflow
