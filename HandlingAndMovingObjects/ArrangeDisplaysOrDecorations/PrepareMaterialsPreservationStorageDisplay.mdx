...
```mermaid
erDiagram
    Artifact ||--|| ConditionReport : "assessed-by"
    Artifact ||--o{ StorageHousing : "housed-in"
    Artifact ||--o{ ExhibitionMount : "displayed-on"
    Artifact ||--|| CatalogRecord : "cataloged-in"
    CatalogRecord ||--o{ EnvironmentalReading : "monitored-by"
    StorageHousing ||--|| EnvironmentalReading : "tracked-by"
```
...
stateDiagram-v2
    [*] --> Received
    Received --> Assessed : conditionAssessed
    Assessed --> Treated : treatmentApplied
    Treated --> Housed : housingConstructed
    Housed --> Cataloged : itemCataloged
    Cataloged --> Displayed : itemInstalledInGallery
    Cataloged --> Stored : itemTransferredToStorage
    Assessed --> Treated : retreatmentNeeded
    Displayed --> [*]
    Stored --> [*]
```
