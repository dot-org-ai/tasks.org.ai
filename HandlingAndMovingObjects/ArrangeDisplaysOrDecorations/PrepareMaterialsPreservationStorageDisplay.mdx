...
```mermaid
erDiagram
    ConservationSupplier ||--|| LendingInstitution : follows
    ConservationSupplier }o--|| InsuranceUnderwriter : generates
    ConservationSupplier ||--|{ EnvironmentalMonitoringService : requires
    ConservationSupplier ||--o{ ExhibitionDesigner : tracks
    LendingInstitution ||--|{ ConservationSupplier : creates
    InsuranceUnderwriter ||--o{ ConservationSupplier : documents
    EnvironmentalMonitoringService ||--|| ConservationSupplier : supports
```
...
```mermaid
stateDiagram-v2
    [*] --> Conservation_Supplier
    Conservation_Supplier --> Lending_Institution: LendingInstitution
    Lending_Institution --> Insurance_Underwriter: InsuranceUnderwriter
    Insurance_Underwriter --> Environmental_Monitoring_Service: EnvironmentalMonitoringService
    Environmental_Monitoring_Service --> Exhibition_Designer: ExhibitionDesigner
    Insurance_Underwriter --> Lending_Institution: InsuranceUnderwriter
    Exhibition_Designer --> [*]
```
