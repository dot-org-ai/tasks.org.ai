...
```mermaid
erDiagram
    BrandRepresentative ||--|| FixtureSupplier : follows
    BrandRepresentative }o--|| SignagePrinter : generates
    BrandRepresentative ||--|{ StoreManager : requires
    BrandRepresentative ||--o{ DistributionCenter : tracks
    FixtureSupplier ||--|{ BrandRepresentative : creates
    SignagePrinter ||--o{ BrandRepresentative : documents
    StoreManager ||--|| BrandRepresentative : supports
```
...
stateDiagram-v2
    ...
    Brand_Representative --> Fixture_Supplier: FixtureSupplier
    Fixture_Supplier --> Signage_Printer: SignagePrinter
    Signage_Printer --> Store_Manager: StoreManager
    Store_Manager --> Distribution_Center: DistributionCenter
    Signage_Printer --> Fixture_Supplier: SignagePrinter
    Distribution_Center --> [*]
```
