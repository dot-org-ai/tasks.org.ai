...
```mermaid
erDiagram
    Machine ||--o{ Program : "defines"
    Machine ||--|{ Fixture : "generates"
    Machine }o--|| Tool : "uses"
    Machine ||--|| Cycle : "tracked-by"
    Machine ||--o{ Output : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : programLoaded
    InProgress --> Verified : fixtureInstalled
    Verified --> Approved : machineCalibrated
    Approved --> Active : cycleStarted
    Active --> Complete : executionMonitored
