...
```mermaid
erDiagram
    Program ||--|| Machine : "loaded-onto"
    Machine ||--|| Fixture : "equipped-with"
    Machine ||--o{ Tool : "operates"
    Cycle ||--|| Program : "executes"
    Cycle ||--o{ Output : "produces"
    Output ||--|| Cycle : "traced-to"
```
...
stateDiagram-v2
    ...
    Loaded --> Fixtured : fixtureInstalled
    Fixtured --> Calibrated : machineCalibrated
    Calibrated --> Running : cycleStarted
    Running --> Monitored : executionMonitored
    Monitored --> Inspected : outputInspected
    Inspected --> Maintained : maintenanceScheduled
    Inspected --> Calibrated : outputInspected
    Maintained --> [*]
```
## Workflow
