...
```mermaid
erDiagram
    Device ||--o{ Component : "defines"
    Device ||--|{ Blueprint : "generates"
    Device }o--|| WorkOrder : "uses"
    Device ||--|| Tolerance : "tracked-by"
    Device ||--o{ Batch : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : workOrderCreated
    InProgress --> Verified : materialsPrepared
    Verified --> Approved : toolingSetup
    Approved --> Active : componentFabricated
    Active --> Complete : dimensionsInspected
