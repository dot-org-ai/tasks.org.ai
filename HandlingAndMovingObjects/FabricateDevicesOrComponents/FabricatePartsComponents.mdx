...
```mermaid
erDiagram
    Part ||--o{ Material : "defines"
    Part ||--|{ Specification : "generates"
    Part }o--|| BatchRun : "uses"
    Part ||--|| InspectionReport : "tracked-by"
    Part ||--o{ ToolPath : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : materialSelected
    InProgress --> Verified : toolPathGenerated
    Verified --> Approved : stockAllocated
    Approved --> Active : partFabricated
    Active --> Complete : dimensionsMeasured
