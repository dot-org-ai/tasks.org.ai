...
```mermaid
erDiagram
    SpecificationSheet ||--o{ Accessory : "specifies"
    Product ||--o{ AttachmentPoint : "designates"
    Accessory ||--|| AttachmentPoint : "secured-at"
    Accessory ||--|| Fastener : "attached-with"
    Accessory ||--|| QualityRecord : "inspected-in"
    Product ||--|| SpecificationSheet : "governed-by"
```
...
stateDiagram-v2
    [*] --> Selecting
    Selecting --> Positioning : accessorySelected
    Positioning --> Attaching : accessoryPositioned
    Attaching --> Inspecting : accessoryAttached
    Inspecting --> Packaging : attachmentInspected
    Packaging --> [*] : productPackaged
    Inspecting --> Adjusting : defectFound
    Adjusting --> Attaching : placementAdjusted
```
## Workflow
