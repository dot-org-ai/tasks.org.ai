...
```mermaid
erDiagram
    Accessory ||--o{ AttachmentPoint : "defines"
    Accessory ||--|{ Fastener : "generates"
    Accessory }o--|| Product : "uses"
    Accessory ||--|| SpecificationSheet : "tracked-by"
    Accessory ||--o{ QualityRecord : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : accessorySelected
    InProgress --> Verified : accessoryPositioned
    Verified --> Approved : accessoryAttached
    Approved --> Active : attachmentInspected
    Active --> Complete : placementAdjusted
