...
```mermaid
erDiagram
    Patient ||--|| Dentist : follows
    Patient }o--|| DentalLaboratory : generates
    Patient ||--|{ DentalSupplyCompany : requires
    Patient ||--o{ InsuranceProvider : tracks
    Dentist ||--|{ Patient : creates
    DentalLaboratory ||--o{ Patient : documents
    DentalSupplyCompany ||--|| Patient : supports
```
...
stateDiagram-v2
    ...
    Dentist --> Dental_Laboratory: DentalLaboratory
    Dental_Laboratory --> Dental_Supply_Company: DentalSupplyCompany
    Dental_Supply_Company --> Insurance_Provider: InsuranceProvider
    Dental_Laboratory --> Dentist: DentalLaboratory
    Insurance_Provider --> [*]
```
