...
```mermaid
erDiagram
    DentalDevice ||--o{ OcclusalContact : "evaluated at"
    ArticulatingPaper ||--|| OcclusalContact : "marks"
    MarginAdaptation ||--|| DentalDevice : "seals"
    RetentionFit ||--|| DentalDevice : "secures"
    AdjustmentBur ||--o{ OcclusalContact : "reduces"
    DeliveryRecord ||--|| DentalDevice : "documents acceptance of"
```
...
stateDiagram-v2
    [*] --> DeviceSeated
    DeviceSeated --> ContactsMarked : contactsMarked
    ContactsMarked --> OcclusionAdjusted : occlusionAdjusted
    OcclusionAdjusted --> MarginsChecked : marginsChecked
    MarginsChecked --> RetentionTuned : retentionTuned
    RetentionTuned --> ComfortVerified : comfortVerified
    ComfortVerified --> ContactsMarked : contactsMarked
    ComfortVerified --> DeviceDelivered : deviceDelivered
    DeviceDelivered --> [*]
```
