...
```mermaid
erDiagram
    LivestockLot ||--|| AntemortemReport : "uses"
    LivestockLot ||--o{ StunRecord : "generates"
    BleedTicket ||--o{ LivestockLot : "contains"
    LivestockLot ||--|| ProductionRun : "uses"
    LivestockLot ||--o{ ComplianceLog : "generates"
```
