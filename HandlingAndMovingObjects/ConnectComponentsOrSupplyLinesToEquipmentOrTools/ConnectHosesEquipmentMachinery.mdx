...
```mermaid
erDiagram
    HoseAssembly ||--o{ Fitting : "defines"
    HoseAssembly ||--|{ Port : "generates"
    HoseAssembly }o--|| PressureTest : "uses"
    HoseAssembly ||--|| HoseRoute : "tracked-by"
    HoseAssembly ||--o{ WorkOrder : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : hoseSelected
    InProgress --> Verified : hoseRouted
    Verified --> Approved : fittingAttached
    Approved --> Active : pressureTestPassed
    Active --> Complete : hoseSecured
