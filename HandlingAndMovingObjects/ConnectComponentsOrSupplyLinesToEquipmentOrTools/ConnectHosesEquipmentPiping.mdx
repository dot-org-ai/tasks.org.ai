...
```mermaid
erDiagram
    HoseLine ||--o{ PipeConnection : "defines"
    HoseLine ||--|{ Gasket : "generates"
    HoseLine }o--|| Valve : "uses"
    HoseLine ||--|| LeakTest : "tracked-by"
    HoseLine ||--o{ ConnectionPermit : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : connectionIdentified
    InProgress --> Verified : hoseLineSelected
    Verified --> Approved : jointPrepared
    Approved --> Active : hoseAttached
    Active --> Complete : connectionTested
