...
```mermaid
erDiagram
    PullSheet ||--|| ConduitRun : "specifies"
    ConduitRun ||--o{ Conduit : "composed-of"
    FishTape ||--|| Conduit : "threaded-through"
    PullRope ||--o{ Conduit : "pulls-wire-in"
    Conduit ||--|| WireLubricant : "lubricated-with"
    PullSheet ||--|| WireLubricant : "prescribes"
```
...
stateDiagram-v2
    [*] --> Assessing
    Assessing --> FishTaping : conduitAssessed
    FishTaping --> WireAttach : fishTapeInserted
    WireAttach --> Lubricating : wiresAttached
    Lubricating --> Pulling : lubricantApplied
    Pulling --> FillVerification : wirePulledThrough
    FillVerification --> SlackCoiling : conduitFillVerified
    SlackCoiling --> [*] : slackCoiled
    FillVerification --> Assessing : fillExceeded
```
## Workflow
