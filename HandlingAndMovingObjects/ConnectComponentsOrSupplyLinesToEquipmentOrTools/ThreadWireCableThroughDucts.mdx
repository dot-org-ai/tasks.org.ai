...
```mermaid
erDiagram
    Conduit ||--o{ FishTape : "defines"
    Conduit ||--|{ PullRope : "generates"
    Conduit }o--|| WireLubricant : "uses"
    Conduit ||--|| ConduitRun : "tracked-by"
    Conduit ||--o{ PullSheet : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : conduitAssessed
    InProgress --> Verified : fishTapeInserted
    Verified --> Approved : wiresAttached
    Approved --> Active : lubricantApplied
    Active --> Complete : wirePulledThrough
