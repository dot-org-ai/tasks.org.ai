...
```mermaid
erDiagram
    WiringDiagram ||--o{ Component : "specifies"
    Component ||--o{ Terminal : "wired-at"
    Component ||--|| ControlPanel : "mounted-in"
    ControlPanel ||--o{ CircuitBranch : "feeds"
    Component ||--|| ConnectionRecord : "documented-in"
    CircuitBranch ||--|| ConnectionRecord : "verified-in"
```
...
stateDiagram-v2
    [*] --> Mounting
    Mounting --> Wiring : componentMounted
    Wiring --> Configuring : componentWired
    Configuring --> Verifying : deviceConfigured
    Verifying --> FunctionalTest : wiringVerified
    FunctionalTest --> Commissioning : componentTested
    Commissioning --> [*] : systemCommissioned
    FunctionalTest --> Wiring : testFailed
```
