...
```mermaid
erDiagram
    Component ||--o{ WiringDiagram : "defines"
    Component ||--|{ Terminal : "generates"
    Component }o--|| ControlPanel : "uses"
    Component ||--|| CircuitBranch : "tracked-by"
    Component ||--o{ ConnectionRecord : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : componentMounted
    InProgress --> Verified : componentWired
    Verified --> Approved : deviceConfigured
    Approved --> Active : wiringVerified
    Active --> Complete : componentTested
