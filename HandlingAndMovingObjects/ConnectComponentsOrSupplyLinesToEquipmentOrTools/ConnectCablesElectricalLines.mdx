...
```mermaid
erDiagram
    Cable ||--o{ Terminal : "defines"
    Cable ||--|{ JunctionBox : "generates"
    Cable }o--|| CircuitBreaker : "uses"
    Cable ||--|| CableSchedule : "tracked-by"
    Cable ||--o{ ConnectionLog : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : cablePrepared
    InProgress --> Verified : cableRouted
    Verified --> Approved : cableTerminated
    Approved --> Active : cableSpliced
    Active --> Complete : connectionLabeled
