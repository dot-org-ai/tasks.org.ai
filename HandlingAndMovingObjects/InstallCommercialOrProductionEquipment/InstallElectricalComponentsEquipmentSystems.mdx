...
```mermaid
erDiagram
    ElectricalPanel ||--o{ Conductor : "defines"
    ElectricalPanel ||--|{ Conduit : "generates"
    ElectricalPanel }o--|| CircuitBreaker : "uses"
    ElectricalPanel ||--|| WiringDiagram : "tracked-by"
    ElectricalPanel ||--o{ ElectricalPermit : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : drawingsReviewed
    InProgress --> Verified : permitPulled
    Verified --> Approved : conduitInstalled
    Approved --> Active : conductorsPulled
    Active --> Complete : equipmentMounted
