...
```mermaid
erDiagram
    DrillingRig ||--o{ Derrick : "defines"
    DrillingRig ||--|{ Drawworks : "generates"
    DrillingRig }o--|| MudSystem : "uses"
    DrillingRig ||--|| BOP : "tracked-by"
    DrillingRig ||--o{ RigUpPlan : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : sitePrepared
    InProgress --> Verified : derrickRigged
    Verified --> Approved : drawworksInstalled
    Approved --> Active : mudSystemAssembled
    Active --> Complete : bopInstalled
