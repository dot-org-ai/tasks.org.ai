...
```mermaid
erDiagram
    VehiclePart ||--o{ RemovalOrder : "defines"
    VehiclePart ||--|{ Vehicle : "generates"
    VehiclePart }o--|| DisconnectionSequence : "uses"
    VehiclePart ||--|| PartConditionReport : "tracked-by"
    VehiclePart ||--o{ HazardousMaterial : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : partIdentified
    InProgress --> Verified : systemsDisconnected
    Verified --> Approved : partExtracted
    Approved --> Active : conditionAssessed
    Active --> Complete : fluidsDrained
