...
```mermaid
erDiagram
    SolderConnection ||--o{ SolderPaste : "defines"
    SolderConnection ||--|{ ReflowProfile : "generates"
    SolderConnection }o--|| CircuitAssembly : "uses"
    SolderConnection ||--|| StencilMask : "tracked-by"
    SolderConnection ||--o{ ContinuityTest : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : pasteApplied
    InProgress --> Verified : componentsPlaced
    Verified --> Approved : reflowCompleted
    Approved --> Active : handSoldered
    Active --> Complete : residuesCleaned
