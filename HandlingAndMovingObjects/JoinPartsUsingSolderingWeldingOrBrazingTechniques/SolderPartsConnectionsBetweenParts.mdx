...
```mermaid
erDiagram
    CircuitAssembly ||--o{ SolderConnection : "contains"
    StencilMask ||--o{ SolderPaste : "deposits"
    SolderPaste ||--|| SolderConnection : "forms"
    ReflowProfile ||--|| CircuitAssembly : "controls"
    SolderConnection ||--|| ContinuityTest : "verified-by"
```
...
stateDiagram-v2
    [*] --> PasteApplied
    PasteApplied --> ComponentsPlaced : componentsPlaced
    ComponentsPlaced --> ReflowCompleted : reflowCompleted
    ReflowCompleted --> ResiduesCleaned : residuesCleaned
    ResiduesCleaned --> ConnectionsInspected : connectionsInspected
    ConnectionsInspected --> HandSoldered : handSoldered
    HandSoldered --> ConnectionsInspected : connectionsInspected
    ConnectionsInspected --> ContinuityVerified : continuityVerified
    ContinuityVerified --> [*]
```
## Workflow
