...
```mermaid
erDiagram
    RivetJoint ||--o{ Rivet : "defines"
    RivetJoint ||--|{ DrillPattern : "generates"
    RivetJoint }o--|| AssemblyDrawing : "uses"
    RivetJoint ||--|| InspectionRecord : "tracked-by"
    RivetJoint ||--o{ RivetGun : "includes"
```
...
stateDiagram-v2
    ...
    InProgress --> Verified : holesDrilled
    Verified --> Approved : holesDeburred
    Approved --> Active : componentsAligned
    Active --> Complete : rivetsInserted
