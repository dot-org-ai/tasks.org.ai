...
```mermaid
erDiagram
    Workpiece ||--o{ SolderJoint : "joined-at"
    SolderJoint ||--|| Solder : "formed-with"
    Flux ||--|| SolderJoint : "promotes-flow-in"
    SolderingProfile ||--|| SolderJoint : "controls"
    SolderJoint ||--|| InspectionRecord : "documented-in"
```
...
stateDiagram-v2
    [*] --> SurfacesCleaned
    SurfacesCleaned --> FluxApplied : fluxApplied
    FluxApplied --> SolderSelected : solderSelected
    SolderSelected --> SolderApplied : solderApplied
    SolderApplied --> ExcessRemoved : excessRemoved
    ExcessRemoved --> JointInspected : jointInspected
    JointInspected --> SolderApplied : solderApplied
    JointInspected --> ResultsDocumented : resultsDocumented
    ResultsDocumented --> [*]
```
## Workflow
