...
```mermaid
erDiagram
    Record ||--o{ RecordSeries : "generates"
    Record ||--|| StorageBox : "uses"
    Record ||--|| RetentionSchedule : "uses"
    RetrievalRequest ||--o{ Record : "contains"
    Record ||--|| DestructionCertificate : "uses"
```
