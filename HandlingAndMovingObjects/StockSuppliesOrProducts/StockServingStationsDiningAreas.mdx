...
```mermaid
erDiagram
    ServingStation ||--|| FoodItem : "uses"
    ServingStation ||--|| SupplyItem : "uses"
    ServingStation ||--o{ TemperatureLog : "generates"
    ServingStation ||--|| ParLevel : "uses"
    ServingStation ||--|| ReplenishmentSchedule : "uses"
```
