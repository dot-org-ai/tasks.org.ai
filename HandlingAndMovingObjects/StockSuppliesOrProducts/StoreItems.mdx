...
```mermaid
erDiagram
    StoredItem ||--|| StorageLocation : "uses"
    StoredItem ||--o{ StorageRecord : "generates"
    StoredItem ||--o{ AccessLog : "generates"
    StoredItem ||--|| ConditionReport : "uses"
    RetrievalRequest ||--o{ StoredItem : "contains"
```
