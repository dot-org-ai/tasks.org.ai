...
```mermaid
erDiagram
    MerchandiseItem ||--|| DisplayFixture : "uses"
    MerchandiseItem ||--|| Planogram : "uses"
    MerchandiseItem ||--|| StockLevel : "uses"
    MerchandiseItem ||--|| PriceTag : "uses"
    MerchandiseItem ||--|| ReplenishmentTask : "uses"
```
