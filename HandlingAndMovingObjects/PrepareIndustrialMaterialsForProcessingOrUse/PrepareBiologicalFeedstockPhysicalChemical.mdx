...
```mermaid
erDiagram
    FeedstockBatch ||--|| SizingEquipment : "reduced-by"
    MoistureSpec ||--|| FeedstockBatch : "targets-moisture-for"
    FeedstockBatch ||--o{ ContaminantReport : "screened-in"
    FeedstockBatch ||--|| StorageBin : "staged-in"
    ProcessRecipe ||--|| FeedstockBatch : "specifies"
    FeedstockBatch ||--|| ReceivingLog : "documented-in"
```
...
stateDiagram-v2
    [*] --> FeedstockReceived
    FeedstockReceived --> FeedstockSampled : feedstockSampled
    FeedstockSampled --> ContaminantsScreened : contaminantsScreened
    ContaminantsScreened --> SizeReduced : sizeReduced
    SizeReduced --> MoistureAdjusted : moistureAdjusted
    MoistureAdjusted --> FeedstockBlended : feedstockBlended
    FeedstockBlended --> FeedstockStaged : feedstockStaged
    FeedstockStaged --> FeedstockSampled : feedstockSampled
    FeedstockStaged --> [*]
```
