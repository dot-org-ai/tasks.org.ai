...
erDiagram
    ...
    BlastHole ||--|| ExplosiveCharge : "loaded-with"
    ExplosiveCharge ||--|| Detonator : "initiated-by"
    Detonator ||--|| FiringCircuit : "connected-to"
    Magazine ||--o{ ExplosiveCharge : "stores"
```
...
stateDiagram-v2
    [*] --> ExplosivesInspected
    ExplosivesInspected --> ChargesLoaded : chargesLoaded
    ChargesLoaded --> DetonatorsWired : detonatorsWired
    DetonatorsWired --> CircuitTested : circuitTested
    CircuitTested --> DetonatorsWired : detonatorsWired
    CircuitTested --> SafetyZoneEstablished : safetyZoneEstablished
    SafetyZoneEstablished --> FiringSystemArmed : firingSystemArmed
    FiringSystemArmed --> PreparationDocumented : preparationDocumented
    PreparationDocumented --> [*]
```
