...
```mermaid
erDiagram
    Arborist ||--|| PropertyOwner : follows
    Arborist }o--|| EquipmentSupplier : generates
    Arborist ||--|{ SafetyInspector : requires
    Arborist ||--o{ LandscapeContractor : tracks
    Arborist ||--|| UtilityCompany : validates
    PropertyOwner ||--|{ Arborist : creates
    EquipmentSupplier ||--o{ Arborist : documents
    SafetyInspector ||--|| Arborist : supports
```
...
stateDiagram-v2
    ...
    Property_Owner --> Equipment_Supplier: EquipmentSupplier
    Equipment_Supplier --> Safety_Inspector: SafetyInspector
    Safety_Inspector --> Landscape_Contractor: LandscapeContractor
    Landscape_Contractor --> Utility_Company: UtilityCompany
    Safety_Inspector --> Property_Owner: EquipmentSupplier
    Utility_Company --> [*]
```
