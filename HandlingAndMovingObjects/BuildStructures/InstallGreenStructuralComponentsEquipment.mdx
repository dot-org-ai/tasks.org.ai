...
```mermaid
erDiagram
    GreenBuildingPlan ||--o{ ComponentSpecification : "details"
    GreenBuildingPlan ||--|| CertificationApplication : "submitted-for"
    ComponentSpecification ||--|| InstallationSchedule : "scheduled-in"
    InstallationSchedule ||--|| PerformanceMetric : "measured-by"
    CertificationApplication ||--|| ComplianceReport : "verified-in"
    PerformanceMetric ||--|| ComplianceReport : "supports"
```
...
stateDiagram-v2
    [*] --> Designing
    Designing --> Certifying : systemDesigned
    Certifying --> Procuring : designCertified
    Procuring --> StructurePrep : componentsProcured
    StructurePrep --> GreenRoofInstall : structurePrepared
    GreenRoofInstall --> SolarInstall : greenRoofInstalled
    SolarInstall --> Monitoring : solarArrayInstalled
    Certifying --> Designing : certificationDenied
    Monitoring --> [*] : performanceVerified
```
