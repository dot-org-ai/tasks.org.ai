...
```mermaid
erDiagram
    Fixture ||--|| Mounting : "secured-with"
    Fixture ||--o{ Connection : "serviced-by"
    Fixture ||--|| InstallationSchedule : "sequenced-in"
    InstallationSchedule ||--|| PunchList : "generates"
    Fixture ||--|| AsBuiltRecord : "documented-in"
    Connection ||--|| AsBuiltRecord : "recorded-in"
```
...
stateDiagram-v2
    [*] --> SubstratePrep
    SubstratePrep --> Positioning : substratePrepared
    Positioning --> Mounting : fixturePositioned
    Mounting --> Connecting : fixtureMounted
    Connecting --> Testing : servicesConnected
    Testing --> Adjusting : operationTested
    Adjusting --> Accepted : alignmentAdjusted
    Testing --> Connecting : connectionFailed
