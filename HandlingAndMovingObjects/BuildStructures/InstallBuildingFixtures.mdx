...
```mermaid
erDiagram
    FixtureManufacturer ||--|| GeneralContractor : follows
    FixtureManufacturer }o--|| Electrician : generates
    FixtureManufacturer ||--|{ Plumber : requires
    FixtureManufacturer ||--o{ BuildingInspector : tracks
    FixtureManufacturer ||--|| BuildingOwner : validates
    GeneralContractor ||--|{ FixtureManufacturer : creates
    Electrician ||--o{ FixtureManufacturer : documents
    Plumber ||--|| FixtureManufacturer : supports
```
...
stateDiagram-v2
    ...
    Fixture_Manufacturer --> General_Contractor: GeneralContractor
    General_Contractor --> Electrician: Electrician
    Electrician --> Plumber: Plumber
    Plumber --> Building_Inspector: BuildingInspector
    Building_Inspector --> Building_Owner: BuildingOwner
    Plumber --> General_Contractor: Electrician
    Building_Owner --> [*]
```
