...
```mermaid
erDiagram
    Architect ||--|| PropertyOwner : follows
    Architect }o--|| MaterialSupplier : generates
    Architect ||--|{ StructuralEngineer : requires
    Architect ||--o{ BuildingInspector : tracks
    Architect ||--|| GeneralContractor : validates
    PropertyOwner ||--|{ Architect : creates
    MaterialSupplier ||--o{ Architect : documents
    StructuralEngineer ||--|| Architect : supports
```
...
stateDiagram-v2
    [*] --> Architect
    Architect --> Property_Owner: PropertyOwner
    Property_Owner --> Material_Supplier: MaterialSupplier
    Material_Supplier --> Structural_Engineer: StructuralEngineer
    Structural_Engineer --> Building_Inspector: BuildingInspector
    Building_Inspector --> General_Contractor: GeneralContractor
    Structural_Engineer --> Property_Owner: MaterialSupplier
    General_Contractor --> [*]
```
