...
```mermaid
erDiagram
    FramingPlan ||--o{ Stud : "defines"
    FramingPlan ||--|{ Joist : "generates"
    FramingPlan }o--|| Beam : "uses"
    FramingPlan ||--|| Truss : "tracked-by"
    FramingPlan ||--o{ Sheathing : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : framingLaidOut
    InProgress --> Verified : lumberCut
    Verified --> Approved : wallsAssembled
    Approved --> Active : wallsRaised
    Active --> Complete : joistsInstalled
