...
```mermaid
erDiagram
    ScaffoldRental ||--|| GeneralContractor : follows
    ScaffoldRental }o--|| SafetyInspector : generates
    ScaffoldRental ||--|{ ConstructionCrew : requires
    ScaffoldRental ||--o{ EngineeringFirm : tracks
    ScaffoldRental ||--|| DismantlingService : validates
    GeneralContractor ||--|{ ScaffoldRental : creates
    SafetyInspector ||--o{ ScaffoldRental : documents
    ConstructionCrew ||--|| ScaffoldRental : supports
```
...
stateDiagram-v2
    [*] --> Scaffold_Rental
    Scaffold_Rental --> General_Contractor: GeneralContractor
    General_Contractor --> Safety_Inspector: SafetyInspector
    Safety_Inspector --> Construction_Crew: ConstructionCrew
    Construction_Crew --> Engineering_Firm: EngineeringFirm
    Engineering_Firm --> Dismantling_Service: DismantlingService
    Construction_Crew --> General_Contractor: SafetyInspector
    Dismantling_Service --> [*]
```
