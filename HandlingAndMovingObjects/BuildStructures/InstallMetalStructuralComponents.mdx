...
```mermaid
erDiagram
    StructuralEngineer ||--|| SteelFabricator : follows
    StructuralEngineer }o--|| GeneralContractor : generates
    StructuralEngineer ||--|{ CraneOperator : requires
    StructuralEngineer ||--o{ WeldingInspector : tracks
    StructuralEngineer ||--|| BuildingInspector : validates
    SteelFabricator ||--|{ StructuralEngineer : creates
    GeneralContractor ||--o{ StructuralEngineer : documents
    CraneOperator ||--|| StructuralEngineer : supports
```
...
stateDiagram-v2
    [*] --> Structural_Engineer
    Structural_Engineer --> Steel_Fabricator: SteelFabricator
    ...
    Welding_Inspector --> Building_Inspector: BuildingInspector
    Crane_Operator --> Steel_Fabricator: GeneralContractor
    Building_Inspector --> [*]
```
