...
```mermaid
erDiagram
    InteriorDesigner ||--|| Homeowner : follows
    InteriorDesigner }o--|| HardwareSupplier : generates
    InteriorDesigner ||--|{ GeneralContractor : requires
    InteriorDesigner ||--o{ Inspector : tracks
    InteriorDesigner ||--|| Architect : validates
    Homeowner ||--|{ InteriorDesigner : creates
    HardwareSupplier ||--o{ InteriorDesigner : documents
    GeneralContractor ||--|| InteriorDesigner : supports
```
...
stateDiagram-v2
    [*] --> Interior_Designer
    Interior_Designer --> Homeowner: Homeowner
    Homeowner --> Hardware_Supplier: HardwareSupplier
    Hardware_Supplier --> General_Contractor: GeneralContractor
    General_Contractor --> Inspector: Inspector
    Inspector --> Architect: Architect
    General_Contractor --> Homeowner: HardwareSupplier
    Architect --> [*]
```
