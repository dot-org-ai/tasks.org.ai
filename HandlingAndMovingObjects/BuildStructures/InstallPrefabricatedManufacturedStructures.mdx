...
```mermaid
erDiagram
    ProductionSchedule ||--o{ ModuleSpecification : "produces"
    SitePreparation ||--|| LiftingPlan : "enables"
    TransportPlan ||--o{ ModuleSpecification : "delivers"
    ModuleSpecification ||--|| LiftingPlan : "lifted-per"
    ModuleSpecification ||--|| ConnectionSchedule : "connected-per"
    ConnectionSchedule ||--|| SitePreparation : "integrates-with"
```
...
stateDiagram-v2
    [*] --> Coordinating
    Coordinating --> SitePrep : productionCoordinated
    SitePrep --> TransportPlan : sitePrepared
    TransportPlan --> Receiving : transportPlanned
    Receiving --> Positioning : moduleReceived
    Positioning --> Connecting : modulePositioned
    Connecting --> Finishing : modulesConnected
    Finishing --> Complete : seamsFinished
    Connecting --> Positioning : realignmentNeeded
    Complete --> [*]
```
