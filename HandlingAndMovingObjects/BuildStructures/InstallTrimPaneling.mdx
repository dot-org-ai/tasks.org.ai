...
```mermaid
erDiagram
    TrimProfile ||--o{ PanelSheet : "defines"
    TrimProfile ||--|{ CutList : "generates"
    TrimProfile }o--|| Adhesive : "uses"
    TrimProfile ||--|| Fastener : "tracked-by"
    TrimProfile ||--o{ JointCompound : "includes"
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> InProgress : wallsMeasured
    InProgress --> Verified : materialsCut
    Verified --> Approved : adhesiveApplied
    Approved --> Active : panelsInstalled
    Active --> Complete : trimSecured
