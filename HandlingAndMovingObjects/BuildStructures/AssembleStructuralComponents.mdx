...
```mermaid
erDiagram
    ComponentManufacturer ||--|| LogisticsProvider : follows
    ComponentManufacturer }o--|| GeneralContractor : generates
    ComponentManufacturer ||--|{ StructuralEngineer : requires
    ComponentManufacturer ||--o{ BuildingInspector : tracks
    ComponentManufacturer ||--|| CraneService : validates
    LogisticsProvider ||--|{ ComponentManufacturer : creates
    GeneralContractor ||--o{ ComponentManufacturer : documents
    StructuralEngineer ||--|| ComponentManufacturer : supports
```
...
stateDiagram-v2
    ...
    Component_Manufacturer --> Logistics_Provider: LogisticsProvider
    Logistics_Provider --> General_Contractor: GeneralContractor
    General_Contractor --> Structural_Engineer: StructuralEngineer
    Structural_Engineer --> Building_Inspector: BuildingInspector
    Building_Inspector --> Crane_Service: CraneService
    Structural_Engineer --> Logistics_Provider: GeneralContractor
    Crane_Service --> [*]
```
