...
```mermaid
erDiagram
    RawMaterialLot ||--o{ ProductionBatch : "defines"
    RawMaterialLot ||--|{ Sample : "generates"
    RawMaterialLot }o--|| InspectionPlan : "uses"
    RawMaterialLot ||--|| Certificate : "tracked-by"
    RawMaterialLot ||--o{ RetentionSample : "includes"
```
...
stateDiagram-v2
    ...
    InProgress --> Verified : rawSampleCollected
    Verified --> Approved : finishedSampleCollected
    Approved --> Active : inspectionPerformed
    Active --> Complete : retentionSampleArchived
