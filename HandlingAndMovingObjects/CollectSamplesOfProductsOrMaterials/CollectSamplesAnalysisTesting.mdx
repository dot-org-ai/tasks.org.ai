...
```mermaid
erDiagram
    SamplingPlan ||--o{ Sample : "defines"
    SamplingPlan ||--|{ Batch : "generates"
    SamplingPlan }o--|| TestRequest : "uses"
    SamplingPlan ||--|| SampleLabel : "tracked-by"
    SamplingPlan ||--o{ ComplianceCertificate : "includes"
```
...
stateDiagram-v2
    ...
    InProgress --> Verified : sampleCollected
    Verified --> Approved : sampleLabeled
    Approved --> Active : conditionsDocumented
    Active --> Complete : testRequestSubmitted
