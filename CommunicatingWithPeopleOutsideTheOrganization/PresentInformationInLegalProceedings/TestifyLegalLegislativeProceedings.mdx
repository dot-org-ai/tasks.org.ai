...
```mermaid
erDiagram
    Proceeding ||--|{ Testimony : contains
    Testimony ||--|{ Exhibit : references
    Proceeding ||--|| Subpoena : "compelled by"
    Testimony ||--|| Transcript : "recorded in"
    Testimony ||--o{ CrossExamination : "challenged via"
    Exhibit }o--|| Transcript : "entered into"
```
...
stateDiagram-v2
    [*] --> Prepared
    Prepared --> DocumentsSubmitted : documentationSubmitted
    DocumentsSubmitted --> Testifying : testimonyProvided
    Testifying --> Answering : questionAnswered
    Answering --> Answering : moreQuestions
    Answering --> Clarifying : statementClarified
    Clarifying --> Answering : additionalQuestions
    Clarifying --> TranscriptReview : transcriptReviewed
    TranscriptReview --> Clarifying : correctionsNeeded
    TranscriptReview --> Complete : proceedingCompleted
    Complete --> [*]
```
