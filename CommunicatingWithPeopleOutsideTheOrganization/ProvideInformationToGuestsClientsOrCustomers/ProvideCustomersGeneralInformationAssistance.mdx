...
```mermaid
erDiagram
    Request ||--o| Resource : "answered by"
    Request ||--o| Guidance : "resolved with"
    Request ||--o| Referral : "directed via"
    FAQEntry }o--|| Request : "generated from"
    Resource }o--|| FAQEntry : "referenced in"
    Interaction ||--|| Request : "documents"
```
...
stateDiagram-v2
    [*] --> RequestReceived
    RequestReceived --> InformationProvided : informationProvided
    RequestReceived --> GuidanceOffered : guidanceOffered
    RequestReceived --> ResourceShared : resourceShared
    RequestReceived --> CustomerReferred : customerReferred
    InformationProvided --> InteractionTracked : interactionTracked
    GuidanceOffered --> InteractionTracked : interactionTracked
    ResourceShared --> InteractionTracked : interactionTracked
    CustomerReferred --> InteractionTracked : interactionTracked
    InteractionTracked --> FAQUpdated : faqUpdated
    InteractionTracked --> [*]
    FAQUpdated --> [*]
```
