...
```mermaid
erDiagram
    Attraction ||--|{ Schedule : "available per"
    Event ||--|| Schedule : "listed in"
    Event ||--|{ Ticket : "accessed via"
    Attraction ||--o{ Accommodation : "offers"
    Attraction ||--|{ Recommendation : "suggested in"
    Recommendation }o--|| Event : "promotes"
```
...
stateDiagram-v2
    [*] --> ScheduleProvided
    ScheduleProvided --> AttractionDescribed : attractionDescribed
    ScheduleProvided --> EventRecommended : eventRecommended
    AttractionDescribed --> AvailabilityChecked : availabilityChecked
    EventRecommended --> AvailabilityChecked : availabilityChecked
    AvailabilityChecked --> AccommodationsArranged : accommodationsArranged
    AvailabilityChecked --> DirectionsProvided : directionsProvided
    AccommodationsArranged --> DirectionsProvided : directionsProvided
    DirectionsProvided --> [*]
```
