...
```mermaid
erDiagram
    CoordinatePair ||--o{ ElevationValue : contains
    CoordinatePair ||--o{ GeodeticDatum : contains
    CoordinatePair ||--o{ SurveyObservation : contains
    CoordinatePair }o--|| ControlPoint : uses
    CoordinatePair ||--o{ CoordinateTransformation : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : instrumentationSetUp
    Processing --> [*]
```
## Workflow
