...
```mermaid
erDiagram
    StratigraphicLog ||--o{ TopographicSurvey : contains
    StratigraphicLog ||--o{ SubsurfaceModel : contains
    StratigraphicLog ||--o{ GeologicalMap : contains
    StratigraphicLog ||--o{ HazardAssessment : contains
    StratigraphicLog ||--o{ TerrainAnalysis : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : geologicalDataCompiled
    Processing --> UnderReview : stratigraphyCorrelated
    UnderReview --> [*]
```
## Workflow
