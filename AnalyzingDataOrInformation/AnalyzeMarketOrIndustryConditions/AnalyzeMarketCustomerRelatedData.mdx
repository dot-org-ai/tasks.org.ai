...
```mermaid
erDiagram
    CustomerProfile ||--o{ MarketSegment : contains
    CustomerProfile ||--o{ PurchaseBehavior : contains
    CustomerProfile ||--o{ SatisfactionScore : contains
    CustomerProfile ||--o{ ChurnIndicator : contains
    CustomerProfile ||--o{ LifetimeValueEstimate : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : customerDataIntegrated
    Processing --> UnderReview : customersProfiled
    UnderReview --> [*]
```
## Workflow
