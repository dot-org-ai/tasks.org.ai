...
```mermaid
erDiagram
    EconomicIndicator ||--o{ PoliticalRiskScore : contains
    EconomicIndicator ||--o{ DemographicProjection : contains
    EconomicIndicator ||--o{ ForecastModel : contains
    EconomicIndicator ||--o{ ScenarioProjection : contains
    EconomicIndicator ||--o{ TrendForecastReport : generates
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : indicatorDataCollected
    Processing --> [*]
```
## Workflow
