...
```mermaid
erDiagram
    SustainabilityProject ||--o{ ImpactAssessment : contains
    SustainabilityProject ||--o{ SustainabilityGoal : contains
    SustainabilityProject ||--o{ EnvironmentalMetric : contains
    SustainabilityProject ||--o{ ProjectBenefit : contains
    SustainabilityProject ||--o{ EvaluationReport : generates
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : impactAssessed
    Processing --> [*]
```
## Workflow
