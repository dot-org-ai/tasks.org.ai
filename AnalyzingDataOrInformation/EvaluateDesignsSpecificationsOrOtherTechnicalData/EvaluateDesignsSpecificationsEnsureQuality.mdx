...
```mermaid
erDiagram
    DesignDocument ||--o{ QualityChecklist : contains
    DesignDocument ||--o{ Defect : contains
    DesignDocument ||--o{ ReviewFinding : generates
    DesignDocument ||--o{ QualityMetric : contains
    DesignDocument ||--o{ ApprovalStatus : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> UnderReview : designReviewed
    UnderReview --> Processing : complianceChecked
    Processing --> Identified : defectsIdentified
    Identified --> [*]
```
## Workflow
