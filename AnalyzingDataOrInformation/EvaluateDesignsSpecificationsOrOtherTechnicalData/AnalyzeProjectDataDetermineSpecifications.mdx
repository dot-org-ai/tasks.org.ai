...
```mermaid
erDiagram
    ProjectData ||--o{ Specification : contains
    ProjectData ||--o{ StakeholderInput : contains
    ProjectData ||--o{ DesignConstraint : contains
    ProjectData ||--o{ PerformanceCriteria : contains
    ProjectData ||--o{ SpecificationDocument : contains
```
...
stateDiagram-v2
    [*] --> Draft
    Draft --> DataCollected : dataCollected
    DataCollected --> InputsSynthesized : inputsSynthesized
    InputsSynthesized --> [*]
```
## Workflow
