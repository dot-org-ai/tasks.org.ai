...
```mermaid
erDiagram
    JobAnalysisStudy ||--o{ ObservationRecord : generates
    JobAnalysisStudy ||--o{ SurveyInstrument : contains
    JobAnalysisStudy ||--o{ InterviewTranscript : contains
    JobAnalysisStudy ||--o{ TaskInventory : contains
    CompetencyProfile ||--o{ JobAnalysisStudy : provides
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : analysisStudyDesigned
    Processing --> [*]
```
## Workflow
