...
```mermaid
erDiagram
    IncomeStatement ||--o{ BalanceSheet : contains
    IncomeStatement ||--o{ CashFlowStatement : contains
    IncomeStatement ||--o{ OperationalScorecard : contains
    IncomeStatement ||--o{ SolvencyAssessment : contains
    IncomeStatement ||--o{ LiquidityAnalysis : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : financialRecordsCompiled
    Processing --> UnderReview : profitabilityAssessed
    UnderReview --> [*]
```
## Workflow
