...
```mermaid
erDiagram
    FinancialStatement ||--o{ RatioAnalysis : contains
    CreditProfile ||--o{ FinancialStatement : provides
    FinancialStatement ||--o{ CashFlowProjection : contains
    FinancialStatement ||--o{ InvestmentValuation : contains
    FinancialStatement ||--o{ EconomicIndicator : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : financialStatementsIngested
    Processing --> Complete : ratiosComputed
    Complete --> [*]
```
## Workflow
