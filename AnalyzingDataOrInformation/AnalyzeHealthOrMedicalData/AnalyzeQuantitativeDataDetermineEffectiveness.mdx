...
```mermaid
erDiagram
    OutcomeDataset ||--o{ EffectivenessMetric : contains
    OutcomeDataset ||--o{ TreatmentComparison : contains
    OutcomeDataset ||--o{ EffectSize : contains
    OutcomeDataset ||--o{ ConfidenceInterval : contains
    OutcomeDataset ||--o{ ClinicalSignificance : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : outcomeDataCollected
    Processing --> [*]
```
## Workflow
