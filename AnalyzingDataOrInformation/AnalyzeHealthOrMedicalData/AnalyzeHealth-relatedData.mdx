...
```mermaid
erDiagram
    HealthIndicator ||--o{ SurveillanceDataset : contains
    HealthIndicator ||--o{ DiseaseOutbreak : contains
    HealthIndicator ||--o{ RiskFactor : contains
    HealthIndicator ||--o{ HealthDisparity : contains
    HealthIndicator ||--o{ PopulationCohort : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> Processing : healthDataIngested
    Processing --> UnderReview : healthIndicatorsCalculated
    UnderReview --> [*]
```
## Workflow
