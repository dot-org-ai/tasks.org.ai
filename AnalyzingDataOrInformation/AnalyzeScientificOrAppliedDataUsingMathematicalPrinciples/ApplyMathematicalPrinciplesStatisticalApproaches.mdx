...
```mermaid
erDiagram
    MathematicalModel ||--o{ StatisticalTest : contains
    MathematicalModel ||--o{ DataSet : contains
    MathematicalModel ||--o{ ComputationResult : generates
    MathematicalModel ||--o{ ValidationMetric : contains
    MathematicalModel ||--o{ AnalysisReport : generates
```
...
stateDiagram-v2
    ...
    Processing --> Prepared : methodsSelected
    Prepared --> Validated : dataPrepared
    Validated --> [*]
```
## Workflow
