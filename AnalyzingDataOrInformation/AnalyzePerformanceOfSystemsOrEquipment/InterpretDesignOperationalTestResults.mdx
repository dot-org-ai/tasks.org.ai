...
```mermaid
erDiagram
    TestRun ||--o{ TestResult : generates
    TestRun ||--o{ Specification : contains
    TestRun ||--o{ Interpretation : contains
    TestRun ||--o{ DesignDefect : contains
    TestRun ||--o{ Recommendation : contains
```
...
stateDiagram-v2
    [*] --> Pending
    Pending --> UnderReview : testDataAnalyzed
    UnderReview --> Processing : specCompared
    Processing --> Identified : deviationsIdentified
    Identified --> [*]
```
## Workflow
