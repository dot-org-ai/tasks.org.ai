...
```mermaid
erDiagram
    PermitApplication ||--|| ConstructionPermit : "becomes"
    PermitApplication ||--|{ BuildingPlan : "includes"
    ConstructionPermit ||--o{ InspectionReport : "requires"
    PermitApplication ||--o| ZoningApproval : "needs"
    InspectionReport }o--|| ComplianceCertificate : "leads to"
    ConstructionPermit ||--o| ComplianceCertificate : "concludes with"
```
...
stateDiagram-v2
    ...
    Submitted --> UnderReview : plansReviewed
    UnderReview --> ZoningCheck : zoningVerified
    ZoningCheck --> Permitted : permitIssued
    Permitted --> Inspecting : inspectionCompleted
    Inspecting --> Violation : violationIdentified
    Violation --> Inspecting : inspectionCompleted
    Inspecting --> Certified : certificateIssued
    Certified --> [*]
```
