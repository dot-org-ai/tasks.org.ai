...
erDiagram
    ...
    ProductionOrder ||--|{ RoutingSheet : "follows"
    BillOfMaterials ||--o{ ScrapAllowance : "adjusted-by"
    RoutingSheet ||--|| CapacityPlan : "mapped-to"
    CapacityPlan ||--|{ LaborAllocation : "assigns"
    ProductionOrder ||--|| CapacityPlan : "scheduled-in"
```
...
stateDiagram-v2
    [*] --> OrderReceived
    OrderReceived --> MaterialsCalculated : productionOrderAnalyzed
    MaterialsCalculated --> ScrapAdjusted : materialNeedsCalculated
    ScrapAdjusted --> EquipmentPlanned : scrapAllowanceApplied
    EquipmentPlanned --> LaborEstimated : equipmentHoursDetermined
    LaborEstimated --> CapacityCheck : productionLaborEstimated
    CapacityCheck --> ResourcePlanReady : capacityChecked
    CapacityCheck --> MaterialsCalculated : capacityInsufficient
    ResourcePlanReady --> [*] : resourcePlanGenerated
```
...
graph TD
    ...
    H -->|Reschedule| B
    H -->|Outsource| I[generateResourcePlan]
    G -->|Yes| I
```
