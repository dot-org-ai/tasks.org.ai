...
```mermaid
erDiagram
    CostEstimate ||--|{ LineItemEstimate : "contains"
    LineItemEstimate ||--o{ SupplierQuote : "priced-by"
    CostEstimate ||--|| EstimationBasis : "grounded-in"
    CostEstimate ||--|| ContingencyAllowance : "buffered-by"
    CostEstimate ||--o{ EstimateRevision : "versioned-as"
    SupplierQuote }o--|| EstimationBasis : "validates"
```
...
stateDiagram-v2
    ...
    RequirementsGathering --> QuoteCollection : requirementsGathered
    QuoteCollection --> EstimateBuildup : supplierQuotesReceived
    EstimateBuildup --> ContingencyPhase : costEstimateBuilt
    ContingencyPhase --> PeerReview : contingencyApplied
    PeerReview --> EstimateBuildup : revisionNeeded
    PeerReview --> Submitted : estimateReviewed
    Submitted --> AccuracyTracking : estimateSubmitted
    AccuracyTracking --> EstimateBuildup : estimateVarianceIdentified
    AccuracyTracking --> [*]
```
