...
```mermaid
erDiagram
    DemonstrationPlan ||--|| TechniqueProfile : "demonstrates"
    DemonstrationPlan ||--|{ DemonstrationSession : "scheduled as"
    DemonstrationSession ||--|{ PracticeExercise : "followed by"
    DemonstrationSession ||--o{ ObservationChecklist : "uses"
    DemonstrationSession ||--o{ RecordedDemo : "captured as"
    PracticeExercise }o--|| TechniqueProfile : "replicates"
```
...
stateDiagram-v2
    [*] --> Planned
    Planned --> MaterialsReady : materialsPrepared
    MaterialsReady --> InDemonstration : demonstrationPerformed
    InDemonstration --> Explained : keyPointsExplained
    Explained --> InPractice : practiceSupervised
    InPractice --> ReplicationCheck : evaluating
    ReplicationCheck --> InDemonstration : replicationUnsuccessful
    ReplicationCheck --> Recorded : replicationSuccessful
    Recorded --> [*]
```
