...
```mermaid
erDiagram
    TreatmentPlan ||--o{ CareTeamMeeting : "reviewed at"
    CareTeamMeeting ||--o{ ClinicalConsultation : produces
    ClinicalConsultation ||--o{ CarePlan : informs
    CarePlan ||--o{ PatientRecord : "documented in"
    PatientRecord ||--o{ TreatmentOutcome : tracks
```
...
stateDiagram-v2
    [*] --> CareteamConvened
    CareteamConvened --> ClinicalInsightsShared : clinicalInsightsShared
    ClinicalInsightsShared --> TreatmentProtocolDeveloped : treatmentProtocolDeveloped
    TreatmentProtocolDeveloped --> CareResponsibilitiesAssigned : careResponsibilitiesAssigned
    CareResponsibilitiesAssigned --> InterventionsCoordinated : interventionsCoordinated
    InterventionsCoordinated --> TreatmentProgressReviewed : treatmentProgressReviewed
    TreatmentProgressReviewed --> CarePlanAdjusted : carePlanAdjusted
    CareResponsibilitiesAssigned --> TreatmentProtocolDeveloped : revisionRequired
    CarePlanAdjusted --> [*]
```
