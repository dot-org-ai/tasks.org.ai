...
```mermaid
erDiagram
    CollaborativePartnership ||--o{ PartnershipAgreement : formalizes
    CollaborativePartnership ||--o{ SharedObjective : defines
    SharedObjective ||--o{ JointProgramPlan : drives
    JointProgramPlan ||--o{ ProgramDeliverable : produces
    ProgramConcept ||--o{ JointProgramPlan : shapes
```
...
stateDiagram-v2
    [*] --> PartnersIdentified
    PartnersIdentified --> PartnershipEstablished : partnershipEstablished
    PartnershipEstablished --> ObjectivesDefined : sharedObjectivesDefined
    ObjectivesDefined --> PlanDeveloped : programPlanCoDeveloped
    PlanDeveloped --> Executing : partnerResponsibilitiesAllocated
    Executing --> OutcomesEvaluated : partnershipOutcomesEvaluated
    PlanDeveloped --> ObjectivesDefined : sharedObjectivesDefined
    OutcomesEvaluated --> ObjectivesDefined : programPlanCoDeveloped
    OutcomesEvaluated --> [*]
```
