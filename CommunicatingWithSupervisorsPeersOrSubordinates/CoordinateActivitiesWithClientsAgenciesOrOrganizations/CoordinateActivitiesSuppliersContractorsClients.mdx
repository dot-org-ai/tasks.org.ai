...
```mermaid
erDiagram
    Activity ||--o{ Dependency : relates-to
    Dependency ||--o{ Schedule : relates-to
    Schedule ||--o{ Deliverable : relates-to
    Deliverable ||--o{ Milestone : relates-to
    Milestone ||--o{ Issue : relates-to
```
...
stateDiagram-v2
    [*] --> Activities Planned
    Activities Planned --> Responsibilities Assigned : responsibilitiesAssigned
    Responsibilities Assigned --> Schedules Synchronized : schedulesSynchronized
    Schedules Synchronized --> Progress Tracked : progressTracked
    Progress Tracked --> Conflicts Resolved : conflictsResolved
    Conflicts Resolved --> Stakeholders Updated : stakeholdersUpdated
    Stakeholders Updated --> Milestone Completed : milestoneCompleted
    Progress Tracked --> Schedules Synchronized : revisionRequired
    Milestone Completed --> [*]
```
