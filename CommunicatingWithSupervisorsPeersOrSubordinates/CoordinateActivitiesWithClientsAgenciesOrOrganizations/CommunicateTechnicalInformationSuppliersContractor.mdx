...
```mermaid
erDiagram
    TechnicalSpecification ||--o{ EngineeringDrawing : illustrates
    TechnicalSpecification ||--o{ PerformanceRequirement : defines
    TechnicalSpecification ||--o{ ChangeOrder : modifies
    ComplianceDocument ||--o{ TechnicalSpecification : validates
    TechnicalClarification ||--o{ PerformanceRequirement : resolves
```
...
stateDiagram-v2
    ...
    SpecificationDrafted --> Transmitted : specificationTransmitted
    Transmitted --> UnderReview : technicalFeedbackRequested
    UnderReview --> Clarified : requirementsClarified
    Clarified --> Verified : technicalUnderstandingVerified
    Verified --> Revised : technicalRevisionIssued
    Revised --> Transmitted : specificationTransmitted
    Verified --> SpecificationDrafted : technicalRevisionIssued
    Verified --> [*]
```
