...
```mermaid
erDiagram
    TechnicalSpecification ||--o{ EngineeringDrawing : relates-to
    EngineeringDrawing ||--o{ ComplianceDocument : relates-to
    ComplianceDocument ||--o{ PerformanceRequirement : relates-to
    PerformanceRequirement ||--o{ TechnicalClarification : relates-to
    TechnicalClarification ||--o{ ChangeOrder : relates-to
```
...
stateDiagram-v2
    ...
    Specification Transmitted --> Technical Drawings Shared : technicalDrawingsShared
    Technical Drawings Shared --> Requirements Clarified : requirementsClarified
    Requirements Clarified --> Compliance Data Submitted : complianceDataSubmitted
    Compliance Data Submitted --> Technical Revision Issued : technicalRevisionIssued
    Technical Revision Issued --> Technical Feedback Requested : technicalFeedbackRequested
    Technical Feedback Requested --> Technical Understanding Verified : technicalUnderstandingVerified
    Compliance Data Submitted --> Requirements Clarified : revisionRequired
