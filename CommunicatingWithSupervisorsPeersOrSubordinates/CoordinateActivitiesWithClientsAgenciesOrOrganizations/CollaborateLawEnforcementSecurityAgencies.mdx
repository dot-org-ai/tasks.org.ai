...
```mermaid
erDiagram
    SecurityIncident ||--o{ IncidentReport : documents
    SecurityIncident ||--o{ CollaborativeInvestigation : triggers
    InformationSharingAgreement ||--o{ ThreatIntelligence : governs
    AgencyRequest ||--o{ IncidentReport : references
    CollaborativeInvestigation ||--o{ ThreatIntelligence : produces
```
...
stateDiagram-v2
    [*] --> IncidentDetected
    IncidentDetected --> ReportedToAgency : securityIncidentReported
    ReportedToAgency --> UnderInvestigation : investigationCoordinated
    UnderInvestigation --> IntelligenceExchanged : intelligenceShared
    IntelligenceExchanged --> RequestFulfilled : agencyRequestResponded
    RequestFulfilled --> CollaborationDocumented : collaborationDocumented
    UnderInvestigation --> ReportedToAgency : agencyRequestResponded
    CollaborationDocumented --> IncidentDetected : securityIncidentReported
