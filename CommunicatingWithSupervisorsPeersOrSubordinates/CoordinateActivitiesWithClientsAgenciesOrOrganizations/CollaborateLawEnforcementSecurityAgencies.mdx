...
```mermaid
erDiagram
    SecurityIncident ||--o{ InformationSharingAgreement : relates-to
    InformationSharingAgreement ||--o{ IncidentReport : relates-to
    IncidentReport ||--o{ AgencyRequest : relates-to
    AgencyRequest ||--o{ ThreatIntelligence : relates-to
    ThreatIntelligence ||--o{ CollaborativeInvestigation : relates-to
```
...
stateDiagram-v2
    ...
    Security Incident Reported --> Intelligence Shared : intelligenceShared
    Intelligence Shared --> Agency Request Responded : agencyRequestResponded
    Agency Request Responded --> Investigation Coordinated : investigationCoordinated
    Investigation Coordinated --> Information Sharing Established : informationSharingEstablished
    Information Sharing Established --> Threat Briefing Received : threatBriefingReceived
    Threat Briefing Received --> Collaboration Documented : collaborationDocumented
    Investigation Coordinated --> Agency Request Responded : revisionRequired
