...
```mermaid
stateDiagram-v2
    [*] --> TechnicalRequirementsDefined
    TechnicalRequirementsDefined --> EquipmentNeedsReviewed : equipmentNeedsReviewed
    EquipmentNeedsReviewed --> VenuePlotCreated : venuePlotCreated
    VenuePlotCreated --> TechnicalRehearsalScheduled : technicalRehearsalScheduled
    TechnicalRehearsalScheduled --> TechnicalConflictResolved : technicalConflictResolved
    TechnicalConflictResolved --> VenuePlotCreated : revisionRequired
    TechnicalRehearsalScheduled --> CuePlanDocumented : cuePlanDocumented
    CuePlanDocumented --> TechnicalPlanApproved : technicalPlanApproved
