...
```mermaid
stateDiagram-v2
    [*] --> ProductionScopeDefined
    ProductionScopeDefined --> ResourcesAllocated : resourcesAllocated
    ResourcesAllocated --> ScheduleSet : scheduleSet
    ScheduleSet --> BillOfMaterialsReviewed : billOfMaterialsReviewed
    BillOfMaterialsReviewed --> ProductionPlanApproved : productionPlanApproved
    ProductionPlanApproved --> ProductionDetailsAdjusted : productionDetailsAdjusted
    ProductionDetailsAdjusted --> ResourcesAllocated : revisionRequired
    ProductionPlanApproved --> HandoffCoordinated : handoffCoordinated
    HandoffCoordinated --> [*]
```
