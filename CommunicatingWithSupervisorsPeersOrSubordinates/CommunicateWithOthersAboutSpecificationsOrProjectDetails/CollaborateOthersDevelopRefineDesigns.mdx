...
```mermaid
erDiagram
    DesignConcept ||--o{ Prototype : materializes
    Prototype ||--o{ DesignReview : undergoes
    DesignReview ||--|{ FeedbackItem : generates
    FeedbackItem }o--|| Revision : informs
    Revision ||--|| DesignApproval : culminates-in
```
...
stateDiagram-v2
    [*] --> Concept Proposed
    Concept Proposed --> Design Review Conducted : designReviewConducted
    Design Review Conducted --> Feedback Collected : feedbackCollected
    Feedback Collected --> Design Revised : designRevised
    Design Revised --> Design Review Conducted : revisionRequired
    Feedback Collected --> Prototype Built : prototypeBuilt
    Prototype Built --> Design Approved : designApproved
    Design Approved --> Design Version Archived : designVersionArchived
    Design Version Archived --> [*]
```
