...
stateDiagram-v2
    [*] --> ConceptProposed
    ConceptProposed --> DesignReviewConducted : designReviewConducted
    DesignReviewConducted --> FeedbackCollected : feedbackCollected
    FeedbackCollected --> DesignRevised : designRevised
    DesignRevised --> DesignReviewConducted : revisionRequired
    FeedbackCollected --> PrototypeBuilt : prototypeBuilt
    PrototypeBuilt --> DesignApproved : designApproved
    DesignApproved --> DesignVersionArchived : designVersionArchived
    DesignVersionArchived --> [*]
```
