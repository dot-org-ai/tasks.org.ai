...
stateDiagram-v2
    ...
    Consultation Scheduled --> Site Conditions Reviewed : siteConditionsReviewed
    Site Conditions Reviewed --> Calculations Validated : calculationsValidated
    Calculations Validated --> Design Package Prepared : designPackagePrepared
    Design Package Prepared --> Code Compliance Assessed : codeComplianceAssessed
    Code Compliance Assessed --> Operational Plan Finalized : operationalPlanFinalized
    Code Compliance Assessed --> Design Revision Issued : designRevisionIssued
    Design Revision Issued --> Calculations Validated : revisionRequired
    Operational Plan Finalized --> [*]
```
