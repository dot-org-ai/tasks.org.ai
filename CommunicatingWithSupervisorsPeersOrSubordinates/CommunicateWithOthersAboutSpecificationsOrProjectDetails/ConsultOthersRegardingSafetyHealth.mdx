...
```mermaid
stateDiagram-v2
    [*] --> HazardAssessmentConducted
    HazardAssessmentConducted --> EquipmentComplianceReviewed : equipmentComplianceReviewed
    EquipmentComplianceReviewed --> FacilityInspectionScheduled : facilityInspectionScheduled
    FacilityInspectionScheduled --> CorrectiveActionRecommended : correctiveActionRecommended
    CorrectiveActionRecommended --> CorrectiveActionApproved : correctiveActionApproved
    CorrectiveActionApproved --> PPERequirementsUpdated : ppeRequirementsUpdated
    CorrectiveActionRecommended --> EquipmentComplianceReviewed : revisionRequired
    PPERequirementsUpdated --> ConsultationDocumented : consultationDocumented
    ConsultationDocumented --> [*]
```
