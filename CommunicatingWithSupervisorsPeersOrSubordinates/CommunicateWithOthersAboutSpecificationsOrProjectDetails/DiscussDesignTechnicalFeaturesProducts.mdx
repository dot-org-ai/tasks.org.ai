...
stateDiagram-v2
    [*] --> DiscussionInitiated
    DiscussionInitiated --> FeatureDetailsPresented : featureDetailsPresented
    FeatureDetailsPresented --> ConstraintsClarified : constraintsClarified
    ConstraintsClarified --> CompatibilityAssessed : compatibilityAssessed
    CompatibilityAssessed --> ConstraintsClarified : revisionRequired
    ConstraintsClarified --> DecisionsDocumented : decisionsDocumented
    DecisionsDocumented --> FeatureSpecUpdated : featureSpecUpdated
    FeatureSpecUpdated --> KnowledgeBaseShared : knowledgeBaseShared
    KnowledgeBaseShared --> [*]
```
