...
stateDiagram-v2
    ...
    Requirements Gathered --> Specification Drafted : specificationDrafted
    Specification Drafted --> Design Review Conducted : designReviewConducted
    Design Review Conducted --> Feasibility Assessed : feasibilityAssessed
    Feasibility Assessed --> Specification Revised : specificationRevised
    Specification Revised --> Design Review Conducted : revisionRequired
    Specification Revised --> Specification Approved : specificationApproved
    Specification Approved --> Specification Distributed : specificationDistributed
