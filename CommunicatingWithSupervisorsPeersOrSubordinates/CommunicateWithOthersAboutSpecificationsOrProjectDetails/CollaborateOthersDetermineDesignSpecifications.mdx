...
```mermaid
erDiagram
    Specification ||--o{ Revision : evolves-through
    Revision ||--o{ ReviewComment : receives
    ReviewComment }o--|| DesignBrief : informs
    DesignBrief ||--|| FeasibilityAssessment : requires
```
...
stateDiagram-v2
    ...
    RequirementsGathered --> SpecificationDrafted : specificationDrafted
    SpecificationDrafted --> DesignReviewConducted : designReviewConducted
    DesignReviewConducted --> FeasibilityAssessed : feasibilityAssessed
    FeasibilityAssessed --> SpecificationRevised : specificationRevised
    SpecificationRevised --> DesignReviewConducted : revisionRequired
    SpecificationRevised --> SpecificationApproved : specificationApproved
    SpecificationApproved --> SpecificationDistributed : specificationDistributed
    SpecificationDistributed --> [*]
```
