...
stateDiagram-v2
    ...
    Stakeholder Map Updated --> Status Report Published : statusReportPublished
    Status Report Published --> Milestone Presented : milestonePresented
    Milestone Presented --> Risk Escalated : riskEscalated
    Risk Escalated --> Change Notified : changeNotified
    Change Notified --> Status Report Published : revisionRequired
    Risk Escalated --> Review Scheduled : reviewScheduled
    Review Scheduled --> Minutes Distributed : minutesDistributed
    Minutes Distributed --> [*]
```
