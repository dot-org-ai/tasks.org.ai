...
```mermaid
erDiagram
    EmergencyRequest ||--o{ Incident : relates-to
    Incident ||--o{ ResponseUnit : relates-to
    ResponseUnit ||--o{ ArrivalConfirmation : relates-to
    ArrivalConfirmation ||--o{ ResourceRequirement : relates-to
    ResourceRequirement ||--o{ IncidentReport : relates-to
```
...
stateDiagram-v2
    [*] --> Emergency Assessed
    Emergency Assessed --> Request Submitted : requestSubmitted
    Request Submitted --> Resources Specified : resourcesSpecified
    Resources Specified --> Personnel Dispatched : personnelDispatched
    Personnel Dispatched --> Arrival Confirmed : arrivalConfirmed
    Arrival Confirmed --> Response Documented : responseDocumented
    Personnel Dispatched --> Resources Specified : revisionRequired
    Response Documented --> [*]
```
