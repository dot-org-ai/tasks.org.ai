...
```mermaid
erDiagram
    MalfunctionReport ||--o{ Vehicle : documents
    MalfunctionReport ||--o{ Equipment : documents
    Vehicle ||--o{ InspectionChecklist : requires
    MalfunctionReport ||--o{ RepairOrder : generates
    OutOfServiceTag ||--o{ Vehicle : grounds
```
...
stateDiagram-v2
    [*] --> MalfunctionReported
    MalfunctionReported --> TaggedOutOfService : vehicleTaggedOutOfService
    TaggedOutOfService --> RepairOrderCreated : repairOrderCreated
    RepairOrderCreated --> MalfunctionDiagnosed : malfunctionDiagnosed
    MalfunctionDiagnosed --> RepairCompleted : repairCompleted
    RepairCompleted --> ReturnedToService : vehicleReturnedToService
    MalfunctionDiagnosed --> RepairOrderCreated : repairOrderCreated
    ReturnedToService --> [*]
```
