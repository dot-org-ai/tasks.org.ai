...
```mermaid
erDiagram
    MalfunctionReport ||--o{ Vehicle : relates-to
    Vehicle ||--o{ Equipment : relates-to
    Equipment ||--o{ InspectionChecklist : relates-to
    InspectionChecklist ||--o{ RepairOrder : relates-to
    RepairOrder ||--o{ OutOfServiceTag : relates-to
```
...
stateDiagram-v2
    ...
    Malfunction Reported --> Vehicle Tagged Out Of Service : vehicleTaggedOutOfService
    Vehicle Tagged Out Of Service --> Repair Order Created : repairOrderCreated
    Repair Order Created --> Malfunction Diagnosed : malfunctionDiagnosed
    Malfunction Diagnosed --> Repair Completed : repairCompleted
    Repair Completed --> Vehicle Returned To Service : vehicleReturnedToService
    Malfunction Diagnosed --> Repair Order Created : revisionRequired
