...
```mermaid
erDiagram
    Violation ||--o{ Warning : relates-to
    Warning ||--o{ Rule : relates-to
    Rule ||--o{ CorrectiveAction : relates-to
    CorrectiveAction ||--o{ IncidentReport : relates-to
    IncidentReport ||--o{ EscalationRecord : relates-to
```
...
stateDiagram-v2
    ...
    Violation Identified --> Verbal Warning Issued : verbalWarningIssued
    Verbal Warning Issued --> Written Warning Issued : writtenWarningIssued
    Written Warning Issued --> Corrective Action Assigned : correctiveActionAssigned
    Corrective Action Assigned --> Violation Escalated : violationEscalated
    Violation Escalated --> Violation Closed : violationClosed
    Violation Closed --> Incident Recorded : incidentRecorded
    Corrective Action Assigned --> Written Warning Issued : revisionRequired
    Incident Recorded --> [*]
```
