...
```mermaid
erDiagram
    MaintenanceReport ||--o{ Equipment : relates-to
    Equipment ||--o{ WorkOrder : relates-to
    WorkOrder ||--o{ PriorityLevel : relates-to
    PriorityLevel ||--o{ RepairLog : relates-to
    RepairLog ||--o{ Attachment : relates-to
```
...
stateDiagram-v2
    [*] --> Report Submitted
    Report Submitted --> Priority Assessed : priorityAssessed
    Priority Assessed --> Work Order Assigned : workOrderAssigned
    Work Order Assigned --> Report Acknowledged : reportAcknowledged
    Report Acknowledged --> Issue Resolved : issueResolved
    Issue Resolved --> Report Escalated : reportEscalated
    Report Acknowledged --> Work Order Assigned : revisionRequired
    Report Escalated --> [*]
```
