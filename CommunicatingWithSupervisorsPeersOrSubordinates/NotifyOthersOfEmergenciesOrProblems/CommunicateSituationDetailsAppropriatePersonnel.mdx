...
```mermaid
erDiagram
    SituationReport ||--o{ Situation : relates-to
    Situation ||--o{ Recipient : relates-to
    Recipient ||--o{ CommunicationChannel : relates-to
    CommunicationChannel ||--o{ ActionItem : relates-to
    ActionItem ||--o{ Acknowledgment : relates-to
```
...
stateDiagram-v2
    [*] --> Situation Assessed
    Situation Assessed --> Report Composed : reportComposed
    Report Composed --> Recipients Identified : recipientsIdentified
    Recipients Identified --> Report Delivered : reportDelivered
    Report Delivered --> Understanding Confirmed : understandingConfirmed
    Understanding Confirmed --> Follow Up Assigned : followUpAssigned
    Report Delivered --> Recipients Identified : revisionRequired
    Follow Up Assigned --> [*]
```
