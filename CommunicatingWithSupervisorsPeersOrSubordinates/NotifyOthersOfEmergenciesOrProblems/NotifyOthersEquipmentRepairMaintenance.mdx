...
```mermaid
erDiagram
    MaintenanceNotification ||--o{ Equipment : relates-to
    Equipment ||--o{ MaintenanceSchedule : relates-to
    MaintenanceSchedule ||--o{ ServiceRequest : relates-to
    ServiceRequest ||--o{ DowntimeWindow : relates-to
    DowntimeWindow ||--o{ SparePart : relates-to
```
...
stateDiagram-v2
    ...
    Notification Created --> Urgency Classified : urgencyClassified
    Urgency Classified --> Stakeholders Notified : stakeholdersNotified
    Stakeholders Notified --> Downtime Scheduled : downtimeScheduled
    Downtime Scheduled --> Parts Ordered : partsOrdered
    Parts Ordered --> Resolution Confirmed : resolutionConfirmed
    Downtime Scheduled --> Stakeholders Notified : revisionRequired
