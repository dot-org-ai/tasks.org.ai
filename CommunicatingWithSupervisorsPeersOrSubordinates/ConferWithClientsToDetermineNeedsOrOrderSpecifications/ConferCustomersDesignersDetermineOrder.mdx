...
```mermaid
erDiagram
    OrderSpecification ||--o{ DesignRequirement : relates-to
    DesignRequirement ||--o{ CustomerPreference : relates-to
    CustomerPreference ||--o{ FeasibilityAssessment : relates-to
    FeasibilityAssessment ||--o{ ApprovalSignoff : relates-to
```
...
stateDiagram-v2
    ...
    Conference Initiated --> Requirements Captured : requirementsCaptured
    Requirements Captured --> Specifications Validated : specificationsValidated
    Specifications Validated --> Specifications Revised : specificationsRevised
    Specifications Revised --> Design Options Presented : designOptionsPresented
    Design Options Presented --> Approval Requested : approvalRequested
    Approval Requested --> Order Spec Finalized : orderSpecFinalized
    Specifications Revised --> Specifications Validated : revisionRequired
    Order Spec Finalized --> [*]
```
