...
stateDiagram-v2
    [*] --> Discovery Scheduled
    Discovery Scheduled --> Needs Assessment Conducted : needsAssessmentConducted
    Needs Assessment Conducted --> Requirements Documented : requirementsDocumented
    Requirements Documented --> Needs Prioritized : needsPrioritized
    Needs Prioritized --> Understanding Validated : understandingValidated
    Understanding Validated --> Scope Defined : scopeDefined
    Understanding Validated --> Needs Assessment Conducted : revisionRequired
    Scope Defined --> Findings Presented : findingsPresented
    Findings Presented --> [*]
```
