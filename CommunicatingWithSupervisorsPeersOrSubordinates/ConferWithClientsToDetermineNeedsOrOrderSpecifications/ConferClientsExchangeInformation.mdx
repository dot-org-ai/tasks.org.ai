...
```mermaid
erDiagram
    InformationRequest ||--o{ SharedDocument : relates-to
    SharedDocument ||--o{ MeetingAgenda : relates-to
    MeetingAgenda ||--o{ ActionItem : relates-to
    ActionItem ||--o{ FeedbackRecord : relates-to
    FeedbackRecord ||--o{ CommunicationLog : relates-to
```
...
stateDiagram-v2
    ...
    Conference Scheduled --> Document Shared : documentShared
    Document Shared --> Information Requested : informationRequested
    Information Requested --> Feedback Recorded : feedbackRecorded
    Feedback Recorded --> Action Item Assigned : actionItemAssigned
    Action Item Assigned --> Communication Log Updated : communicationLogUpdated
    Communication Log Updated --> Information Gap Resolved : informationGapResolved
    Feedback Recorded --> Information Requested : revisionRequired
    Information Gap Resolved --> [*]
```
