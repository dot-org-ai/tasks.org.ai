...
```mermaid
erDiagram
    Problem ||--|| IssueReport : "documented in"
    Problem ||--o| Resolution : "resolved by"
    Problem ||--o| WorkBlocker : "creates"
    IssueReport }o--|| EscalationPath : "follows"
    ResourceRequest }o--|| Problem : "addresses"
    Resolution }o--|| Problem : "closes"
    WorkBlocker }o--|{ ResourceRequest : "requires"
```
...
stateDiagram-v2
    [*] --> ProblemReported
    ProblemReported --> SupportRequested : supportRequested
    SupportRequested --> SolutionProposed : solutionProposed
    SupportRequested --> IssueEscalated : issueEscalated
    IssueEscalated --> SupportRequested : resourcesSecured
    SolutionProposed --> ProblemStatusUpdated : problemStatusUpdated
    ProblemStatusUpdated --> ProblemClosed : problemClosed
    ProblemStatusUpdated --> SupportRequested : unresolved
    ProblemClosed --> ProblemReopened : problemReopened
    ProblemReopened --> SupportRequested : reactivated
    ProblemClosed --> [*]
```
