...
erDiagram
    ...
    TaskAssignment ||--o| ResourceAllocation : "requires"
    HandoffNote }o--|| TaskAssignment : "documents"
    WorkSchedule ||--o{ ResourceAllocation : "allocates"
    StatusUpdate }o--|| HandoffNote : "feeds into"
```
...
stateDiagram-v2
    [*] --> StandupConducted
    StandupConducted --> TaskAssigned : taskAssigned
    TaskAssigned --> UpdateShared : updateShared
    UpdateShared --> ConflictResolved : conflictResolved
    UpdateShared --> AssistanceRequested : assistanceRequested
    ConflictResolved --> UpdateShared : statusUpdated
    AssistanceRequested --> UpdateShared : helped
    UpdateShared --> HandoffDocumented : handoffDocumented
    HandoffDocumented --> TaskCompleted : taskCompleted
    TaskCompleted --> [*]
```
