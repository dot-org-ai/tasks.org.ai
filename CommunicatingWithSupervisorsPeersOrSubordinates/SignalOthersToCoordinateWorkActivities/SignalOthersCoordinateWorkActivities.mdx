...
```mermaid
erDiagram
    Signal ||--o{ SignalProtocol : relates-to
    SignalProtocol ||--o{ ActivitySequence : relates-to
    ActivitySequence ||--o{ Acknowledgment : relates-to
    Acknowledgment ||--o{ CoordinationLog : relates-to
```
...
stateDiagram-v2
    [*] --> Protocol Defined
    Protocol Defined --> Signal Sent : signalSent
    Signal Sent --> Signal Acknowledged : signalAcknowledged
    Signal Acknowledged --> Action Executed : actionExecuted
    Action Executed --> Completion Verified : completionVerified
    Completion Verified --> Signal Logged : signalLogged
    Signal Logged --> Operation Aborted : operationAborted
    Action Executed --> Signal Acknowledged : revisionRequired
    Operation Aborted --> [*]
```
