...
```mermaid
erDiagram
    Problem ||--o{ Escalation : relates-to
    Escalation ||--o{ StatusReport : relates-to
    StatusReport ||--o{ ResourceRequest : relates-to
    ResourceRequest ||--o{ Resolution : relates-to
    Resolution ||--o{ Meeting : relates-to
```
...
stateDiagram-v2
    [*] --> Problem Reported
    Problem Reported --> Issue Escalated : issueEscalated
    Issue Escalated --> Resources Requested : resourcesRequested
    Resources Requested --> Discussion Scheduled : discussionScheduled
    Discussion Scheduled --> Status Updated : statusUpdated
    Status Updated --> Resolution Documented : resolutionDocumented
    Resolution Documented --> Responsibility Assigned : responsibilityAssigned
    Discussion Scheduled --> Resources Requested : revisionRequired
