...
```mermaid
erDiagram
    DesignIssue ||--o{ Collaboration : initiates
    DesignIssue ||--o{ Diagnostic : investigates
    Collaboration ||--o{ Solution : proposes
    Solution ||--o{ TechnicalReview : validates
    TechnicalReview ||--o{ ChangeRequest : authorizes
```
...
stateDiagram-v2
    [*] --> IssueIdentified
    IssueIdentified --> SpecialistEngaged : specialistEngaged
    SpecialistEngaged --> DiagnosticCompleted : diagnosticCompleted
    DiagnosticCompleted --> SolutionProposed : solutionProposed
    SolutionProposed --> SolutionApproved : solutionApproved
    SolutionApproved --> FixImplemented : fixImplemented
    SolutionProposed --> DiagnosticCompleted : diagnosticCompleted
    FixImplemented --> IssueIdentified : issueIdentified
    FixImplemented --> [*]
```
