...
```mermaid
erDiagram
    CaseFile ||--o{ MeetingBrief : relates-to
    MeetingBrief ||--o{ IssueList : relates-to
    IssueList ||--o{ MeetingRecord : relates-to
    MeetingRecord ||--o{ FollowUpAction : relates-to
    FollowUpAction ||--o{ ConfidentialityAgreement : relates-to
```
...
stateDiagram-v2
    [*] --> Brief Prepared
    Brief Prepared --> Meeting Scheduled : meetingScheduled
    Meeting Scheduled --> Information Presented : informationPresented
    Information Presented --> Issues Clarified : issuesClarified
    Issues Clarified --> Outcomes Documented : outcomesDocumented
    Outcomes Documented --> Follow Ups Assigned : followUpsAssigned
    Follow Ups Assigned --> Case File Updated : caseFileUpdated
    Issues Clarified --> Information Presented : revisionRequired
    Case File Updated --> [*]
```
