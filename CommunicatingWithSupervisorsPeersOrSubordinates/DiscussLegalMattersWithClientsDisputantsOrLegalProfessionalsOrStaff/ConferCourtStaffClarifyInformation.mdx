...
```mermaid
erDiagram
    CourtInquiry ||--o{ FilingRequirement : relates-to
    FilingRequirement ||--o{ HearingSchedule : relates-to
    HearingSchedule ||--o{ CourtRule : relates-to
    CourtRule ||--o{ ClarificationRecord : relates-to
    ClarificationRecord ||--o{ CaseCalendar : relates-to
```
...
stateDiagram-v2
    [*] --> Question Identified
    Question Identified --> Inquiry Submitted : inquirySubmitted
    Inquiry Submitted --> Clarification Received : clarificationReceived
    Clarification Received --> Clarification Verified : clarificationVerified
    Clarification Verified --> Case Calendar Updated : caseCalendarUpdated
    Case Calendar Updated --> Clarification Documented : clarificationDocumented
    Clarification Documented --> Team Notified : teamNotified
    Clarification Verified --> Clarification Received : revisionRequired
    Team Notified --> [*]
```
