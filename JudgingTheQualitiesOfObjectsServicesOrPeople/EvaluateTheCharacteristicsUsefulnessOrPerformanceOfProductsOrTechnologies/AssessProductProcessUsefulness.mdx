...
```mermaid
erDiagram
    Product ||--o{ UseCase : "applied in"
    Product ||--o{ Feedback : receives
    Process ||--o{ UseCase : "applied in"
    UserNeed ||--o{ UseCase : defines
    Feedback }o--|| UsefulnessMetric : "contributes to"
    UseCase }o--|| UsefulnessMetric : measures
```
...
stateDiagram-v2
    ...
    NeedsIdentified --> AdoptionTracked : adoptionMeasured
    AdoptionTracked --> FeedbackGathered : feedbackCollected
    FeedbackGathered --> FitAssessed : fitAssessed
    FitAssessed --> AlternativesCompared : alternativesCompared
    AlternativesCompared --> OutcomesReviewed : outcomesAnalyzed
    OutcomesReviewed --> Improved : improvementsRecommended
    OutcomesReviewed --> AdoptionTracked : adoptionMeasured
    Improved --> NeedsIdentified : needsIdentified
    Improved --> [*]
```
