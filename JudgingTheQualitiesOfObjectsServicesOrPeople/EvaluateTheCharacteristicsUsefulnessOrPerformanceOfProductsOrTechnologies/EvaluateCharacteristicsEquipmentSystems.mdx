...
erDiagram
    ...
    Equipment ||--o{ TestResult : generates
    System ||--o{ Equipment : "composed of"
    Specification }o--|| Standard : "validated against"
    TestResult }o--|| EvaluationCriterion : "scored by"
    EvaluationCriterion }o--|| Standard : "derived from"
```
...
```mermaid
stateDiagram-v2
    [*] --> SpecsVerified : specificationsVerified
    SpecsVerified --> PerformanceTested : performanceTested
    PerformanceTested --> ReliabilityAssessed : reliabilityAssessed
    ReliabilityAssessed --> ComplianceChecked : complianceChecked
    ComplianceChecked --> SuitabilityEvaluated : suitabilityEvaluated
    SuitabilityEvaluated --> OptionsCompared : optionsCompared
    OptionsCompared --> Selected : selectionRecommended
    OptionsCompared --> SpecsVerified : specificationsVerified
    Selected --> [*]
```
...
graph TD
    ...
    G -->|No| I{Other Options?}
    I -->|Yes| A
    I -->|No| J[Reject All Options]
    H --> K[Proceed to Procurement]
```
