...
erDiagram
    ...
    Invoice }o--|| AccountBalance : "tracked in"
    Payment }o--|| AccountBalance : "reduces"
```
...
stateDiagram-v2
    ...
    Invoiced --> Reminded : reminderSent
    Reminded --> Processed : paymentProcessed
    Invoiced --> Processed : paymentProcessed
    Processed --> Receipted : receiptIssued
    Receipted --> Applied : paymentApplied
    Applied --> Recorded : revenueRecorded
    Reminded --> WrittenOff : balanceWrittenOff
    Recorded --> [*]
    WrittenOff --> [*]
```
