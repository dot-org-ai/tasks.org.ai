...
```mermaid
erDiagram
    InventoryItem ||--o{ PhysicalCount : "counted in"
    PhysicalCount ||--o{ Variance : "reveals"
    Variance ||--|| InventoryAdjustment : "corrected by"
    CycleCountSchedule ||--|{ PhysicalCount : "schedules"
    InventoryItem }o--|| Location : "stored at"
    PhysicalCount }o--|| Location : "conducted at"
```
...
stateDiagram-v2
    ...
    Scheduled --> Counted : physicalCountConducted
    Counted --> Recorded : countRecorded
    Recorded --> VariancesFound : variancesIdentified
    VariancesFound --> Investigated : discrepancyInvestigated
    Investigated --> Adjusted : inventoryAdjusted
    Adjusted --> Reported : countReportGenerated
    Recorded --> Reported : countReportGenerated
    Reported --> Scheduled : countScheduled
    Reported --> [*]
```
