...
```mermaid
erDiagram
    StoneSpecimen ||--o{ PhysicalTest : "references"
    TestResult }o--|| StoneSpecimen : "contains"
    StoneSpecimen ||--|{ GradeClassification : "produces"
    StoneSpecimen ||--o{ PetrographicAnalysis : "summarized in"
    ComplianceCertificate }o--|| StoneSpecimen : "documents"
    PhysicalTest ||--o{ GradeClassification : "produces"
```
...
stateDiagram-v2
    [*] --> SpecimenIntaken
    SpecimenIntaken --> VisualExamCompleted : visualExamCompleted
    VisualExamCompleted --> CompressiveStrengthTested : compressiveStrengthTested
    CompressiveStrengthTested --> WaterAbsorptionTested : waterAbsorptionTested
    WaterAbsorptionTested --> DensityMeasured : densityMeasured
    DensityMeasured --> GradeClassified : gradeClassified
    GradeClassified --> CertificateIssued : certificateIssued
    WaterAbsorptionTested --> NeedsReview : waterAbsorptionTested
    NeedsReview --> CompressiveStrengthTested : compressiveStrengthTested
    CertificateIssued --> [*]
```
