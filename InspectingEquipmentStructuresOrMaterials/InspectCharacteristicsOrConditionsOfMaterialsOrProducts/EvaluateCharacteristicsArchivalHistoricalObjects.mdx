...
```mermaid
erDiagram
    Object ||--o{ ConditionReport : "contains"
    Provenance }o--|| Object : "documents"
    Object ||--|{ Appraisal : "contains"
    Object ||--o{ TreatmentPlan : "contains"
    Catalog }o--|| Object : "documents"
    ConditionReport ||--o{ Appraisal : "contains"
```
...
stateDiagram-v2
    [*] --> ObjectInspected
    ObjectInspected --> ConditionDocumented : conditionDocumented
    ConditionDocumented --> ProvenanceResearched : provenanceResearched
    ProvenanceResearched --> AppraisalRequested : appraisalRequested
    AppraisalRequested --> TreatmentPlanCreated : treatmentPlanCreated
    TreatmentPlanCreated --> ObjectCataloged : objectCataloged
    ObjectCataloged --> StorageAssigned : storageAssigned
    AppraisalRequested --> NeedsReview : appraisalRequested
    NeedsReview --> ProvenanceResearched : provenanceResearched
    StorageAssigned --> [*]
```
