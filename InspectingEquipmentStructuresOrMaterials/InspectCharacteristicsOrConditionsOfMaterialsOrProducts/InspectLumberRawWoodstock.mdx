...
```mermaid
erDiagram
    LumberLot ||--o{ InspectionReport : "documents"
    GradeAssignment }o--|| LumberLot : "contains"
    LumberLot ||--|{ DefectRecord : "may have"
    LumberLot ||--o{ MoistureReading : "contains"
    Species }o--|| LumberLot : "contains"
    InspectionReport ||--o{ DefectRecord : "may have"
```
...
stateDiagram-v2
    [*] --> LotReceived
    LotReceived --> MoistureMeasured : moistureMeasured
    MoistureMeasured --> DefectIdentified : defectIdentified
    DefectIdentified --> GradeAssigned : gradeAssigned
    GradeAssigned --> MaterialRejected : materialRejected
    MaterialRejected --> ReportGenerated : reportGenerated
    ReportGenerated --> LotApproved : lotApproved
    GradeAssigned --> NeedsReview : gradeAssigned
    NeedsReview --> DefectIdentified : defectIdentified
    LotApproved --> [*]
```
