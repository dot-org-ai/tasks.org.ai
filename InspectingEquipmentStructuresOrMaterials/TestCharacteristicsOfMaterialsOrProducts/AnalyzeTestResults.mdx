...
```mermaid
erDiagram
    DataSet ||--o{ StatisticalSummary : "references"
    ControlChart }o--|| DataSet : "contains"
    DataSet ||--|{ TrendReport : "documents"
    DataSet ||--o{ AnomalyFlag : "contains"
    RootCauseAnalysis }o--|| DataSet : "produces"
    DataSet ||--|{ ComplianceEvidence : "documents"
    DataSet ||--o{ ActionableInsight : "triggers"
    StatisticalSummary ||--o{ TrendReport : "documents"
```
...
stateDiagram-v2
    [*] --> DataAggregated
    DataAggregated --> StatisticsCalculated : statisticsCalculated
    StatisticsCalculated --> ControlChartUpdated : controlChartUpdated
    ControlChartUpdated --> TrendIdentified : trendIdentified
    TrendIdentified --> AnomalyFlagged : anomalyFlagged
    AnomalyFlagged --> RootCauseIdentified : rootCauseIdentified
    RootCauseIdentified --> InsightsGenerated : insightsGenerated
    InsightsGenerated --> ReportPublished : reportPublished
    AnomalyFlagged --> NeedsReview : anomalyFlagged
    NeedsReview --> TrendIdentified : trendIdentified
    ReportPublished --> [*]
```
