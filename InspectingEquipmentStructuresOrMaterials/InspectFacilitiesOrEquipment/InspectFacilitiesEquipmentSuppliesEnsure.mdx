...
```mermaid
erDiagram
    ConformanceStandard ||--o{ InspectionChecklist : "references"
    NonConformanceReport }o--|| ConformanceStandard : "documents"
    ConformanceStandard ||--|{ CalibrationRecord : "documents"
    ConformanceStandard ||--o{ CertificateOfConformance : "documents"
    AuditFinding }o--|| ConformanceStandard : "contains"
    ConformanceStandard ||--|{ CorrectiveActionRequest : "contains"
    ConformanceStandard ||--o{ ComplianceMatrix : "contains"
    InspectionChecklist ||--o{ CalibrationRecord : "documents"
```
...
```mermaid
stateDiagram-v2
    [*] --> InspectionScopeDefined
    InspectionScopeDefined --> FacilityInspected : facilityInspected
    FacilityInspected --> EquipmentInspected : equipmentInspected
    EquipmentInspected --> SuppliesInspected : suppliesInspected
    SuppliesInspected --> NonConformanceDocumented : nonConformanceDocumented
    NonConformanceDocumented --> CorrectiveActionIssued : correctiveActionIssued
    CorrectiveActionIssued --> CorrectionVerified : correctionVerified
    CorrectionVerified --> CertificateIssued : certificateIssued
    NonConformanceDocumented --> NeedsReview : nonConformanceDocumented
    NeedsReview --> SuppliesInspected : suppliesInspected
    CertificateIssued --> [*]
```
