...
```mermaid
erDiagram
    SiteConditionReport ||--o{ ConditionRating : "references"
    DeficiencyItem }o--|| SiteConditionReport : "contains"
    SiteConditionReport ||--|{ RepairEstimate : "may have"
    SiteConditionReport ||--o{ WorkOrder : "contains"
    PhotoDocumentation }o--|| SiteConditionReport : "contains"
    SiteConditionReport ||--|{ MaintenanceBacklog : "contains"
    SiteConditionReport ||--o{ InspectionSchedule : "follows"
    ConditionRating ||--o{ RepairEstimate : "may have"
```
...
stateDiagram-v2
    ...
    ConditionRated --> DeficiencyDocumented : deficiencyDocumented
    DeficiencyDocumented --> RepairEstimated : repairEstimated
    RepairEstimated --> RepairsPrioritized : repairsPrioritized
    RepairsPrioritized --> WorkOrderGenerated : workOrderGenerated
    WorkOrderGenerated --> ReportCompiled : reportCompiled
    ReportCompiled --> FollowUpScheduled : followUpScheduled
    RepairsPrioritized --> NeedsReview : repairsPrioritized
    NeedsReview --> RepairEstimated : repairEstimated
    FollowUpScheduled --> [*]
```
