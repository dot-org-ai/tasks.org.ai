...
```mermaid
erDiagram
    InspectionRoute ||--o{ ConditionReport : "documents"
    PerformanceTest }o--|| InspectionRoute : "references"
    InspectionRoute ||--|{ Deficiency : "may have"
    InspectionRoute ||--o{ MaintenanceRecommendation : "contains"
    AssetHealthScore }o--|| InspectionRoute : "uses"
    ConditionReport ||--o{ Deficiency : "may have"
```
...
stateDiagram-v2
    [*] --> InspectionScheduled
    InspectionScheduled --> VisualExamPerformed : visualExamPerformed
    VisualExamPerformed --> PerformanceTested : performanceTested
    PerformanceTested --> DeficienciesIdentified : deficienciesIdentified
    DeficienciesIdentified --> AssetHealthAssessed : assetHealthAssessed
    AssetHealthAssessed --> MaintenanceRecommended : maintenanceRecommended
    MaintenanceRecommended --> ReportIssued : reportIssued
    DeficienciesIdentified --> NeedsReview : deficienciesIdentified
    NeedsReview --> PerformanceTested : performanceTested
    ReportIssued --> [*]
```
