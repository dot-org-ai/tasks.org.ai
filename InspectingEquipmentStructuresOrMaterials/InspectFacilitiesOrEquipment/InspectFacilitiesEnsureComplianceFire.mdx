...
```mermaid
erDiagram
    FireInspectionReport ||--o{ FireCodeViolation : "documents"
    SprinklerTestReport }o--|| FireInspectionReport : "documents"
    FireInspectionReport ||--|{ FireAlarmTestRecord : "produces"
    FireInspectionReport ||--o{ EgressAnalysis : "contains"
    FireDoorInspection }o--|| FireInspectionReport : "contains"
    FireInspectionReport ||--|{ OccupancyLoadCalculation : "contains"
    FireInspectionReport ||--o{ HazmatStorageAssessment : "contains"
    FireCodeViolation ||--o{ FireAlarmTestRecord : "produces"
```
...
stateDiagram-v2
    [*] --> FireAlarmInspected
    FireAlarmInspected --> SprinklerSystemInspected : sprinklerSystemInspected
    SprinklerSystemInspected --> EgressPathsVerified : egressPathsVerified
    EgressPathsVerified --> FireDoorsInspected : fireDoorsInspected
    FireDoorsInspected --> ExtinguishersChecked : extinguishersChecked
    ExtinguishersChecked --> HazmatStorageAssessed : hazmatStorageAssessed
    HazmatStorageAssessed --> OccupancyLoadCalculated : occupancyLoadCalculated
    OccupancyLoadCalculated --> FireCodeViolationIssued : fireCodeViolationIssued
    ExtinguishersChecked --> NeedsReview : extinguishersChecked
    NeedsReview --> FireDoorsInspected : fireDoorsInspected
    FireCodeViolationIssued --> [*]
```
