...
```mermaid
erDiagram
    SafetyInspectionReport ||--o{ UnsafeCondition : "contains"
    UnsafePractice }o--|| SafetyInspectionReport : "contains"
    SafetyInspectionReport ||--|{ CorrectiveActionItem : "contains"
    SafetyInspectionReport ||--o{ PPEComplianceCheck : "uses"
    MachineGuardAudit }o--|| SafetyInspectionReport : "references"
    SafetyInspectionReport ||--|{ FireSafetyCheck : "contains"
    SafetyInspectionReport ||--o{ IncidentTrendAnalysis : "contains"
    UnsafeCondition ||--o{ CorrectiveActionItem : "contains"
```
...
```mermaid
stateDiagram-v2
    [*] --> SafetyWalkthroughCompleted
    SafetyWalkthroughCompleted --> MachineGuardingVerified : machineGuardingVerified
    MachineGuardingVerified --> PpeComplianceAudited : ppeComplianceAudited
    PpeComplianceAudited --> FireSafetyInspected : fireSafetyInspected
    FireSafetyInspected --> ErgonomicsEvaluated : ergonomicsEvaluated
    ErgonomicsEvaluated --> UnsafeConditionDocumented : unsafeConditionDocumented
    UnsafeConditionDocumented --> CorrectiveActionAssigned : correctiveActionAssigned
    CorrectiveActionAssigned --> CorrectionVerified : correctionVerified
    ErgonomicsEvaluated --> NeedsReview : ergonomicsEvaluated
    NeedsReview --> FireSafetyInspected : fireSafetyInspected
    CorrectionVerified --> [*]
```
