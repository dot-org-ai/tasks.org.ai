...
```mermaid
erDiagram
    WorkOrder ||--o{ TestCase : "contains"
    Defect }o--|| WorkOrder : "contains"
    WorkOrder ||--|{ ReworkRequest : "may have"
    WorkOrder ||--o{ AcceptanceReport : "documents"
    Warranty }o--|| WorkOrder : "may have"
    TestCase ||--o{ ReworkRequest : "may have"
```
...
stateDiagram-v2
    [*] --> InspectionScheduled
    InspectionScheduled --> TestingPerformed : testingPerformed
    TestingPerformed --> DefectDocumented : defectDocumented
    DefectDocumented --> ReworkInitiated : reworkInitiated
    ReworkInitiated --> CorrectionVerified : correctionVerified
    CorrectionVerified --> AcceptanceApproved : acceptanceApproved
    AcceptanceApproved --> WarrantyIssued : warrantyIssued
    ReworkInitiated --> NeedsReview : reworkInitiated
    NeedsReview --> DefectDocumented : defectDocumented
    WarrantyIssued --> [*]
```
