...
```mermaid
erDiagram
    InspectionPlan ||--o{ DimensionalReport : "produces"
    MaterialCert }o--|| InspectionPlan : "contains"
    InspectionPlan ||--|{ NDTResult : "produces"
    InspectionPlan ||--o{ SurfaceFinishReport : "documents"
    AcceptanceCriteria }o--|| InspectionPlan : "contains"
    DimensionalReport ||--o{ NDTResult : "produces"
```
...
```mermaid
stateDiagram-v2
    [*] --> InspectionInitialized
    InspectionInitialized --> DimensionsMeasured : dimensionsMeasured
    DimensionsMeasured --> MaterialTested : materialTested
    MaterialTested --> NdtPerformed : ndtPerformed
    NdtPerformed --> SurfaceFinishAssessed : surfaceFinishAssessed
    SurfaceFinishAssessed --> ResultsDocumented : resultsDocumented
    ResultsDocumented --> AcceptanceIssued : acceptanceIssued
    NdtPerformed --> NeedsReview : ndtPerformed
    NeedsReview --> MaterialTested : materialTested
    AcceptanceIssued --> [*]
```
