...
```mermaid
erDiagram
    Project ||--o{ Specification : "references"
    Deliverable }o--|| Project : "contains"
    Project ||--|{ TestPlan : "contains"
    Project ||--o{ NonCompliance : "references"
    Certificate }o--|| Project : "documents"
    Specification ||--o{ TestPlan : "contains"
```
...
stateDiagram-v2
    ...
    SpecificationsReviewed --> TestPlanDeveloped : testPlanDeveloped
    TestPlanDeveloped --> EvaluationConducted : evaluationConducted
    EvaluationConducted --> TestingRequested : testingRequested
    TestingRequested --> NonComplianceDocumented : nonComplianceDocumented
    NonComplianceDocumented --> CorrectionsApproved : correctionsApproved
    CorrectionsApproved --> CertificateIssued : certificateIssued
    TestingRequested --> NeedsReview : testingRequested
    NeedsReview --> EvaluationConducted : evaluationConducted
    CertificateIssued --> [*]
```
