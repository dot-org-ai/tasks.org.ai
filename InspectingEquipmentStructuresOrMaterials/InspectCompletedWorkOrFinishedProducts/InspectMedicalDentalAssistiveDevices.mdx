...
```mermaid
erDiagram
    MedicalDevice ||--o{ InspectionProtocol : "references"
    ComplianceTest }o--|| MedicalDevice : "contains"
    MedicalDevice ||--|{ SterilizationCycle : "documents"
    MedicalDevice ||--o{ CalibrationRecord : "produces"
    DeviceCertificate }o--|| MedicalDevice : "documents"
    InspectionProtocol ||--o{ SterilizationCycle : "documents"
```
...
```mermaid
stateDiagram-v2
    [*] --> DeviceInspectionScheduled
    DeviceInspectionScheduled --> FunctionalTestPerformed : functionalTestPerformed
    FunctionalTestPerformed --> SterilizationVerified : sterilizationVerified
    SterilizationVerified --> BiocompatibilityChecked : biocompatibilityChecked
    BiocompatibilityChecked --> CalibrationValidated : calibrationValidated
    CalibrationValidated --> ComplianceDocumented : complianceDocumented
    ComplianceDocumented --> DeviceCertified : deviceCertified
    BiocompatibilityChecked --> NeedsReview : biocompatibilityChecked
    NeedsReview --> SterilizationVerified : sterilizationVerified
    DeviceCertified --> [*]
```
