...
```mermaid
erDiagram
    AlignmentPlan ||--o{ ControlDatum : "contains"
    AlignmentMeasurement }o--|| AlignmentPlan : "documents"
    AlignmentPlan ||--|{ ToleranceReport : "references"
    AlignmentPlan ||--o{ AdjustmentRecord : "contains"
    CertificationReport }o--|| AlignmentPlan : "contains"
    ControlDatum ||--o{ ToleranceReport : "references"
```
...
stateDiagram-v2
    [*] --> DatumEstablished
    DatumEstablished --> MeasurementPerformed : measurementPerformed
    MeasurementPerformed --> DeviationAnalyzed : deviationAnalyzed
    DeviationAnalyzed --> PositionAdjusted : positionAdjusted
    PositionAdjusted --> ToleranceVerified : toleranceVerified
    ToleranceVerified --> AlignmentDocumented : alignmentDocumented
    AlignmentDocumented --> ConformanceCertified : conformanceCertified
    PositionAdjusted --> NeedsReview : positionAdjusted
    NeedsReview --> DeviationAnalyzed : deviationAnalyzed
