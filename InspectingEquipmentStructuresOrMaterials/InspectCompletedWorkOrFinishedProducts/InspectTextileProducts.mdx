...
```mermaid
erDiagram
    FabricRoll ||--o{ InspectionReport : "documents"
    DefectClassification }o--|| FabricRoll : "contains"
    FabricRoll ||--|{ ColorStandard : "contains"
    FabricRoll ||--o{ DimensionalSpec : "contains"
    AcceptanceLevel }o--|| FabricRoll : "follows"
    InspectionReport ||--o{ ColorStandard : "contains"
```
...
stateDiagram-v2
    [*] --> FabricInspected
    FabricInspected --> DimensionsMeasured : dimensionsMeasured
    DimensionsMeasured --> ColorMatched : colorMatched
    ColorMatched --> DefectsClassified : defectsClassified
    DefectsClassified --> GarmentInspected : garmentInspected
    GarmentInspected --> AqlCalculated : aqlCalculated
    AqlCalculated --> ShipmentApproved : shipmentApproved
    DefectsClassified --> NeedsReview : defectsClassified
    NeedsReview --> ColorMatched : colorMatched
    ShipmentApproved --> [*]
```
