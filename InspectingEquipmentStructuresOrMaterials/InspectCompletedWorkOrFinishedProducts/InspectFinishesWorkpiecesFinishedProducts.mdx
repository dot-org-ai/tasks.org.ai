...
```mermaid
erDiagram
    Workpiece ||--o{ Finish : "contains"
    Defect }o--|| Workpiece : "contains"
    Workpiece ||--|{ Measurement : "contains"
    Workpiece ||--o{ RefinishOrder : "contains"
    Certificate }o--|| Workpiece : "documents"
    Finish ||--o{ Measurement : "contains"
```
...
stateDiagram-v2
    [*] --> AppearanceInspected
    AppearanceInspected --> ThicknessMeasured : thicknessMeasured
    ThicknessMeasured --> AdhesionTested : adhesionTested
    AdhesionTested --> DurabilityAssessed : durabilityAssessed
    DurabilityAssessed --> DefectDocumented : defectDocumented
    DefectDocumented --> RefinishAuthorized : refinishAuthorized
    RefinishAuthorized --> FinishCertified : finishCertified
    DurabilityAssessed --> NeedsReview : durabilityAssessed
    NeedsReview --> AdhesionTested : adhesionTested
    FinishCertified --> [*]
```
