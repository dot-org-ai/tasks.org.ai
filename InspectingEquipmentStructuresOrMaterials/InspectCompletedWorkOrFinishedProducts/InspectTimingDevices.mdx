...
```mermaid
erDiagram
    TimingDevice ||--o{ RateMeasurement : "documents"
    TemperatureTest }o--|| TimingDevice : "contains"
    TimingDevice ||--|{ CalibrationCertificate : "documents"
    TimingDevice ||--o{ AdjustmentRecord : "contains"
    ComplianceReport }o--|| TimingDevice : "documents"
    RateMeasurement ||--o{ CalibrationCertificate : "documents"
```
...
stateDiagram-v2
    [*] --> InspectionScheduled
    InspectionScheduled --> RateMeasured : rateMeasured
    RateMeasured --> TemperatureTestPerformed : temperatureTestPerformed
    TemperatureTestPerformed --> TimingAdjusted : timingAdjusted
    TimingAdjusted --> TraceabilityVerified : traceabilityVerified
    TraceabilityVerified --> ComplianceDocumented : complianceDocumented
    ComplianceDocumented --> CertificateIssued : certificateIssued
    TimingAdjusted --> NeedsReview : timingAdjusted
    NeedsReview --> TemperatureTestPerformed : temperatureTestPerformed
    CertificateIssued --> [*]
```
