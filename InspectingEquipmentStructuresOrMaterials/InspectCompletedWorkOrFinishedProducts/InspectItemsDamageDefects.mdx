...
```mermaid
erDiagram
    InspectionLot ||--o{ InspectionResult : "documents"
    Defect }o--|| InspectionLot : "documents"
    InspectionLot ||--|{ AcceptanceCriteria : "references"
    InspectionLot ||--o{ DispositionCode : "may have"
    DefectReport }o--|| InspectionLot : "may have"
    InspectionResult ||--o{ AcceptanceCriteria : "references"
```
...
stateDiagram-v2
    ...
    DefectRecorded --> DispositionAssigned : dispositionAssigned
    DispositionAssigned --> InspectionApproved : inspectionApproved
    InspectionApproved --> ReportGenerated : reportGenerated
    ReportGenerated --> DefectEscalated : defectEscalated
    DispositionAssigned --> NeedsReview : dispositionAssigned
