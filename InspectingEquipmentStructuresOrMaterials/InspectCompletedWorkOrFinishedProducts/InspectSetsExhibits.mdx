...
```mermaid
erDiagram
    SetExhibit ||--o{ InspectionChecklist : "references"
    StructuralAssessment }o--|| SetExhibit : "contains"
    SetExhibit ||--|{ AccessibilityReport : "documents"
    SetExhibit ||--o{ MaintenanceLog : "documents"
    SafetyCertificate }o--|| SetExhibit : "contains"
    InspectionChecklist ||--o{ AccessibilityReport : "documents"
```
...
stateDiagram-v2
    [*] --> InspectionScheduled
    InspectionScheduled --> StructureAssessed : structureAssessed
    StructureAssessed --> FireSafetyChecked : fireSafetyChecked
    FireSafetyChecked --> AccessibilityVerified : accessibilityVerified
    AccessibilityVerified --> FinishEvaluated : finishEvaluated
    FinishEvaluated --> FindingsDocumented : findingsDocumented
    FindingsDocumented --> CertificateIssued : certificateIssued
    AccessibilityVerified --> NeedsReview : accessibilityVerified
    NeedsReview --> FireSafetyChecked : fireSafetyChecked
    CertificateIssued --> [*]
```
