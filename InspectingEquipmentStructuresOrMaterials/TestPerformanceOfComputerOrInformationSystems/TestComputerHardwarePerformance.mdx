...
```mermaid
erDiagram
    HardwareAsset ||--o{ BenchmarkTest : "references"
    PerformanceMetrics }o--|| HardwareAsset : "contains"
    HardwareAsset ||--|{ StressTest : "may have"
    HardwareAsset ||--o{ BaselineRecord : "contains"
    DegradationAlert }o--|| HardwareAsset : "contains"
    BenchmarkTest ||--o{ StressTest : "may have"
```
...
stateDiagram-v2
    [*] --> BenchmarksDefined
    BenchmarksDefined --> CpuTestExecuted : cpuTestExecuted
    CpuTestExecuted --> MemoryThroughputTested : memoryThroughputTested
    MemoryThroughputTested --> StorageIomeasured : storageIOMeasured
    StorageIomeasured --> StressTestRun : stressTestRun
    StressTestRun --> PerformanceAnalyzed : performanceAnalyzed
    PerformanceAnalyzed --> ReportIssued : reportIssued
    StorageIomeasured --> NeedsReview : storageIOMeasured
    NeedsReview --> MemoryThroughputTested : memoryThroughputTested
    ReportIssued --> [*]
```
