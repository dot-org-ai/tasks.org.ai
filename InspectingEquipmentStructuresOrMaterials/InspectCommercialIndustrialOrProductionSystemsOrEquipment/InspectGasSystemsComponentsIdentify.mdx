...
```mermaid
erDiagram
    GasSystem ||--o{ LeakSurvey : "contains"
    LeakReport }o--|| GasSystem : "documents"
    GasSystem ||--|{ PressureTest : "contains"
    GasSystem ||--o{ HazardClassification : "contains"
    RemediationRecord }o--|| GasSystem : "documents"
    LeakSurvey ||--o{ PressureTest : "contains"
```
...
stateDiagram-v2
    [*] --> LeakSurveyCompleted
    LeakSurveyCompleted --> LeakDetected : leakDetected
    LeakDetected --> HazardClassified : hazardClassified
    HazardClassified --> PressureTestPassed : pressureTestPassed
    PressureTestPassed --> PressureTestFailed : pressureTestFailed
    PressureTestFailed --> ShutoffOrdered : shutoffOrdered
    ShutoffOrdered --> RemediationVerified : remediationVerified
    PressureTestPassed --> NeedsReview : pressureTestPassed
    NeedsReview --> HazardClassified : hazardClassified
    RemediationVerified --> [*]
```
