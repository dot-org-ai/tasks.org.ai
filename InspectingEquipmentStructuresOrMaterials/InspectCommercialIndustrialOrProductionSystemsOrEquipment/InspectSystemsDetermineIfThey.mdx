...
```mermaid
erDiagram
    System ||--o{ PerformanceBaseline : "contains"
    DiagnosticTest }o--|| System : "contains"
    System ||--|{ Anomaly : "contains"
    System ||--o{ AlarmLog : "documents"
    CorrectiveAction }o--|| System : "follows"
    PerformanceBaseline ||--o{ Anomaly : "contains"
```
...
stateDiagram-v2
    [*] --> BaselineCompared
    BaselineCompared --> DiagnosticCompleted : diagnosticCompleted
    DiagnosticCompleted --> AnomalyIdentified : anomalyIdentified
    AnomalyIdentified --> AlarmTriggered : alarmTriggered
    AlarmTriggered --> CorrectiveActionInitiated : correctiveActionInitiated
    CorrectiveActionInitiated --> ResolutionVerified : resolutionVerified
    ResolutionVerified --> SystemOperatingNormally : systemOperatingNormally
    AlarmTriggered --> NeedsReview : alarmTriggered
    NeedsReview --> AnomalyIdentified : anomalyIdentified
