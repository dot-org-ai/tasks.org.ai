...
```mermaid
erDiagram
    PlumbingSystem ||--o{ Fixture : "contains"
    PipeSegment }o--|| PlumbingSystem : "contains"
    PlumbingSystem ||--|{ PressureTestResult : "documents"
    PlumbingSystem ||--o{ LeakDetection : "documents"
    BackflowDevice }o--|| PlumbingSystem : "contains"
    PlumbingSystem ||--|{ InspectionReport : "documents"
    Fixture ||--o{ PressureTestResult : "documents"
```
...
stateDiagram-v2
    [*] --> InspectionInitiated
    InspectionInitiated --> SupplyLinesInspected : supplyLinesInspected
    SupplyLinesInspected --> DrainSystemInspected : drainSystemInspected
    DrainSystemInspected --> PressureTestCompleted : pressureTestCompleted
    PressureTestCompleted --> PressureTestFailed : pressureTestFailed
    PressureTestFailed --> BackflowDeviceTested : backflowDeviceTested
    BackflowDeviceTested --> CodeViolationDocumented : codeViolationDocumented
    CodeViolationDocumented --> InspectionResultIssued : inspectionResultIssued
    PressureTestFailed --> NeedsReview : pressureTestFailed
    NeedsReview --> PressureTestCompleted : pressureTestCompleted
    InspectionResultIssued --> [*]
```
