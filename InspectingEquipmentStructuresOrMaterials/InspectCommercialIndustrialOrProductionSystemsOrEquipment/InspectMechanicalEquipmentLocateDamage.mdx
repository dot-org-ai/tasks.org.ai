...
```mermaid
erDiagram
    MechanicalComponent ||--o{ WearMeasurement : "documents"
    VibrationReading }o--|| MechanicalComponent : "contains"
    MechanicalComponent ||--|{ OilAnalysisReport : "produces"
    MechanicalComponent ||--o{ DamageClassification : "contains"
    ComponentLifeEstimate }o--|| MechanicalComponent : "contains"
    MechanicalComponent ||--|{ InspectionWorkOrder : "uses"
    WearMeasurement ||--o{ OilAnalysisReport : "produces"
```
...
stateDiagram-v2
    [*] --> InspectionInitiated
    InspectionInitiated --> VisualExaminationCompleted : visualExaminationCompleted
    VisualExaminationCompleted --> ComponentMeasured : componentMeasured
    ComponentMeasured --> WearLimitExceeded : wearLimitExceeded
    WearLimitExceeded --> VibrationAnomalyDetected : vibrationAnomalyDetected
    VibrationAnomalyDetected --> OilAnalysisReviewed : oilAnalysisReviewed
    OilAnalysisReviewed --> DamageClassified : damageClassified
    DamageClassified --> InspectionReportGenerated : inspectionReportGenerated
    VibrationAnomalyDetected --> NeedsReview : vibrationAnomalyDetected
    NeedsReview --> WearLimitExceeded : wearLimitExceeded
