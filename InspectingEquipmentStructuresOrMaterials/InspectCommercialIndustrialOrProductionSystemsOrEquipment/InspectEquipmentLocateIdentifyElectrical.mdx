...
```mermaid
erDiagram
    EquipmentAsset ||--o{ FaultSymptom : "contains"
    DiagnosticReading }o--|| EquipmentAsset : "contains"
    EquipmentAsset ||--|{ FaultIsolationReport : "documents"
    EquipmentAsset ||--o{ WiringSchematic : "contains"
    WorkOrder }o--|| EquipmentAsset : "contains"
    EquipmentAsset ||--|{ RepairRecommendation : "produces"
    FaultSymptom ||--o{ FaultIsolationReport : "documents"
```
...
stateDiagram-v2
    [*] --> FaultSymptomLogged
    FaultSymptomLogged --> SchematicReviewed : schematicReviewed
    SchematicReviewed --> DiagnosticTestPerformed : diagnosticTestPerformed
    DiagnosticTestPerformed --> FaultIsolated : faultIsolated
    FaultIsolated --> WaveformAnalyzed : waveformAnalyzed
    WaveformAnalyzed --> RootCauseIdentified : rootCauseIdentified
    RootCauseIdentified --> DiagnosisDocumented : diagnosisDocumented
    DiagnosisDocumented --> RepairRecommended : repairRecommended
    WaveformAnalyzed --> NeedsReview : waveformAnalyzed
    NeedsReview --> FaultIsolated : faultIsolated
    RepairRecommended --> [*]
```
