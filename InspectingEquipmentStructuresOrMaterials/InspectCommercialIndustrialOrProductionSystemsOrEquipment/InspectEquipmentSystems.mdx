...
```mermaid
erDiagram
    Equipment ||--o{ System : "contains"
    InspectionRecord }o--|| Equipment : "documents"
    Equipment ||--|{ Checklist : "evaluated by"
    Equipment ||--o{ Finding : "may have"
    ComplianceStatus }o--|| Equipment : "uses"
    System ||--o{ Checklist : "evaluated by"
```
...
stateDiagram-v2
    [*] --> InspectionPlanned
    InspectionPlanned --> InspectionExecuted : inspectionExecuted
    InspectionExecuted --> FindingRecorded : findingRecorded
    FindingRecorded --> SeverityClassified : severityClassified
    SeverityClassified --> ComplianceVerified : complianceVerified
    ComplianceVerified --> ReportIssued : reportIssued
    ReportIssued --> FollowUpScheduled : followUpScheduled
    SeverityClassified --> NeedsReview : severityClassified
    NeedsReview --> FindingRecorded : findingRecorded
    FollowUpScheduled --> [*]
```
