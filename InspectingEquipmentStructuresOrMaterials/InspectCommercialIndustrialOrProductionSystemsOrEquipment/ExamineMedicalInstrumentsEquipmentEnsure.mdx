...
```mermaid
erDiagram
    MedicalDevice ||--o{ InspectionRecord : "documents"
    CalibrationCertificate }o--|| MedicalDevice : "documents"
    MedicalDevice ||--|{ MaintenanceSchedule : "follows"
    MedicalDevice ||--o{ DeficiencyReport : "documents"
    ServiceManual }o--|| MedicalDevice : "documents"
    MedicalDevice ||--|{ ComplianceChecklist : "references"
    InspectionRecord ||--o{ MaintenanceSchedule : "follows"
```
...
stateDiagram-v2
    [*] --> InspectionScheduled
    InspectionScheduled --> VisualExaminationCompleted : visualExaminationCompleted
    VisualExaminationCompleted --> FunctionalTestPassed : functionalTestPassed
    FunctionalTestPassed --> FunctionalTestFailed : functionalTestFailed
    FunctionalTestFailed --> CalibrationVerified : calibrationVerified
    CalibrationVerified --> DeficiencyFlagged : deficiencyFlagged
    DeficiencyFlagged --> DeviceClearedForService : deviceClearedForService
    DeviceClearedForService --> ComplianceReportGenerated : complianceReportGenerated
    CalibrationVerified --> NeedsReview : calibrationVerified
    NeedsReview --> FunctionalTestFailed : functionalTestFailed
