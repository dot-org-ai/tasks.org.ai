...
```mermaid
erDiagram
    EquipmentAsset ||--o{ InspectionChecklist : "uses"
    InspectionResult }o--|| EquipmentAsset : "evaluated by"
    EquipmentAsset ||--|{ ConditionReport : "uses"
    EquipmentAsset ||--o{ MaintenanceSchedule : "follows"
    AdjustmentRecord }o--|| EquipmentAsset : "documents"
    EquipmentAsset ||--|{ ReadinessCertification : "uses"
    InspectionChecklist ||--o{ ConditionReport : "uses"
```
...
stateDiagram-v2
    [*] --> InspectionScheduled
    InspectionScheduled --> ChecklistExecuted : checklistExecuted
    ChecklistExecuted --> OperatingParametersMeasured : operatingParametersMeasured
    OperatingParametersMeasured --> OperationalTestCompleted : operationalTestCompleted
    OperationalTestCompleted --> AdjustmentRecorded : adjustmentRecorded
    AdjustmentRecorded --> ConditionAssessed : conditionAssessed
    ConditionAssessed --> ReadinessCertified : readinessCertified
    ReadinessCertified --> MaintenanceEscalated : maintenanceEscalated
    AdjustmentRecorded --> NeedsReview : adjustmentRecorded
    NeedsReview --> OperationalTestCompleted : operationalTestCompleted
