...
```mermaid
erDiagram
    ScreeningOrder ||--|| AssessmentInstrument : "uses"
    ScreeningOrder ||--|| TestSession : "uses"
    ScreeningOrder ||--|| ScoreReport : "uses"
    ScreeningOrder ||--|| ClinicalInterpretation : "uses"
    ScreeningOrder ||--|| CarePlanRecommendation : "uses"
```
