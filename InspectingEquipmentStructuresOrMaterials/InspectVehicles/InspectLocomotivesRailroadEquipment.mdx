...
```mermaid
erDiagram
    InspectionForm ||--o{ DefectCard : "uses"
    AirBrakeTest }o--|| InspectionForm : "documents"
    InspectionForm ||--|{ WheelMeasurement : "documents"
    InspectionForm ||--o{ CouplerAssessment : "contains"
    LocomotiveLog }o--|| InspectionForm : "documents"
    InspectionForm ||--|{ ComplianceRecord : "documents"
    InspectionForm ||--o{ BadOrderTag : "uses"
    DefectCard ||--o{ WheelMeasurement : "documents"
```
...
stateDiagram-v2
    ...
    PreDepartureCompleted --> BrakeSystemInspected : brakeSystemInspected
    BrakeSystemInspected --> WheelsExamined : wheelsExamined
    WheelsExamined --> CouplerInspected : couplerInspected
    CouplerInspected --> ElectricalChecked : electricalChecked
    ElectricalChecked --> SafetyAppliancesVerified : safetyAppliancesVerified
    SafetyAppliancesVerified --> EquipmentTagged : equipmentTagged
    EquipmentTagged --> ComplianceDocumented : complianceDocumented
    ElectricalChecked --> NeedsReview : electricalChecked
    NeedsReview --> CouplerInspected : couplerInspected
    ComplianceDocumented --> [*]
```
