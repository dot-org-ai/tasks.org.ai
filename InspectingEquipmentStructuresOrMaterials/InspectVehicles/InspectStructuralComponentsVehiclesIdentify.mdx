...
```mermaid
erDiagram
    FrameMeasurement ||--o{ CorrosionAssessment : "contains"
    DamageProfile }o--|| FrameMeasurement : "contains"
    FrameMeasurement ||--|{ StructuralRepairPlan : "documents"
    FrameMeasurement ||--o{ WeldInspection : "contains"
    DimensionalSpecification }o--|| FrameMeasurement : "contains"
    FrameMeasurement ||--|{ LoadTestResult : "contains"
    FrameMeasurement ||--o{ ComplianceDecal : "contains"
    CorrosionAssessment ||--o{ StructuralRepairPlan : "documents"
```
...
stateDiagram-v2
    [*] --> FrameMeasured
    FrameMeasured --> CorrosionAssessed : corrosionAssessed
    CorrosionAssessed --> CrackingIdentified : crackingIdentified
    CrackingIdentified --> CollisionDamageEvaluated : collisionDamageEvaluated
    CollisionDamageEvaluated --> MountingPointsInspected : mountingPointsInspected
    MountingPointsInspected --> WeldIntegrityTested : weldIntegrityTested
    WeldIntegrityTested --> DamageProfileDocumented : damageProfileDocumented
    DamageProfileDocumented --> RepairRecommended : repairRecommended
    MountingPointsInspected --> NeedsReview : mountingPointsInspected
    NeedsReview --> CollisionDamageEvaluated : collisionDamageEvaluated
    RepairRecommended --> [*]
```
