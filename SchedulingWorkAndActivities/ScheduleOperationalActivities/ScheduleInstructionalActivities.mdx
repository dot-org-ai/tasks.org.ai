...
erDiagram
    ...
    Session ||--|| Room : occupies
    Session }o--|| Timetable : appears_in
    Session ||--o{ Enrollment : accepts
    Timetable ||--o{ ConflictRecord : detects
...
stateDiagram-v2
    [*] --> Created
    Created --> Assigned : instructorAssigned
    Assigned --> Reserved : roomReserved
    Reserved --> Checked : conflictDetected
    Checked --> Rescheduled : sessionRescheduled
    Rescheduled --> Reserved : roomReserved
    Reserved --> Published : timetablePublished
    Published --> Active : timetablePublished
    Active --> Rescheduled : sessionRescheduled
