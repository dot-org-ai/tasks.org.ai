...
```mermaid
erDiagram
    LearningModule ||--o{ MediaAsset : contains
    LearningModule ||--o{ CoursePackage : contains
    LearningModule ||--o{ LearningObjective : contains
    LearningModule ||--o{ StoryboardDocument : contains
    Assessment ||--o{ CoursePackage : contains
    Assessment ||--o{ LearningObjective : contains
```
...
stateDiagram-v2
    [*] --> Start
    Start --> CurriculumDesign : curriculumDesigned
    CurriculumDesign --> ModuleAuthor : moduleAuthored
    ModuleAuthor --> MediaAssetProduc : mediaAssetProduced
    MediaAssetProduc --> AssessmentBuilt : assessmentBuilt
    AssessmentBuilt --> ContentReview : contentReviewed
    ContentReview --> CoursePackag : coursePackaged
    CoursePackag --> CoursePublish : coursePublished
    CoursePublish --> [*]
```
