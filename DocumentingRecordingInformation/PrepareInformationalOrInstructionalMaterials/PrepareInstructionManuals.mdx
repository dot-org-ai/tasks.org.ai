...
```mermaid
erDiagram
    Manual ||--o{ Revision : contains
    Manual ||--o{ Template : contains
    Manual ||--o{ Illustration : contains
    Manual ||--o{ Glossary : contains
    Manual ||--o{ SafetyWarning : contains
    Section ||--o{ Template : contains
```
...
stateDiagram-v2
    [*] --> Start
    Start --> ManualCreat : manualCreated
    ManualCreat --> SectionDraft : sectionDrafted
    SectionDraft --> ContentReview : contentReviewed
    ContentReview --> ManualApprov : manualApproved
    ManualApprov --> ManualPublish : manualPublished
    ManualPublish --> ManualRevis : manualRevised
    ManualRevis --> ManualArchiv : manualArchived
    ManualArchiv --> [*]
```
