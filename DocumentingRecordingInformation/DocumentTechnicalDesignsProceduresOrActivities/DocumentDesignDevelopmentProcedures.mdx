...
```mermaid
erDiagram
    ProcedureDocument ||--o{ ApprovalGate : contains
    ProcedureDocument ||--o{ ProcedureTemplate : contains
    ProcedureDocument ||--o{ ComplianceMapping : contains
    ProcedureDocument ||--o{ ProcedureRevision : contains
    ProcessStep ||--o{ ProcedureTemplate : contains
    ProcessStep ||--o{ ComplianceMapping : contains
```
...
stateDiagram-v2
    [*] --> Start
    Start --> ProcedureDraft : procedureDrafted
    ProcedureDraft --> ProcessStepsDefin : processStepsDefined
    ProcessStepsDefin --> ApprovalGatesEstablish : approvalGatesEstablished
    ApprovalGatesEstablish --> ComplianceRequirementsMapp : complianceRequirementsMapped
    ComplianceRequirementsMapp --> ProcedureSubmittedForReview : procedureSubmittedForReview
    ProcedureSubmittedForReview --> ProcedurePublish : procedurePublished
    ProcedurePublish --> ProcedureRevis : procedureRevised
    ProcedureRevis --> [*]
```
