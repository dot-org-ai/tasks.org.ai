...
```mermaid
erDiagram
    ComplianceReport ||--o{ Finding : "documents"
    Finding ||--o{ CorrectiveAction : "requires"
    ComplianceReport ||--o{ ComplianceMetric : "measures"
    ComplianceReport ||--o{ AuditWorkpaper : "supported-by"
    ComplianceReport ||--o| SubmissionRecord : "tracked-by"
    Regulation ||--o{ ComplianceReport : "governs"
    CorrectiveAction }o--|| Finding : "addresses"
```
...
stateDiagram-v2
    [*] --> DataCollection
    DataCollection --> Analysis : dataGathered
    Analysis --> Drafting : findingsAnalyzed
    Drafting --> RemediationPlanning : reportDrafted
    RemediationPlanning --> InternalReview : correctiveActionsDocumented
    RemediationPlanning --> InternalReview
    InternalReview --> RevisionRequired : reportReviewed
    RevisionRequired --> Drafting
    InternalReview --> Submitted : reportSubmitted
    Submitted --> Remediation : remediationCompleted
