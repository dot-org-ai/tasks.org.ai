...
```mermaid
erDiagram
    Report ||--o{ ReportDraft : "versioned-as"
    Report ||--|| ReportTemplate : "based-on"
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> Compilation : reportInitialized
    Compilation --> Drafting : findingsCompiled
    Drafting --> Review : reportDrafted
    Review --> Revision : reportSubmittedForReview
    Revision --> Drafting
    Review --> Finalization : reportSubmittedForReview
    Finalization --> Published : reportFinalized
    Published --> [*]
```
