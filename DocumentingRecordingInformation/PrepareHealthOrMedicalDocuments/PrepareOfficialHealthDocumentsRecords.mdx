...
```mermaid
erDiagram
    BirthCertificate ||--o{ ImmunizationRecord : tracks
    BirthCertificate ||--o{ CommunicableDiseaseReport : contains
    BirthCertificate ||--o{ HealthClearance : contains
    BirthCertificate ||--o{ VitalStatisticsRecord : tracks
    DeathCertificate ||--o{ ImmunizationRecord : tracks
    DeathCertificate ||--o{ CommunicableDiseaseReport : contains
```
...
stateDiagram-v2
    [*] --> Start
    Start --> DocumentCreat : documentCreated
    DocumentCreat --> DocumentCertifi : documentCertified
    DocumentCertifi --> DocumentFil : documentFiled
    DocumentFil --> ImmunizationRecordIssu : immunizationRecordIssued
    ImmunizationRecordIssu --> CommunicableDiseaseReport : communicableDiseaseReported
    CommunicableDiseaseReport --> HealthClearanceIssu : healthClearanceIssued
    HealthClearanceIssu --> DocumentAmen : documentAmended
    DocumentAmen --> [*]
```
