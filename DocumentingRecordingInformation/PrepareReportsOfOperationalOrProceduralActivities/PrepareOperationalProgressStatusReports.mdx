...
erDiagram
    ...
    StatusReport ||--o{ ProgressMetric : "measures"
    StatusReport ||--o{ Blocker : "identifies"
    StatusReport ||--o{ RiskItem : "assesses"
    StatusReport ||--o{ ActionItem : "assigns"
    StatusReport ||--|| Scorecard : "visualized-by"
    Blocker ||--o{ ActionItem : "generates"
```
...
stateDiagram-v2
    [*] --> DataGathering
    DataGathering --> Assessment : statusUpdatesCollected
    Assessment --> Analysis : milestonesAssessed
    Analysis --> IssueIdentification : blockersIdentified
    IssueIdentification --> RiskEvaluation : risksAssessed
    RiskEvaluation --> Escalation : issueEscalated
    RiskEvaluation --> Compilation : statusReportCompiled
    Escalation --> Compilation
    Compilation --> Visualization : scorecardGenerated
    Visualization --> Distributed : reportDistributed
    Distributed --> [*]
```
