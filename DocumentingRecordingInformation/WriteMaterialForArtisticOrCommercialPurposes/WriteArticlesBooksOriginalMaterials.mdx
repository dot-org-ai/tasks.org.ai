...
```mermaid
erDiagram
    Manuscript ||--o{ Article : "contains"
    Article }o--|| BookChapter : "tracks"
    BookChapter ||--o{ Outline : "references"
    Outline }o--|| Bibliography : "generates"
    Bibliography ||--o{ DraftRevision : "validates"
    DraftRevision }o--|| PublicationContract : "supports"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : researchCompleted
    InProgress --> InProgress : outlineCreated
    InProgress --> InProgress : draftCompleted
    InProgress --> Review : draftRevised
    Review --> InProgress
    InProgress --> InProgress : reviewSubmitted
    InProgress --> InProgress : feedbackIncorporated
    InProgress --> Completed : manuscriptFinalized
    Completed --> [*]
```
## Workflow
