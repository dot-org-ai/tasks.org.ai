...
```mermaid
erDiagram
    Script ||--o{ Screenplay : "contains"
    Screenplay }o--|| Treatment : "tracks"
    Treatment ||--o{ StoryOutline : "references"
    StoryOutline }o--|| DialogueDraft : "generates"
    DialogueDraft ||--o{ RevisionNote : "validates"
    RevisionNote }o--|| ProductionDraft : "supports"
```
...
stateDiagram-v2
    [*] --> Initialized
    Initialized --> InProgress : conceptDeveloped
    InProgress --> InProgress : treatmentWritten
    InProgress --> InProgress : storyOutlined
    InProgress --> Review : scriptDrafted
    Review --> InProgress
    InProgress --> InProgress : notesReceived
    InProgress --> InProgress : scriptRevised
    InProgress --> Completed : dialoguePolished
    Completed --> [*]
```
## Workflow
