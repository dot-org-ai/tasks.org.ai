...
```mermaid
erDiagram
    ResearchProject ||--o{ Milestone : "structured by"
    InternshipAgreement ||--|| ResearchProject : "governs"
    Milestone ||--o{ Deliverable : "requires"
    Deliverable ||--o{ EvaluationRubric : "scored by"
    ResearchProject ||--o{ ProgressReport : "tracked in"
    Milestone ||--o{ ProgressReport : "reported in"
```
...
stateDiagram-v2
    [*] --> ProjectDefined
    ProjectDefined --> MentorPaired : mentorAssigned
    MentorPaired --> MilestoneSet : milestoneReached
    MilestoneSet --> UnderReview : deliverableReviewed
    UnderReview --> GuidanceNeeded : guidanceProvided
    GuidanceNeeded --> UnderReview : deliverableReviewed
    UnderReview --> Evaluated : performanceEvaluated
    Evaluated --> MilestoneSet : milestoneReached
