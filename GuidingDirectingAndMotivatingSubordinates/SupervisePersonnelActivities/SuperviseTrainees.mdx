...
```mermaid
erDiagram
    Trainee ||--|| Mentor : follows
    Trainee }o--|| TrainingOrganization : generates
    Trainee ||--|{ DepartmentManager : requires
    Trainee ||--o{ HumanResources : tracks
    Mentor ||--|{ Trainee : creates
    TrainingOrganization ||--o{ Trainee : documents
    DepartmentManager ||--|| Trainee : supports
```
...
stateDiagram-v2
    ...
    Mentor --> Training_Organization: TrainingOrganization
    Training_Organization --> Department_Manager: DepartmentManager
    Department_Manager --> Human_Resources: HumanResources
    Training_Organization --> Mentor: TrainingOrganization
    Human_Resources --> [*]
```
