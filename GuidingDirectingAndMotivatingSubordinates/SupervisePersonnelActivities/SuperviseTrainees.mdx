...
```mermaid
erDiagram
    TrainingPlan ||--o{ Milestone : "structured by"
    Milestone ||--o{ Assessment : "evaluated at"
    TrainingPlan ||--o{ Competency : "develops"
    Competency ||--o{ Assessment : "measured by"
    MentorAssignment ||--|| TrainingPlan : "supports"
    TrainingRecord ||--o{ Assessment : "documents"
```
...
stateDiagram-v2
    [*] --> Enrolled
    Enrolled --> MentorPaired : mentorAssigned
    MentorPaired --> MilestoneReached : milestoneReached
    MilestoneReached --> Assessed : competencyAssessed
    Assessed --> FeedbackGiven : feedbackProvided
    FeedbackGiven --> MilestoneReached : milestoneReached
    Assessed --> Advanced : traineeAdvanced
    Advanced --> MilestoneReached : milestoneReached
    Advanced --> Completed : trainingCompleted
    Completed --> [*]
```
