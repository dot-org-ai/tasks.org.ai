...
```mermaid
erDiagram
    SustainabilityWorker ||--|| EnvironmentalAgency : follows
    SustainabilityWorker }o--|| CertificationBody : generates
    SustainabilityWorker ||--|{ CommunityStakeholder : requires
    SustainabilityWorker ||--o{ MaterialSupplier : tracks
    SustainabilityWorker ||--|| ProjectOwner : validates
    EnvironmentalAgency ||--|{ SustainabilityWorker : creates
    CertificationBody ||--o{ SustainabilityWorker : documents
    CommunityStakeholder ||--|| SustainabilityWorker : supports
```
...
stateDiagram-v2
    ...
    Sustainability_Worker --> Environmental_Agency: EnvironmentalAgency
    Environmental_Agency --> Certification_Body: CertificationBody
    Certification_Body --> Community_Stakeholder: CommunityStakeholder
    Community_Stakeholder --> Material_Supplier: MaterialSupplier
    Material_Supplier --> Project_Owner: ProjectOwner
    Community_Stakeholder --> Environmental_Agency: CertificationBody
    Project_Owner --> [*]
```
