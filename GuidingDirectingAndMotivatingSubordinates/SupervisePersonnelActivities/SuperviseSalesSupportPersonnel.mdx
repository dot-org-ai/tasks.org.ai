...
```mermaid
erDiagram
    SalesRepresentative ||--|| SupportAgent : follows
    SalesRepresentative }o--|| Customer : generates
    SalesRepresentative ||--|{ MarketingTeam : requires
    SalesRepresentative ||--o{ ProductTeam : tracks
    SupportAgent ||--|{ SalesRepresentative : creates
    Customer ||--o{ SalesRepresentative : documents
    MarketingTeam ||--|| SalesRepresentative : supports
```
...
stateDiagram-v2
    ...
    Sales_Representative --> Support_Agent: SupportAgent
    Support_Agent --> Customer: Customer
    Customer --> Marketing_Team: MarketingTeam
    Marketing_Team --> Product_Team: ProductTeam
    Customer --> Support_Agent: Customer
    Product_Team --> [*]
```
