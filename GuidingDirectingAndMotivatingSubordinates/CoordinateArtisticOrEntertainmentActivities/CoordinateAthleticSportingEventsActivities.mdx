...
```mermaid
erDiagram
    GoverningBody ||--o{ Sponsor : includes
    Sponsor }o--|| BroadcastPartner : "relates to"
    Sponsor }o--|| VenueOperator : "relates to"
    Sponsor }o--|| MedicalStaff : "relates to"
    Sponsor }o--|| OfficialAssigningAuthority : "relates to"
    BroadcastPartner }o--|| VenueOperator : "relates to"
    BroadcastPartner }o--|| MedicalStaff : "relates to"
    BroadcastPartner }o--|| OfficialAssigningAuthority : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> GoverningBody: GoverningBody
    GoverningBody --> Sponsor: Sponsor
    Sponsor --> BroadcastPartner: BroadcastPartner
    BroadcastPartner --> ValidationCheck: needs review
    ValidationCheck --> Sponsor: corrections needed
    ValidationCheck --> VenueOperator: approved
    ValidationCheck --> VenueOperator: VenueOperator
    VenueOperator --> MedicalStaff: MedicalStaff
    MedicalStaff --> OfficialAssigningAuthority: OfficialAssigningAuthority
    OfficialAssigningAuthority --> [*]
```
