...
```mermaid
erDiagram
    Production ||--o{ CastList : casts
    Production ||--o{ RehearsalSchedule : schedules
    Production ||--o{ TechnicalCueSheet : sequences
    Production ||--o{ ProductionBudget : funds
    Production ||--o{ PerformanceRun : stages
    CastList ||--o{ BlockingNotes : documents
```
...
stateDiagram-v2
    [*] --> ProductionCast
    ProductionCast --> DesignApproved : designApproved
    DesignApproved --> RehearsalCompleted : rehearsalCompleted
    RehearsalCompleted --> TechnicalCuesBuilt : technicalCuesBuilt
    TechnicalCuesBuilt --> PerformanceRunScheduled : performanceRunScheduled
    PerformanceRunScheduled --> OpeningNightCompleted : openingNightCompleted
    OpeningNightCompleted --> ProductionClosed : productionClosed
    RehearsalCompleted --> DesignApproved : rehearsalCompleted
    ProductionClosed --> [*]
```
