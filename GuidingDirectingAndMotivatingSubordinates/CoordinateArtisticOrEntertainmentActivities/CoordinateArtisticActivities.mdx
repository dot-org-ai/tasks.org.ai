...
```mermaid
erDiagram
    Artist }o--|| GalleryOwner : "relates to"
    Artist }o--|| ArtCollector : "relates to"
    Artist ||--o{ GrantFoundation : contains
    Artist }o--|| PublicArtsCommission : "relates to"
    Artist }o--|| ArtShipper : "relates to"
    GalleryOwner }o--|| ArtCollector : "relates to"
    GalleryOwner }o--|| GrantFoundation : "relates to"
    GalleryOwner }o--|| PublicArtsCommission : "relates to"
    GalleryOwner }o--|| ArtShipper : "relates to"
    ArtCollector }o--|| GrantFoundation : "relates to"
    ArtCollector }o--|| PublicArtsCommission : "relates to"
    ArtCollector }o--|| ArtShipper : "relates to"
    GrantFoundation }o--|| PublicArtsCommission : "relates to"
    GrantFoundation }o--|| ArtShipper : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Artist: Artist
    Artist --> GalleryOwner: GalleryOwner
    GalleryOwner --> ArtCollector: ArtCollector
    ArtCollector --> ValidationCheck: needs review
    ValidationCheck --> GalleryOwner: corrections needed
    ValidationCheck --> GrantFoundation: approved
    ValidationCheck --> GrantFoundation: GrantFoundation
    GrantFoundation --> PublicArtsCommission: PublicArtsCommission
    PublicArtsCommission --> ArtShipper: ArtShipper
    ArtShipper --> [*]
```
