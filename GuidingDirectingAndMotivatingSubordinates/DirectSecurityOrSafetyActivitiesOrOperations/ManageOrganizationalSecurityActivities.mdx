...
```mermaid
erDiagram
    LawEnforcement ||--o{ SecurityVendor : includes
    SecurityVendor ||--o{ CyberThreatIntelligence : includes
    CyberThreatIntelligence }o--|| InsuranceProvider : "relates to"
    CyberThreatIntelligence }o--|| RegulatoryBody : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> LawEnforcement: LawEnforcement
    LawEnforcement --> SecurityVendor: SecurityVendor
    SecurityVendor --> CyberThreatIntelligence: CyberThreatIntelligence
    CyberThreatIntelligence --> ValidationCheck: needs review
    ValidationCheck --> SecurityVendor: corrections needed
    ValidationCheck --> InsuranceProvider: approved
    ValidationCheck --> InsuranceProvider: InsuranceProvider
    InsuranceProvider --> RegulatoryBody: RegulatoryBody
    RegulatoryBody --> [*]
```
