...
```mermaid
erDiagram
    EmergencyPlan ||--o{ IncidentAction : "activates"
    IncidentAction ||--o{ EvacuationOrder : "issues"
    IncidentAction ||--o{ ResourceDeployment : "dispatches"
    ResourceDeployment ||--|| ShelterOperation : "supports"
    MutualAidAgreement ||--o{ ResourceDeployment : "provisions"
    IncidentAction ||--|| AfterActionReport : "produces"
```
...
stateDiagram-v2
    [*] --> PlanDeveloped
    PlanDeveloped --> ResponseActivated : responseActivated
    ResponseActivated --> MultiAgencyCoordinated : multiAgencyCoordinated
    MultiAgencyCoordinated --> EvacuationIssued : evacuationOrderIssued
    EvacuationIssued --> ResourcesDeployed : resourcesDeployed
    ResourcesDeployed --> RecoveryInitiated : recoveryInitiated
    RecoveryInitiated --> AfterActionCompleted : afterActionCompleted
    AfterActionCompleted --> PlanDeveloped : emergencyPlanDeveloped
