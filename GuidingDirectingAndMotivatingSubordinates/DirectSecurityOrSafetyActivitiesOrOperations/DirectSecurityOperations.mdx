...
```mermaid
erDiagram
    Client }o--|| LawEnforcement : "relates to"
    Client }o--|| AlarmMonitoringService : "relates to"
    Client }o--|| SecurityEquipmentVendor : "relates to"
    Client }o--|| InsuranceUnderwriter : "relates to"
    LawEnforcement ||--o{ AlarmMonitoringService : includes
    AlarmMonitoringService ||--o{ SecurityEquipmentVendor : includes
    SecurityEquipmentVendor }o--|| InsuranceUnderwriter : "relates to"
```
...
stateDiagram-v2
    ...
    Client --> LawEnforcement: LawEnforcement
    LawEnforcement --> AlarmMonitoringService: AlarmMonitoringService
    AlarmMonitoringService --> ValidationCheck: needs review
    ValidationCheck --> LawEnforcement: corrections needed
    ValidationCheck --> SecurityEquipmentVendor: approved
    ValidationCheck --> SecurityEquipmentVendor: SecurityEquipmentVendor
    SecurityEquipmentVendor --> InsuranceUnderwriter: InsuranceUnderwriter
