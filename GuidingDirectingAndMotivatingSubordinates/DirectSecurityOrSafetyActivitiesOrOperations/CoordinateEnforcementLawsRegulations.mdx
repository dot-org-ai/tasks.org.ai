...
```mermaid
erDiagram
    InspectionPlan ||--o{ Violation : "discovers"
    Violation ||--|| Citation : "triggers"
    Citation ||--o{ Penalty : "imposes"
    Violation ||--|| RemediationPlan : "requires"
    RemediationPlan ||--|| ComplianceDeadline : "targets"
    EnforcementAction ||--o{ Citation : "escalates"
```
...
stateDiagram-v2
    ...
    InspectionCompleted --> ViolationDocumented : violationDocumented
    ViolationDocumented --> CitationIssued : citationIssued
    CitationIssued --> PenaltyAssessed : penaltyAssessed
    PenaltyAssessed --> RemediationPending : remediationDeadlinePassed
    RemediationPending --> Escalated : enforcementEscalated
    Escalated --> InspectionScheduled : inspectionScheduled
    PenaltyAssessed --> [*]
```
