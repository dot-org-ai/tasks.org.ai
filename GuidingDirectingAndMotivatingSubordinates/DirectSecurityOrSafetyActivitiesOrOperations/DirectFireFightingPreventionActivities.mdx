...
```mermaid
erDiagram
    DispatchCenter ||--o{ BuildingOwner : includes
    BuildingOwner ||--o{ FireMarshal : includes
    FireMarshal }o--|| MutualAidDepartment : "relates to"
    FireMarshal }o--|| InsuranceCarrier : "relates to"
    FireMarshal }o--|| WaterAuthority : "relates to"
```
...
stateDiagram-v2
    ...
    DispatchCenter --> BuildingOwner: BuildingOwner
    BuildingOwner --> FireMarshal: FireMarshal
    FireMarshal --> ValidationCheck: needs review
    ValidationCheck --> BuildingOwner: corrections needed
    ValidationCheck --> MutualAidDepartment: approved
    ValidationCheck --> MutualAidDepartment: MutualAidDepartment
    MutualAidDepartment --> InsuranceCarrier: InsuranceCarrier
    InsuranceCarrier --> WaterAuthority: WaterAuthority
    WaterAuthority --> [*]
```
