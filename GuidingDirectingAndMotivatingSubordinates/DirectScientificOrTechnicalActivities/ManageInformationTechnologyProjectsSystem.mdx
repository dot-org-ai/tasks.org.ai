...
```mermaid
erDiagram
    BusinessStakeholder ||--o{ SoftwareVendor : includes
    SoftwareVendor }o--|| CloudProvider : "relates to"
    SoftwareVendor }o--|| SecurityTeam : "relates to"
    SoftwareVendor }o--|| EndUser : "relates to"
    SoftwareVendor }o--|| ProcurementOffice : "relates to"
    CloudProvider ||--o{ SecurityTeam : includes
    SecurityTeam }o--|| EndUser : "relates to"
    SecurityTeam }o--|| ProcurementOffice : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> BusinessStakeholder: BusinessStakeholder
    BusinessStakeholder --> SoftwareVendor: SoftwareVendor
    SoftwareVendor --> CloudProvider: CloudProvider
    CloudProvider --> ValidationCheck: needs review
    ValidationCheck --> SoftwareVendor: corrections needed
    ValidationCheck --> SecurityTeam: approved
    ValidationCheck --> SecurityTeam: SecurityTeam
    SecurityTeam --> EndUser: EndUser
    EndUser --> ProcurementOffice: ProcurementOffice
    ProcurementOffice --> [*]
```
