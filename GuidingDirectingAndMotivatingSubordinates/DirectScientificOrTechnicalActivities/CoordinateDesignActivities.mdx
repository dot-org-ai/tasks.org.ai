...
```mermaid
erDiagram
    DesignProject ||--o{ Deliverable : "produces"
    Deliverable ||--o{ ReviewCycle : "evaluated-in"
    Deliverable ||--o{ Revision : "versioned-by"
    DesignProject ||--|| DesignStandard : "conforms-to"
    ReviewCycle ||--o| ConflictLog : "identifies"
    ConflictLog ||--|| Revision : "resolves"
```
...
stateDiagram-v2
    [*] --> ProjectInitiated
    ProjectInitiated --> TasksAssigned : designTasksAssigned
    TasksAssigned --> InReview : designReviewCompleted
    InReview --> ConflictResolution : designConflictResolved
    ConflictResolution --> Revised : revisionIssued
    Revised --> InReview : designReviewCompleted
    InReview --> Approved : deliverableApproved
    Approved --> ReleasedForFabrication : designReleasedForFabrication
