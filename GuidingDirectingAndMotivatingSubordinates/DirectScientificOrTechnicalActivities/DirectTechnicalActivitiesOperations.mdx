...
```mermaid
erDiagram
    ClientOrganization ||--o{ EquipmentManufacturer : includes
    EquipmentManufacturer ||--o{ RegulatoryAuthority : includes
    RegulatoryAuthority }o--|| SubcontractorFirm : "relates to"
    RegulatoryAuthority }o--|| UtilityProvider : "relates to"
    RegulatoryAuthority }o--|| IndustryStandardsBody : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> ClientOrganization: ClientOrganization
    ClientOrganization --> EquipmentManufacturer: EquipmentManufacturer
    EquipmentManufacturer --> RegulatoryAuthority: RegulatoryAuthority
    RegulatoryAuthority --> ValidationCheck: needs review
    ValidationCheck --> EquipmentManufacturer: corrections needed
    ValidationCheck --> SubcontractorFirm: approved
    ValidationCheck --> SubcontractorFirm: SubcontractorFirm
    SubcontractorFirm --> UtilityProvider: UtilityProvider
    UtilityProvider --> IndustryStandardsBody: IndustryStandardsBody
