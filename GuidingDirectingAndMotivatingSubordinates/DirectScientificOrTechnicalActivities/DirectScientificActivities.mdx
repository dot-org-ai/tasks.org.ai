...
```mermaid
erDiagram
    ResearchInstitution ||--o{ RegulatoryAgency : includes
    RegulatoryAgency ||--o{ EthicsBoard : includes
    EthicsBoard }o--|| EquipmentVendor : "relates to"
    EthicsBoard }o--|| PublicationJournal : "relates to"
    EthicsBoard }o--|| FundingAgency : "relates to"
    EquipmentVendor }o--|| PublicationJournal : "relates to"
    EquipmentVendor }o--|| FundingAgency : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> ResearchInstitution: ResearchInstitution
    ResearchInstitution --> RegulatoryAgency: RegulatoryAgency
    RegulatoryAgency --> EthicsBoard: EthicsBoard
    EthicsBoard --> ValidationCheck: needs review
    ValidationCheck --> RegulatoryAgency: corrections needed
    ValidationCheck --> EquipmentVendor: approved
    ValidationCheck --> EquipmentVendor: EquipmentVendor
    EquipmentVendor --> PublicationJournal: PublicationJournal
    PublicationJournal --> FundingAgency: FundingAgency
    FundingAgency --> [*]
```
