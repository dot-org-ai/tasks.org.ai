...
```mermaid
erDiagram
    DevelopmentProgram ||--o{ DesignMilestone : "defines"
    DevelopmentProgram ||--|| TechnicalSpecification : "specifies"
    DevelopmentProgram ||--|| ResourcePlan : "allocates"
    DesignMilestone ||--o| Prototype : "produces"
    Prototype ||--o{ IntellectualProperty : "generates"
    TechnicalSpecification ||--|| Prototype : "validates"
```
...
stateDiagram-v2
    [*] --> Launched
    Launched --> Specified : specificationsDefinied
    Specified --> Resourced : resourcesAllocated
    Resourced --> Prototyping : prototypeCompleted
    Prototyping --> MilestoneReviewed : milestoneReviewCompleted
    MilestoneReviewed --> Approved : designApproved
    MilestoneReviewed --> Resourced : resourcesAllocated
    Approved --> PatentFiled : patentFiled
    PatentFiled --> Launched : programLaunched
    PatentFiled --> [*]
```
