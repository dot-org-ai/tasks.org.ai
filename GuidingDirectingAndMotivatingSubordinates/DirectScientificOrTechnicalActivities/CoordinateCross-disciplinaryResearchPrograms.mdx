...
```mermaid
erDiagram
    FundingAgency ||--o{ PartnerInstitution : includes
    PartnerInstitution ||--o{ IndustryPartner : includes
    IndustryPartner ||--o{ InstitutionalReviewBoard : includes
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> FundingAgency: FundingAgency
    FundingAgency --> PartnerInstitution: PartnerInstitution
    PartnerInstitution --> IndustryPartner: IndustryPartner
    IndustryPartner --> ValidationCheck: needs review
    ValidationCheck --> PartnerInstitution: corrections needed
    ValidationCheck --> InstitutionalReviewBoard: approved
    ValidationCheck --> InstitutionalReviewBoard: InstitutionalReviewBoard
    InstitutionalReviewBoard --> PublishingJournal: PublishingJournal
    PublishingJournal --> [*]
```
