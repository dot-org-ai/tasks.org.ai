...
```mermaid
erDiagram
    RegulatoryAgency ||--o{ FundingBody : includes
    FundingBody ||--o{ PatientPopulation : includes
    PatientPopulation ||--o{ PartnerHospital : includes
```
...
stateDiagram-v2
    ...
    RegulatoryAgency --> FundingBody: FundingBody
    FundingBody --> PatientPopulation: PatientPopulation
    PatientPopulation --> ValidationCheck: needs review
    ValidationCheck --> FundingBody: corrections needed
    ValidationCheck --> PartnerHospital: approved
    ValidationCheck --> PartnerHospital: PartnerHospital
    PartnerHospital --> PharmaceuticalSponsor: PharmaceuticalSponsor
