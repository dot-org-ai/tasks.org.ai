...
```mermaid
erDiagram
    SoftwareVendor }o--|| HardwareVendor : "relates to"
    SoftwareVendor }o--|| EndUser : "relates to"
    SoftwareVendor }o--|| NetworkOperations : "relates to"
    SoftwareVendor }o--|| ChangeAdvisoryBoard : "relates to"
    HardwareVendor ||--o{ EndUser : includes
    EndUser }o--|| NetworkOperations : "relates to"
    EndUser }o--|| ChangeAdvisoryBoard : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> SoftwareVendor: SoftwareVendor
    SoftwareVendor --> HardwareVendor: HardwareVendor
    HardwareVendor --> EndUser: EndUser
    EndUser --> ValidationCheck: needs review
    ValidationCheck --> HardwareVendor: corrections needed
    ValidationCheck --> NetworkOperations: approved
    ValidationCheck --> NetworkOperations: NetworkOperations
    NetworkOperations --> ChangeAdvisoryBoard: ChangeAdvisoryBoard
    ChangeAdvisoryBoard --> [*]
```
