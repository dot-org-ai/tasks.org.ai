...
```mermaid
erDiagram
    Student ||--o{ Parent : includes
    Student ||--o{ Advisor : contains
    Parent ||--o{ Coach : includes
    Coach }o--|| Advisor : "relates to"
    Coach }o--|| SchoolAdministrator : "relates to"
    Coach }o--|| ExternalOrganizer : "relates to"
```
...
stateDiagram-v2
    ...
    Parent --> Coach: Coach
    Coach --> ValidationCheck: needs review
    ValidationCheck --> Parent: corrections needed
    ValidationCheck --> Advisor: approved
    ValidationCheck --> Advisor: Advisor
    Advisor --> SchoolAdministrator: SchoolAdministrator
    SchoolAdministrator --> ExternalOrganizer: ExternalOrganizer
    ExternalOrganizer --> [*]
```
