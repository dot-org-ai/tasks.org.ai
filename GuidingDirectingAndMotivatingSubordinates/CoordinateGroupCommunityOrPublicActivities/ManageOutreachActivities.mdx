...
```mermaid
erDiagram
    CommunityMembers }o--|| VolunteerGroups : "relates to"
    CommunityMembers }o--|| LocalGovernment : "relates to"
    CommunityMembers }o--|| MediaOutlets : "relates to"
    CommunityMembers }o--|| NonprofitPartners : "relates to"
    CommunityMembers }o--|| Sponsors : "relates to"
    VolunteerGroups ||--o{ LocalGovernment : includes
    LocalGovernment ||--o{ MediaOutlets : includes
```
...
stateDiagram-v2
    ...
    CommunityMembers --> VolunteerGroups: VolunteerGroups
    VolunteerGroups --> LocalGovernment: LocalGovernment
    LocalGovernment --> ValidationCheck: needs review
    ValidationCheck --> VolunteerGroups: corrections needed
    ValidationCheck --> MediaOutlets: approved
    ValidationCheck --> MediaOutlets: MediaOutlets
    MediaOutlets --> NonprofitPartners: NonprofitPartners
    NonprofitPartners --> Sponsors: Sponsors
    Sponsors --> [*]
```
