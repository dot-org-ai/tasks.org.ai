...
stateDiagram-v2
    [*] --> EventPlanned
    EventPlanned --> VenueBooked : venueBooked
    VenueBooked --> VendorContracted : vendorContracted
    VendorContracted --> RegistrationOpened : registrationOpened
    RegistrationOpened --> ProgramScheduled : programScheduled
    ProgramScheduled --> LogisticsCoordinated : logisticsCoordinated
    LogisticsCoordinated --> EventExecuted : eventExecuted
    ProgramScheduled --> VendorContracted : vendorContracted
    EventExecuted --> [*]
```
