...
```mermaid
erDiagram
    CommunityMembers }o--|| VenueProvider : "relates to"
    CommunityMembers }o--|| EquipmentSupplier : "relates to"
    CommunityMembers }o--|| SponsorOrganization : "relates to"
    CommunityMembers }o--|| PermittingAuthority : "relates to"
    VenueProvider ||--o{ EquipmentSupplier : includes
    EquipmentSupplier ||--o{ SponsorOrganization : includes
    SponsorOrganization }o--|| PermittingAuthority : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> CommunityMembers: CommunityMembers
    CommunityMembers --> VenueProvider: VenueProvider
    VenueProvider --> EquipmentSupplier: EquipmentSupplier
    EquipmentSupplier --> ValidationCheck: needs review
    ValidationCheck --> VenueProvider: corrections needed
    ValidationCheck --> SponsorOrganization: approved
    ValidationCheck --> SponsorOrganization: SponsorOrganization
    SponsorOrganization --> PermittingAuthority: PermittingAuthority
    PermittingAuthority --> [*]
```
