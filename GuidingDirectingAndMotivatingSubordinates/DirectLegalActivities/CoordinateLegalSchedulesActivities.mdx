...
```mermaid
erDiagram
    CourtClerk }o--|| OpposingCounsel : "relates to"
    CourtClerk }o--|| CourtReporter : "relates to"
    CourtClerk }o--|| MediationService : "relates to"
    CourtClerk }o--|| ClientOrganization : "relates to"
    OpposingCounsel }o--|| CourtReporter : "relates to"
    OpposingCounsel }o--|| MediationService : "relates to"
    OpposingCounsel }o--|| ClientOrganization : "relates to"
    CourtReporter }o--|| MediationService : "relates to"
    CourtReporter }o--|| ClientOrganization : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> CourtClerk: CourtClerk
    CourtClerk --> OpposingCounsel: OpposingCounsel
    OpposingCounsel --> CourtReporter: CourtReporter
    CourtReporter --> ValidationCheck: needs review
    ValidationCheck --> OpposingCounsel: corrections needed
    ValidationCheck --> MediationService: approved
    ValidationCheck --> MediationService: MediationService
    MediationService --> ClientOrganization: ClientOrganization
    ClientOrganization --> [*]
```
