...
```mermaid
erDiagram
    ProsecutorOffice ||--o{ ForensicLaboratory : includes
    ForensicLaboratory }o--|| CourtSystem : "relates to"
    ForensicLaboratory }o--|| VictimAdvocate : "relates to"
    ForensicLaboratory }o--|| ExternalAgency : "relates to"
    CourtSystem }o--|| VictimAdvocate : "relates to"
    CourtSystem }o--|| ExternalAgency : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> ProsecutorOffice: ProsecutorOffice
    ProsecutorOffice --> ForensicLaboratory: ForensicLaboratory
    ForensicLaboratory --> CourtSystem: CourtSystem
    CourtSystem --> ValidationCheck: needs review
    ValidationCheck --> ForensicLaboratory: corrections needed
    ValidationCheck --> VictimAdvocate: approved
    ValidationCheck --> VictimAdvocate: VictimAdvocate
    VictimAdvocate --> ExternalAgency: ExternalAgency
    ExternalAgency --> [*]
```
