...
```mermaid
erDiagram
    DepartmentHead ||--o{ ServiceContractor : includes
    ServiceContractor ||--o{ VendorCoordinator : includes
    VendorCoordinator ||--o{ SafetyOfficer : includes
    SafetyOfficer }o--|| ProcurementTeam : "relates to"
    SafetyOfficer }o--|| ExecutiveStakeholder : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> DepartmentHead: DepartmentHead
    DepartmentHead --> ServiceContractor: ServiceContractor
    ServiceContractor --> VendorCoordinator: VendorCoordinator
    VendorCoordinator --> ValidationCheck: needs review
    ValidationCheck --> ServiceContractor: corrections needed
    ValidationCheck --> SafetyOfficer: approved
    ValidationCheck --> SafetyOfficer: SafetyOfficer
    SafetyOfficer --> ProcurementTeam: ProcurementTeam
    ProcurementTeam --> ExecutiveStakeholder: ExecutiveStakeholder
