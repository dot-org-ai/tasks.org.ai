...
```mermaid
erDiagram
    EnvironmentalRegulator ||--o{ CertificationBody : includes
    CertificationBody ||--o{ SustainabilityConsultant : includes
    SustainabilityConsultant ||--o{ CommunityGroup : includes
    CommunityGroup }o--|| GreenTechnologyVendor : "relates to"
    CommunityGroup }o--|| InvestorOrShareholder : "relates to"
    GreenTechnologyVendor }o--|| InvestorOrShareholder : "relates to"
```
...
stateDiagram-v2
    ...
    EnvironmentalRegulator --> CertificationBody: CertificationBody
    CertificationBody --> SustainabilityConsultant: SustainabilityConsultant
    SustainabilityConsultant --> ValidationCheck: needs review
    ValidationCheck --> CertificationBody: corrections needed
    ValidationCheck --> CommunityGroup: approved
    ValidationCheck --> CommunityGroup: CommunityGroup
    CommunityGroup --> GreenTechnologyVendor: GreenTechnologyVendor
    GreenTechnologyVendor --> InvestorOrShareholder: InvestorOrShareholder
