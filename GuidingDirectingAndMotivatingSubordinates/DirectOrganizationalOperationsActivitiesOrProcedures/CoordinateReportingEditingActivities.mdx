...
```mermaid
erDiagram
    Source }o--|| Advertiser : "relates to"
    Source }o--|| PrintDistributor : "relates to"
    Source }o--|| DigitalPlatform : "relates to"
    Source }o--|| PressAssociation : "relates to"
    Advertiser ||--o{ PrintDistributor : includes
    PrintDistributor }o--|| DigitalPlatform : "relates to"
    PrintDistributor }o--|| PressAssociation : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Source: Source
    Source --> Advertiser: Advertiser
    Advertiser --> PrintDistributor: PrintDistributor
    PrintDistributor --> ValidationCheck: needs review
    ValidationCheck --> Advertiser: corrections needed
    ValidationCheck --> DigitalPlatform: approved
    ValidationCheck --> DigitalPlatform: DigitalPlatform
    DigitalPlatform --> PressAssociation: PressAssociation
    PressAssociation --> [*]
```
