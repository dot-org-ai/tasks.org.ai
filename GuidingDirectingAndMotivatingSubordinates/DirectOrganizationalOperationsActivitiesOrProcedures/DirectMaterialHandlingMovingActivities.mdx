...
```mermaid
erDiagram
    InboundCarrier ||--o{ OutboundCarrier : includes
    OutboundCarrier }o--|| EquipmentVendor : "relates to"
    OutboundCarrier }o--|| SafetyInspector : "relates to"
    OutboundCarrier }o--|| HazmatRegulator : "relates to"
    EquipmentVendor }o--|| SafetyInspector : "relates to"
    EquipmentVendor }o--|| HazmatRegulator : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> InboundCarrier: InboundCarrier
    InboundCarrier --> OutboundCarrier: OutboundCarrier
    OutboundCarrier --> EquipmentVendor: EquipmentVendor
    EquipmentVendor --> ValidationCheck: needs review
    ValidationCheck --> OutboundCarrier: corrections needed
    ValidationCheck --> SafetyInspector: approved
    ValidationCheck --> SafetyInspector: SafetyInspector
    SafetyInspector --> HazmatRegulator: HazmatRegulator
    HazmatRegulator --> [*]
```
