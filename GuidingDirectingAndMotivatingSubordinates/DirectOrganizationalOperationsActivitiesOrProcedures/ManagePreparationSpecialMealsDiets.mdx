...
```mermaid
erDiagram
    Patient ||--o{ Dietitian : includes
    Dietitian }o--|| SpecialtyFoodSupplier : "relates to"
    Dietitian }o--|| HealthInspector : "relates to"
    Dietitian }o--|| CulturalAdvisor : "relates to"
    SpecialtyFoodSupplier ||--o{ HealthInspector : includes
```
...
stateDiagram-v2
    ...
    Dietitian --> SpecialtyFoodSupplier: SpecialtyFoodSupplier
    SpecialtyFoodSupplier --> ValidationCheck: needs review
    ValidationCheck --> Dietitian: corrections needed
    ValidationCheck --> HealthInspector: approved
    ValidationCheck --> HealthInspector: HealthInspector
    HealthInspector --> CulturalAdvisor: CulturalAdvisor
    CulturalAdvisor --> [*]
```
