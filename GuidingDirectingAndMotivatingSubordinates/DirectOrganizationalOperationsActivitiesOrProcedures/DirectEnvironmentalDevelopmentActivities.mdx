...
```mermaid
erDiagram
    EnvironmentalAgency }o--|| CommunityStakeholder : "relates to"
    EnvironmentalAgency }o--|| ConservationPartner : "relates to"
    EnvironmentalAgency ||--o{ EnvironmentalConsultant : contains
    EnvironmentalAgency }o--|| FundingBody : "relates to"
    EnvironmentalAgency }o--|| LandOwner : "relates to"
    CommunityStakeholder ||--o{ ConservationPartner : includes
    CommunityStakeholder ||--o{ EnvironmentalConsultant : contains
    ConservationPartner ||--o{ EnvironmentalConsultant : contains
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> EnvironmentalAgency: EnvironmentalAgency
    EnvironmentalAgency --> CommunityStakeholder: CommunityStakeholder
    CommunityStakeholder --> ConservationPartner: ConservationPartner
    ConservationPartner --> ValidationCheck: needs review
    ValidationCheck --> CommunityStakeholder: corrections needed
    ValidationCheck --> EnvironmentalConsultant: approved
    ValidationCheck --> EnvironmentalConsultant: EnvironmentalConsultant
    EnvironmentalConsultant --> FundingBody: FundingBody
    FundingBody --> LandOwner: LandOwner
    LandOwner --> [*]
```
