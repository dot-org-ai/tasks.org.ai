...
```mermaid
erDiagram
    Guest ||--o{ TravelAgent : includes
    Guest ||--o{ ReviewPlatform : contains
    TravelAgent }o--|| OnlineTravelAgency : "relates to"
    TravelAgent }o--|| VenuePartner : "relates to"
    TravelAgent }o--|| ReviewPlatform : "relates to"
    OnlineTravelAgency }o--|| VenuePartner : "relates to"
    OnlineTravelAgency }o--|| ReviewPlatform : "relates to"
```
...
stateDiagram-v2
    ...
    Guest --> TravelAgent: TravelAgent
    TravelAgent --> OnlineTravelAgency: OnlineTravelAgency
    OnlineTravelAgency --> ValidationCheck: needs review
    ValidationCheck --> TravelAgent: corrections needed
    ValidationCheck --> VenuePartner: approved
    ValidationCheck --> VenuePartner: VenuePartner
    VenuePartner --> ReviewPlatform: ReviewPlatform
    ReviewPlatform --> [*]
```
