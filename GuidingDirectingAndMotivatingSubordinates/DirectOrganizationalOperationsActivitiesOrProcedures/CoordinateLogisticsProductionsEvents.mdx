...
```mermaid
erDiagram
    VenueProvider }o--|| EquipmentRentalCompany : "relates to"
    VenueProvider }o--|| CateringService : "relates to"
    VenueProvider }o--|| SecurityFirm : "relates to"
    VenueProvider }o--|| TransportCompany : "relates to"
    VenueProvider }o--|| PermittingAuthority : "relates to"
    EquipmentRentalCompany ||--o{ CateringService : includes
    CateringService }o--|| SecurityFirm : "relates to"
    CateringService }o--|| TransportCompany : "relates to"
    CateringService }o--|| PermittingAuthority : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> VenueProvider: VenueProvider
    VenueProvider --> EquipmentRentalCompany: EquipmentRentalCompany
    EquipmentRentalCompany --> CateringService: CateringService
    CateringService --> ValidationCheck: needs review
    ValidationCheck --> EquipmentRentalCompany: corrections needed
    ValidationCheck --> SecurityFirm: approved
    ValidationCheck --> SecurityFirm: SecurityFirm
    SecurityFirm --> TransportCompany: TransportCompany
    TransportCompany --> PermittingAuthority: PermittingAuthority
    PermittingAuthority --> [*]
```
