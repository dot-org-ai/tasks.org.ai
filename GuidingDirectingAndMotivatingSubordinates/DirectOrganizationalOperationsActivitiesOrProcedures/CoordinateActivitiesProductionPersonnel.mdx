...
```mermaid
erDiagram
    StaffingAgency ||--o{ UnionRepresentative : includes
    UnionRepresentative ||--o{ SafetyInspector : includes
    SafetyInspector }o--|| EquipmentVendor : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> StaffingAgency: StaffingAgency
    StaffingAgency --> UnionRepresentative: UnionRepresentative
    UnionRepresentative --> SafetyInspector: SafetyInspector
    SafetyInspector --> EquipmentVendor: EquipmentVendor
    EquipmentVendor --> [*]
```
