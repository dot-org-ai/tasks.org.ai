...
erDiagram
    ...
    Customer }o--|| AdvertisingAgency : "relates to"
    Customer }o--|| MarketResearchFirm : "relates to"
    Customer }o--|| EventOrganizer : "relates to"
    ChannelPartner ||--o{ AdvertisingAgency : includes
    AdvertisingAgency ||--o{ MarketResearchFirm : includes
```
...
stateDiagram-v2
    ...
    Customer --> ChannelPartner: ChannelPartner
    ChannelPartner --> AdvertisingAgency: AdvertisingAgency
    AdvertisingAgency --> ValidationCheck: needs review
    ValidationCheck --> ChannelPartner: corrections needed
    ValidationCheck --> MarketResearchFirm: approved
    ValidationCheck --> MarketResearchFirm: MarketResearchFirm
    MarketResearchFirm --> EventOrganizer: EventOrganizer
    EventOrganizer --> [*]
```
