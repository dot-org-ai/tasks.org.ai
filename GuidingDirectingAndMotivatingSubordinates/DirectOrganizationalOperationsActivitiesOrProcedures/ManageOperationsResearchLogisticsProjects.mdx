...
erDiagram
    ...
    Project ||--|| ResourceAllocation : "consumes"
    RiskRegister ||--o{ Project : "assesses"
    StatusReport ||--o{ Milestone : "tracks"
    ChangeRequest ||--|| Project : "modifies"
    LessonsLearned ||--|| Project : "captures"
```
...
stateDiagram-v2
    [*] --> Scoped
    Scoped --> Resourced : resourcesAllocated
    Resourced --> InProgress : milestoneReached
    InProgress --> RiskIdentified : riskIdentified
    RiskIdentified --> ChangeRequested : changeRequested
    ChangeRequested --> InProgress : milestoneReached
    InProgress --> Reported : statusReportSubmitted
    Reported --> Escalated : issueEscalated
    Escalated --> Scoped : projectScoped
    Reported --> Closed : projectClosed
    Closed --> [*]
```
