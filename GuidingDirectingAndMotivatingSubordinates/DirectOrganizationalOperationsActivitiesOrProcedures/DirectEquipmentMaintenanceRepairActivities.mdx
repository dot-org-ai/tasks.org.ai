...
```mermaid
erDiagram
    OEMSupport ||--o{ IndustrialDistributor : includes
    IndustrialDistributor ||--o{ CalibrationLab : includes
    CalibrationLab }o--|| ProductionScheduler : "relates to"
    CalibrationLab }o--|| SafetyEngineer : "relates to"
    CalibrationLab }o--|| QualityAssurance : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> OEMSupport: OEMSupport
    OEMSupport --> IndustrialDistributor: IndustrialDistributor
    IndustrialDistributor --> CalibrationLab: CalibrationLab
    CalibrationLab --> ValidationCheck: needs review
    ValidationCheck --> IndustrialDistributor: corrections needed
    ValidationCheck --> ProductionScheduler: approved
    ValidationCheck --> ProductionScheduler: ProductionScheduler
    ProductionScheduler --> SafetyEngineer: SafetyEngineer
    SafetyEngineer --> QualityAssurance: QualityAssurance
    QualityAssurance --> [*]
```
