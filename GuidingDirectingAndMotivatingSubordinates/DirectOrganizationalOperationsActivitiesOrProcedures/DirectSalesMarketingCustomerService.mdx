...
```mermaid
erDiagram
    Customer }o--|| AdvertisingPartner : "relates to"
    Customer }o--|| ChannelPartner : "relates to"
    Customer }o--|| MarketResearchFirm : "relates to"
    Customer ||--o{ CRMVendor : contains
    Customer }o--|| TradeAssociation : "relates to"
    AdvertisingPartner }o--|| ChannelPartner : "relates to"
    AdvertisingPartner }o--|| MarketResearchFirm : "relates to"
    AdvertisingPartner }o--|| CRMVendor : "relates to"
    AdvertisingPartner }o--|| TradeAssociation : "relates to"
    ChannelPartner ||--o{ MarketResearchFirm : includes
    CRMVendor }o--|| TradeAssociation : "relates to"
```
...
stateDiagram-v2
    ...
    Customer --> AdvertisingPartner: AdvertisingPartner
    AdvertisingPartner --> ChannelPartner: ChannelPartner
    ChannelPartner --> ValidationCheck: needs review
    ValidationCheck --> AdvertisingPartner: corrections needed
    ValidationCheck --> MarketResearchFirm: approved
    ValidationCheck --> MarketResearchFirm: MarketResearchFirm
    MarketResearchFirm --> CRMVendor: CRMVendor
    CRMVendor --> TradeAssociation: TradeAssociation
    TradeAssociation --> [*]
```
