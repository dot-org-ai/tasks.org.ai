...
```mermaid
erDiagram
    Audience }o--|| TalentAgent : "relates to"
    Audience }o--|| VenueOwner : "relates to"
    Audience }o--|| Sponsor : "relates to"
    Audience }o--|| MediaOutlet : "relates to"
    Audience }o--|| LicensingAuthority : "relates to"
    TalentAgent }o--|| VenueOwner : "relates to"
    TalentAgent }o--|| Sponsor : "relates to"
    TalentAgent }o--|| MediaOutlet : "relates to"
    TalentAgent }o--|| LicensingAuthority : "relates to"
    VenueOwner }o--|| Sponsor : "relates to"
    VenueOwner }o--|| MediaOutlet : "relates to"
    VenueOwner }o--|| LicensingAuthority : "relates to"
    Sponsor }o--|| MediaOutlet : "relates to"
    Sponsor }o--|| LicensingAuthority : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Audience: Audience
    Audience --> TalentAgent: TalentAgent
    TalentAgent --> VenueOwner: VenueOwner
    VenueOwner --> ValidationCheck: needs review
    ValidationCheck --> TalentAgent: corrections needed
    ValidationCheck --> Sponsor: approved
    ValidationCheck --> Sponsor: Sponsor
    Sponsor --> MediaOutlet: MediaOutlet
    MediaOutlet --> LicensingAuthority: LicensingAuthority
    LicensingAuthority --> [*]
```
