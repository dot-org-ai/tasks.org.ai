...
erDiagram
    ...
    HealthInsurer }o--|| RegulatoryAgency : "relates to"
    HealthInsurer }o--|| AccreditationBody : "relates to"
    HealthInsurer }o--|| CommunityPartner : "relates to"
    HealthInsurer }o--|| PharmaceuticalSupplier : "relates to"
    RegulatoryAgency }o--|| AccreditationBody : "relates to"
    RegulatoryAgency }o--|| CommunityPartner : "relates to"
    RegulatoryAgency }o--|| PharmaceuticalSupplier : "relates to"
```
...
stateDiagram-v2
    ...
    HealthInsurer --> RegulatoryAgency: RegulatoryAgency
    RegulatoryAgency --> ValidationCheck: needs review
    ValidationCheck --> HealthInsurer: corrections needed
    ValidationCheck --> AccreditationBody: approved
    ValidationCheck --> AccreditationBody: AccreditationBody
    AccreditationBody --> CommunityPartner: CommunityPartner
    CommunityPartner --> PharmaceuticalSupplier: PharmaceuticalSupplier
