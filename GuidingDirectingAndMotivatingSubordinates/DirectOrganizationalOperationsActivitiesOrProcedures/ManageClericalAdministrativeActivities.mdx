...
```mermaid
erDiagram
    DocumentVendor ||--o{ RecordsArchive : includes
    RecordsArchive }o--|| CourierService : "relates to"
    RecordsArchive }o--|| SoftwareVendor : "relates to"
    CourierService ||--o{ SoftwareVendor : includes
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> DocumentVendor: DocumentVendor
    DocumentVendor --> RecordsArchive: RecordsArchive
    RecordsArchive --> CourierService: CourierService
    CourierService --> SoftwareVendor: SoftwareVendor
    SoftwareVendor --> [*]
```
