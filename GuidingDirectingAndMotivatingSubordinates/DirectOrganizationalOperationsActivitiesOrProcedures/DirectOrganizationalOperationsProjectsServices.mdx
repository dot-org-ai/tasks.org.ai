...
```mermaid
erDiagram
    BoardOfDirectors ||--o{ Client : includes
    Client ||--o{ StrategicPartner : includes
    StrategicPartner ||--o{ IndustryRegulator : includes
    IndustryRegulator }o--|| InvestorStakeholder : "relates to"
```
...
stateDiagram-v2
    ...
    BoardOfDirectors --> Client: Client
    Client --> StrategicPartner: StrategicPartner
    StrategicPartner --> ValidationCheck: needs review
    ValidationCheck --> Client: corrections needed
    ValidationCheck --> IndustryRegulator: approved
    ValidationCheck --> IndustryRegulator: IndustryRegulator
    IndustryRegulator --> InvestorStakeholder: InvestorStakeholder
    InvestorStakeholder --> [*]
```
