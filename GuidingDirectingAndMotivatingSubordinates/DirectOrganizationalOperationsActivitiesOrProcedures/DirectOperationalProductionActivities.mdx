...
```mermaid
erDiagram
    Supplier }o--|| Customer : "relates to"
    Supplier }o--|| RegulatoryAgency : "relates to"
    Supplier }o--|| EquipmentVendor : "relates to"
    Supplier }o--|| LogisticsPartner : "relates to"
    Supplier }o--|| QualityAuditor : "relates to"
    Customer ||--o{ RegulatoryAgency : includes
    RegulatoryAgency }o--|| EquipmentVendor : "relates to"
    RegulatoryAgency }o--|| LogisticsPartner : "relates to"
    RegulatoryAgency }o--|| QualityAuditor : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Supplier: Supplier
    Supplier --> Customer: Customer
    Customer --> RegulatoryAgency: RegulatoryAgency
    RegulatoryAgency --> ValidationCheck: needs review
    ValidationCheck --> Customer: corrections needed
    ValidationCheck --> EquipmentVendor: approved
    ValidationCheck --> EquipmentVendor: EquipmentVendor
    EquipmentVendor --> LogisticsPartner: LogisticsPartner
    LogisticsPartner --> QualityAuditor: QualityAuditor
    QualityAuditor --> [*]
```
