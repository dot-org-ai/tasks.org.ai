...
```mermaid
erDiagram
    GridOperator ||--o{ EnergyRegulator : includes
    EnergyRegulator }o--|| EquipmentManufacturer : "relates to"
    EnergyRegulator }o--|| UtilityCompany : "relates to"
    EnergyRegulator }o--|| EnvironmentalAgency : "relates to"
    EnergyRegulator }o--|| FinancialInvestor : "relates to"
    EquipmentManufacturer ||--o{ UtilityCompany : includes
    EnvironmentalAgency }o--|| FinancialInvestor : "relates to"
```
...
stateDiagram-v2
    ...
    GridOperator --> EnergyRegulator: EnergyRegulator
    EnergyRegulator --> EquipmentManufacturer: EquipmentManufacturer
    EquipmentManufacturer --> ValidationCheck: needs review
    ValidationCheck --> EnergyRegulator: corrections needed
    ValidationCheck --> UtilityCompany: approved
    ValidationCheck --> UtilityCompany: UtilityCompany
    UtilityCompany --> EnvironmentalAgency: EnvironmentalAgency
    EnvironmentalAgency --> FinancialInvestor: FinancialInvestor
    FinancialInvestor --> [*]
```
