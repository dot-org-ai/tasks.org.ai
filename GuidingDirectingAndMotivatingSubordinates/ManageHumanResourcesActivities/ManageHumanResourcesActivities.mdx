...
```mermaid
erDiagram
    Employee ||--o{ Candidate : includes
    Employee ||--o{ PayrollVendor : contains
    Candidate }o--|| BenefitsProvider : "relates to"
    Candidate }o--|| LaborAttorney : "relates to"
    Candidate }o--|| PayrollVendor : "relates to"
    Candidate }o--|| TrainingProvider : "relates to"
    Candidate }o--|| RegulatoryAgency : "relates to"
    BenefitsProvider ||--o{ LaborAttorney : includes
    TrainingProvider }o--|| RegulatoryAgency : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Employee: Employee
    Employee --> Candidate: Candidate
    Candidate --> BenefitsProvider: BenefitsProvider
    BenefitsProvider --> ValidationCheck: needs review
    ValidationCheck --> Candidate: corrections needed
    ValidationCheck --> LaborAttorney: approved
    ValidationCheck --> LaborAttorney: LaborAttorney
    LaborAttorney --> PayrollVendor: PayrollVendor
    PayrollVendor --> TrainingProvider: TrainingProvider
    TrainingProvider --> RegulatoryAgency: RegulatoryAgency
    RegulatoryAgency --> [*]
```
