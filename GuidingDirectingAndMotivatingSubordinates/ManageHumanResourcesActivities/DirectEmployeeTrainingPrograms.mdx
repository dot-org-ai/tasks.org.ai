...
```mermaid
erDiagram
    SeniorLeadership ||--o{ TrainingVendor : includes
    TrainingVendor }o--|| DepartmentHead : "relates to"
    TrainingVendor }o--|| HRTeam : "relates to"
    TrainingVendor }o--|| ComplianceRegulator : "relates to"
    TrainingVendor }o--|| EmployeeUnion : "relates to"
    DepartmentHead ||--o{ HRTeam : includes
    ComplianceRegulator }o--|| EmployeeUnion : "relates to"
```
...
stateDiagram-v2
    ...
    SeniorLeadership --> TrainingVendor: TrainingVendor
    TrainingVendor --> DepartmentHead: DepartmentHead
    DepartmentHead --> ValidationCheck: needs review
    ValidationCheck --> TrainingVendor: corrections needed
    ValidationCheck --> HRTeam: approved
    ValidationCheck --> HRTeam: HRTeam
    HRTeam --> ComplianceRegulator: ComplianceRegulator
    ComplianceRegulator --> EmployeeUnion: EmployeeUnion
    EmployeeUnion --> [*]
```
