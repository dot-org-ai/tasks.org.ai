...
```mermaid
erDiagram
    TrainingStrategy ||--|| TrainingBudget : "funds"
    TrainingStrategy ||--o{ LearningCurriculum : "defines"
    LearningCurriculum ||--o{ VendorContract : "delivered-by"
    SkillGapAnalysis ||--|| TrainingStrategy : "informs"
    EffectivenessReport ||--|| LearningCurriculum : "evaluates"
    TrainingBudget ||--o{ VendorContract : "pays"
```
...
stateDiagram-v2
    [*] --> StrategyDefined
    StrategyDefined --> CurriculumApproved : curriculumApproved
    CurriculumApproved --> BudgetAllocated : budgetAllocated
    BudgetAllocated --> VendorsSelected : vendorsSelected
    VendorsSelected --> ProgressMonitored : progressMonitored
    ProgressMonitored --> EffectivenessEvaluated : effectivenessEvaluated
    EffectivenessEvaluated --> ProgramsRefined : programsRefined
    ProgramsRefined --> CurriculumApproved : curriculumApproved
