...
```mermaid
erDiagram
    TrainingVendor }o--|| Instructor : "relates to"
    TrainingVendor }o--|| Trainee : "relates to"
    TrainingVendor }o--|| LearningManagementSystem : "relates to"
    TrainingVendor }o--|| CertificationBody : "relates to"
    TrainingVendor }o--|| FacilityProvider : "relates to"
    Instructor ||--o{ Trainee : includes
    Trainee ||--o{ LearningManagementSystem : includes
    LearningManagementSystem }o--|| CertificationBody : "relates to"
    LearningManagementSystem }o--|| FacilityProvider : "relates to"
    CertificationBody }o--|| FacilityProvider : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> TrainingVendor: TrainingVendor
    TrainingVendor --> Instructor: Instructor
    Instructor --> Trainee: Trainee
    Trainee --> ValidationCheck: needs review
    ValidationCheck --> Instructor: corrections needed
    ValidationCheck --> LearningManagementSystem: approved
    ValidationCheck --> LearningManagementSystem: LearningManagementSystem
    LearningManagementSystem --> CertificationBody: CertificationBody
    CertificationBody --> FacilityProvider: FacilityProvider
    FacilityProvider --> [*]
```
