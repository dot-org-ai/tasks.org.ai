...
```mermaid
erDiagram
    JobCandidate }o--|| RecruitingAgency : "relates to"
    JobCandidate }o--|| JobBoard : "relates to"
    JobCandidate }o--|| BackgroundCheckProvider : "relates to"
    JobCandidate }o--|| UniversityCareerCenter : "relates to"
    JobCandidate }o--|| HiringManager : "relates to"
    RecruitingAgency ||--o{ JobBoard : includes
    JobBoard }o--|| BackgroundCheckProvider : "relates to"
    JobBoard }o--|| UniversityCareerCenter : "relates to"
    JobBoard }o--|| HiringManager : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> JobCandidate: JobCandidate
    JobCandidate --> RecruitingAgency: RecruitingAgency
    RecruitingAgency --> JobBoard: JobBoard
    JobBoard --> ValidationCheck: needs review
    ValidationCheck --> RecruitingAgency: corrections needed
    ValidationCheck --> BackgroundCheckProvider: approved
    ValidationCheck --> BackgroundCheckProvider: BackgroundCheckProvider
    BackgroundCheckProvider --> UniversityCareerCenter: UniversityCareerCenter
    UniversityCareerCenter --> HiringManager: HiringManager
    HiringManager --> [*]
```
