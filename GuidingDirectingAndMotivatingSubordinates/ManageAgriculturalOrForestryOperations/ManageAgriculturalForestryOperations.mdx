...
```mermaid
erDiagram
    Buyer ||--o{ Supplier : includes
    Supplier }o--|| RegulatoryAgency : "relates to"
    Supplier }o--|| Contractor : "relates to"
    Supplier }o--|| LandOwner : "relates to"
    Supplier }o--|| ConservationOrganization : "relates to"
    RegulatoryAgency }o--|| Contractor : "relates to"
    RegulatoryAgency }o--|| LandOwner : "relates to"
    RegulatoryAgency }o--|| ConservationOrganization : "relates to"
    Contractor }o--|| LandOwner : "relates to"
    Contractor }o--|| ConservationOrganization : "relates to"
    LandOwner }o--|| ConservationOrganization : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Buyer: Buyer
    Buyer --> Supplier: Supplier
    Supplier --> RegulatoryAgency: RegulatoryAgency
    RegulatoryAgency --> ValidationCheck: needs review
    ValidationCheck --> Supplier: corrections needed
    ValidationCheck --> Contractor: approved
    ValidationCheck --> Contractor: Contractor
    Contractor --> LandOwner: LandOwner
    LandOwner --> ConservationOrganization: ConservationOrganization
