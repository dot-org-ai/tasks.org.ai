...
```mermaid
erDiagram
    LandOwner ||--o{ EquipmentDealer : includes
    EquipmentDealer }o--|| SeedSupplier : "relates to"
    EquipmentDealer }o--|| Buyer : "relates to"
    EquipmentDealer }o--|| WeatherService : "relates to"
    EquipmentDealer }o--|| InspectionAgency : "relates to"
    SeedSupplier ||--o{ Buyer : includes
    Buyer }o--|| WeatherService : "relates to"
    Buyer }o--|| InspectionAgency : "relates to"
    WeatherService }o--|| InspectionAgency : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> LandOwner: LandOwner
    LandOwner --> EquipmentDealer: EquipmentDealer
    EquipmentDealer --> SeedSupplier: SeedSupplier
    SeedSupplier --> ValidationCheck: needs review
    ValidationCheck --> EquipmentDealer: corrections needed
    ValidationCheck --> Buyer: approved
    ValidationCheck --> Buyer: Buyer
    Buyer --> WeatherService: WeatherService
    WeatherService --> InspectionAgency: InspectionAgency
    InspectionAgency --> [*]
```
