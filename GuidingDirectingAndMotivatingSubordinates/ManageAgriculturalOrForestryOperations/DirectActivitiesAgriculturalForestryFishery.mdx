...
```mermaid
erDiagram
    WorkSchedule ||--o{ WorkAssignment : "organizes"
    WorkAssignment ||--o{ Employee : "assigns"
    Employee ||--o{ PerformanceReview : "receives"
    Employee ||--o{ TrainingRecord : "completes"
    SafetyIncident ||--|| Employee : "involves"
    WorkAssignment ||--|| SafetyIncident : "generates"
```
...
stateDiagram-v2
    [*] --> TasksAssigned
    TasksAssigned --> SafetyBriefed : safetyBriefingConducted
    SafetyBriefed --> CrewSupervised : crewSupervised
    CrewSupervised --> PerformanceMonitored : performanceMonitored
    PerformanceMonitored --> IncidentDocumented : incidentDocumented
    IncidentDocumented --> TrainingProvided : trainingProvided
    TrainingProvided --> TasksAssigned : tasksAssigned
    PerformanceMonitored --> EmployeeEvaluated : employeeEvaluated
    EmployeeEvaluated --> [*]
```
