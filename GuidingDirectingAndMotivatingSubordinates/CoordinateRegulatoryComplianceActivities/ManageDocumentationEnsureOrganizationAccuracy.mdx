...
```mermaid
erDiagram
    ExternalAuditor }o--|| RecordsAuthority : "relates to"
    ExternalAuditor }o--|| DocumentManagementVendor : "relates to"
    ExternalAuditor }o--|| LegalCounsel : "relates to"
    RecordsAuthority }o--|| DocumentManagementVendor : "relates to"
    RecordsAuthority }o--|| LegalCounsel : "relates to"
    DocumentManagementVendor }o--|| LegalCounsel : "relates to"
```
...
stateDiagram-v2
    ...
    ExternalAuditor --> RecordsAuthority: RecordsAuthority
    RecordsAuthority --> DocumentManagementVendor: DocumentManagementVendor
    DocumentManagementVendor --> LegalCounsel: LegalCounsel
    LegalCounsel --> [*]
```
