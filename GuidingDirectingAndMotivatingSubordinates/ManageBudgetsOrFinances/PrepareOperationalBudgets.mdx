...
```mermaid
erDiagram
    OperationalBudget ||--o{ DepartmentalBudget : "consolidates"
    DepartmentalBudget ||--o{ ExpenseForecast : "projects"
    RevenueAssumption ||--|| OperationalBudget : "targets"
    BudgetTemplate ||--o{ DepartmentalBudget : "structures"
    ApprovalRecord ||--|| OperationalBudget : "authorizes"
    ExpenseForecast ||--|| DepartmentalBudget : "details"
```
...
stateDiagram-v2
    ...
    TemplatesDistributed --> BudgetsCollected : departmentalBudgetsCollected
    BudgetsCollected --> AssumptionsBuilt : revenueAssumptionsBuilt
    AssumptionsBuilt --> BudgetsConsolidated : budgetsConsolidated
    BudgetsConsolidated --> ReviewedAndAdjusted : budgetReviewedAndAdjusted
    ReviewedAndAdjusted --> PresentedForApproval : budgetPresentedForApproval
    PresentedForApproval --> ReviewedAndAdjusted : budgetReviewedAndAdjusted
    PresentedForApproval --> BudgetFinalized : budgetFinalized
    BudgetFinalized --> [*]
```
