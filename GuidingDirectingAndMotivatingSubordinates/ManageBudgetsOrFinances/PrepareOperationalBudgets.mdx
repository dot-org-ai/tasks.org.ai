...
```mermaid
erDiagram
    DepartmentManager ||--o{ ExecutiveLeadership : includes
    ExecutiveLeadership ||--o{ AccountingDepartment : includes
    AccountingDepartment }o--|| HumanResources : "relates to"
    AccountingDepartment }o--|| FacilitiesManagement : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> DepartmentManager: DepartmentManager
    DepartmentManager --> ExecutiveLeadership: ExecutiveLeadership
    ExecutiveLeadership --> AccountingDepartment: AccountingDepartment
    AccountingDepartment --> ValidationCheck: needs review
    ValidationCheck --> ExecutiveLeadership: corrections needed
    ValidationCheck --> HumanResources: approved
    ValidationCheck --> HumanResources: HumanResources
    HumanResources --> FacilitiesManagement: FacilitiesManagement
