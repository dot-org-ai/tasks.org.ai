...
```mermaid
erDiagram
    Vendor }o--|| Customer : "relates to"
    Vendor }o--|| PayrollProcessor : "relates to"
    Vendor }o--|| BankPartner : "relates to"
    Vendor }o--|| TaxAuthority : "relates to"
    Customer }o--|| PayrollProcessor : "relates to"
    Customer }o--|| BankPartner : "relates to"
    Customer }o--|| TaxAuthority : "relates to"
    PayrollProcessor ||--o{ BankPartner : includes
```
...
stateDiagram-v2
    ...
    Customer --> PayrollProcessor: PayrollProcessor
    PayrollProcessor --> ValidationCheck: needs review
    ValidationCheck --> Customer: corrections needed
    ValidationCheck --> BankPartner: approved
    ValidationCheck --> BankPartner: BankPartner
    BankPartner --> TaxAuthority: TaxAuthority
    TaxAuthority --> [*]
```
