...
```mermaid
erDiagram
    Shareholder }o--|| RegulatoryBody : "relates to"
    Shareholder }o--|| CreditRatingAgency : "relates to"
    Shareholder }o--|| InvestmentBank : "relates to"
    Shareholder }o--|| ExternalAuditor : "relates to"
    Shareholder }o--|| InsuranceUnderwriter : "relates to"
    RegulatoryBody }o--|| CreditRatingAgency : "relates to"
    RegulatoryBody }o--|| InvestmentBank : "relates to"
    RegulatoryBody }o--|| ExternalAuditor : "relates to"
    RegulatoryBody }o--|| InsuranceUnderwriter : "relates to"
    CreditRatingAgency ||--o{ InvestmentBank : includes
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Shareholder: Shareholder
    Shareholder --> RegulatoryBody: RegulatoryBody
    RegulatoryBody --> CreditRatingAgency: CreditRatingAgency
    CreditRatingAgency --> ValidationCheck: needs review
    ValidationCheck --> RegulatoryBody: corrections needed
    ValidationCheck --> InvestmentBank: approved
    ValidationCheck --> InvestmentBank: InvestmentBank
    InvestmentBank --> ExternalAuditor: ExternalAuditor
    ExternalAuditor --> InsuranceUnderwriter: InsuranceUnderwriter
