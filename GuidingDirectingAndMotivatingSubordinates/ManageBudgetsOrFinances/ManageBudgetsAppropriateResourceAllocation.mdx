...
```mermaid
erDiagram
    DepartmentHead }o--|| ExecutiveCommittee : "relates to"
    DepartmentHead }o--|| FinanceAdvisor : "relates to"
    DepartmentHead }o--|| Vendor : "relates to"
    DepartmentHead }o--|| HRDepartment : "relates to"
    ExecutiveCommittee }o--|| FinanceAdvisor : "relates to"
    ExecutiveCommittee }o--|| Vendor : "relates to"
    ExecutiveCommittee }o--|| HRDepartment : "relates to"
    FinanceAdvisor ||--o{ Vendor : includes
```
...
stateDiagram-v2
    ...
    DepartmentHead --> ExecutiveCommittee: ExecutiveCommittee
    ExecutiveCommittee --> FinanceAdvisor: FinanceAdvisor
    FinanceAdvisor --> ValidationCheck: needs review
    ValidationCheck --> ExecutiveCommittee: corrections needed
    ValidationCheck --> Vendor: approved
    ValidationCheck --> Vendor: Vendor
    Vendor --> HRDepartment: HRDepartment
    HRDepartment --> [*]
```
