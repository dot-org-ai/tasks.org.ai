...
```mermaid
erDiagram
    GreenOperatingBudget ||--o{ RenewableEnergyProject : "funds"
    RenewableEnergyProject ||--o{ IncentiveCredit : "claims"
    GreenOperatingBudget ||--o{ CarbonOffset : "purchases"
    EnergyProductionForecast ||--|| GreenOperatingBudget : "projects"
    MaintenanceSchedule ||--o{ RenewableEnergyProject : "services"
    IncentiveCredit ||--|| GreenOperatingBudget : "reduces"
```
...
stateDiagram-v2
    ...
    ProductionForecasted --> CostsEstimated : operatingCostsEstimated
    CostsEstimated --> IncentivesCalculated : incentivesCalculated
    IncentivesCalculated --> OffsetsBudgeted : carbonOffsetssBudgeted
    OffsetsBudgeted --> BudgetCompiled : greenBudgetCompiled
    BudgetCompiled --> SubmittedForReview : budgetSubmittedForReview
    SubmittedForReview --> ProductionForecasted : energyProductionForecasted
    SubmittedForReview --> ComplianceVerified : incentiveComplianceVerified
    ComplianceVerified --> [*]
```
