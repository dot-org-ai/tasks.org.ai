...
```mermaid
erDiagram
    UtilityCompany ||--o{ GovernmentIncentiveProgram : includes
    GovernmentIncentiveProgram }o--|| EquipmentSupplier : "relates to"
    GovernmentIncentiveProgram }o--|| EnvironmentalRegulator : "relates to"
    GovernmentIncentiveProgram }o--|| CarbonMarketBroker : "relates to"
    EquipmentSupplier }o--|| EnvironmentalRegulator : "relates to"
    EquipmentSupplier }o--|| CarbonMarketBroker : "relates to"
    EnvironmentalRegulator }o--|| CarbonMarketBroker : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> UtilityCompany: UtilityCompany
    UtilityCompany --> GovernmentIncentiveProgram: GovernmentIncentiveProgram
    GovernmentIncentiveProgram --> EquipmentSupplier: EquipmentSupplier
    EquipmentSupplier --> ValidationCheck: needs review
    ValidationCheck --> GovernmentIncentiveProgram: corrections needed
    ValidationCheck --> EnvironmentalRegulator: approved
    ValidationCheck --> EnvironmentalRegulator: EnvironmentalRegulator
    EnvironmentalRegulator --> CarbonMarketBroker: CarbonMarketBroker
    CarbonMarketBroker --> [*]
```
