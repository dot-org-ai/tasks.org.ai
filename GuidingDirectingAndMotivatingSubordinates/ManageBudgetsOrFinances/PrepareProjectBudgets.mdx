...
```mermaid
erDiagram
    ProjectSponsor ||--o{ Subcontractor : includes
    ProjectSponsor ||--o{ SubjectMatterExpert : contains
    Subcontractor ||--o{ ProcurementOffice : includes
    Subcontractor ||--o{ SubjectMatterExpert : contains
    ProcurementOffice ||--o{ SubjectMatterExpert : contains
    SubjectMatterExpert }o--|| ClientOrganization : "relates to"
```
...
stateDiagram-v2
    ...
    ProjectSponsor --> Subcontractor: Subcontractor
    Subcontractor --> ProcurementOffice: ProcurementOffice
    ProcurementOffice --> ValidationCheck: needs review
    ValidationCheck --> Subcontractor: corrections needed
    ValidationCheck --> SubjectMatterExpert: approved
    ValidationCheck --> SubjectMatterExpert: SubjectMatterExpert
    SubjectMatterExpert --> ClientOrganization: ClientOrganization
    ClientOrganization --> [*]
```
