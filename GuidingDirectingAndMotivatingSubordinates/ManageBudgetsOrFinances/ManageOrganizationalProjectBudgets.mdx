...
```mermaid
erDiagram
    FinanceTeam ||--o{ DepartmentHeads : includes
    DepartmentHeads }o--|| ExecutiveLeadership : "relates to"
    DepartmentHeads }o--|| Auditor : "relates to"
    DepartmentHeads }o--|| Controller : "relates to"
    DepartmentHeads }o--|| Vendor : "relates to"
    ExecutiveLeadership ||--o{ Auditor : includes
    Controller }o--|| Vendor : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> FinanceTeam: FinanceTeam
    FinanceTeam --> DepartmentHeads: DepartmentHeads
    DepartmentHeads --> ExecutiveLeadership: ExecutiveLeadership
    ExecutiveLeadership --> ValidationCheck: needs review
    ValidationCheck --> DepartmentHeads: corrections needed
    ValidationCheck --> Auditor: approved
    ValidationCheck --> Auditor: Auditor
