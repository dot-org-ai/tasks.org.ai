...
```mermaid
erDiagram
    SupplyVendor }o--|| Client : "relates to"
    SupplyVendor }o--|| Landlord : "relates to"
    SupplyVendor }o--|| AccountingFirm : "relates to"
    SupplyVendor }o--|| LicensingBoard : "relates to"
    Client ||--o{ Landlord : includes
    Landlord ||--o{ AccountingFirm : includes
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> SupplyVendor: SupplyVendor
    SupplyVendor --> Client: Client
    Client --> Landlord: Landlord
    Landlord --> ValidationCheck: needs review
    ValidationCheck --> Client: corrections needed
    ValidationCheck --> AccountingFirm: approved
    ValidationCheck --> AccountingFirm: AccountingFirm
    AccountingFirm --> LicensingBoard: LicensingBoard
    LicensingBoard --> [*]
```
