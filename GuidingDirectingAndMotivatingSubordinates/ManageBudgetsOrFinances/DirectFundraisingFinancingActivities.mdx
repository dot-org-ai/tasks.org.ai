...
```mermaid
erDiagram
    Donor ||--o{ GrantMaker : includes
    GrantMaker ||--o{ CorporateSponsor : includes
    CorporateSponsor }o--|| FinancialInstitution : "relates to"
    CorporateSponsor }o--|| RegulatoryAuthority : "relates to"
    FinancialInstitution }o--|| RegulatoryAuthority : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Donor: Donor
    Donor --> GrantMaker: GrantMaker
    GrantMaker --> CorporateSponsor: CorporateSponsor
    CorporateSponsor --> ValidationCheck: needs review
    ValidationCheck --> GrantMaker: corrections needed
    ValidationCheck --> FinancialInstitution: approved
    ValidationCheck --> FinancialInstitution: FinancialInstitution
    FinancialInstitution --> RegulatoryAuthority: RegulatoryAuthority
    RegulatoryAuthority --> [*]
```
