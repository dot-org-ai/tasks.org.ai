...
```mermaid
erDiagram
    CorrectionalOfficer ||--|| ShiftCommander : follows
    CorrectionalOfficer }o--|| CentralControl : generates
    CorrectionalOfficer ||--|{ Inmate : requires
    CorrectionalOfficer ||--o{ StateOversightAgency : tracks
    ShiftCommander ||--|{ CorrectionalOfficer : creates
    CentralControl ||--o{ CorrectionalOfficer : documents
    Inmate ||--|| CorrectionalOfficer : supports
```
...
stateDiagram-v2
    ...
    Correctional_Officer --> Shift_Commander: ShiftCommander
    Shift_Commander --> Central_Control: CentralControl
    Central_Control --> Inmate: Inmate
    Inmate --> State_Oversight_Agency: StateOversightAgency
    Central_Control --> Shift_Commander: CentralControl
    State_Oversight_Agency --> [*]
```
