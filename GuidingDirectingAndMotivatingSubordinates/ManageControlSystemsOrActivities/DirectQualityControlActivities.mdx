...
```mermaid
erDiagram
    Customer ||--o{ Supplier : includes
    Supplier ||--o{ CertificationBody : includes
    CertificationBody ||--o{ RegulatoryAgency : includes
    RegulatoryAgency }o--|| ProductionTeam : "relates to"
    RegulatoryAgency }o--|| EquipmentCalibrationService : "relates to"
```
...
stateDiagram-v2
    ...
    Supplier --> CertificationBody: CertificationBody
    CertificationBody --> ValidationCheck: needs review
    ValidationCheck --> Supplier: corrections needed
    ValidationCheck --> RegulatoryAgency: approved
    ValidationCheck --> RegulatoryAgency: RegulatoryAgency
    RegulatoryAgency --> ProductionTeam: ProductionTeam
    ProductionTeam --> EquipmentCalibrationService: EquipmentCalibrationService
