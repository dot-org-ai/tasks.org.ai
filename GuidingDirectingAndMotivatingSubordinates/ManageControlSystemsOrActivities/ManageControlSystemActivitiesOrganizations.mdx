...
```mermaid
erDiagram
    ExternalAuditor ||--o{ RegulatoryBody : includes
    RegulatoryBody ||--o{ BoardOfDirectors : includes
    BoardOfDirectors ||--o{ InsuranceUnderwriter : includes
    TechnologyVendor }o--|| BusinessPartner : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> ExternalAuditor: ExternalAuditor
    ExternalAuditor --> RegulatoryBody: RegulatoryBody
    RegulatoryBody --> BoardOfDirectors: BoardOfDirectors
    BoardOfDirectors --> ValidationCheck: needs review
    ValidationCheck --> RegulatoryBody: corrections needed
    ValidationCheck --> InsuranceUnderwriter: approved
    ValidationCheck --> InsuranceUnderwriter: InsuranceUnderwriter
    InsuranceUnderwriter --> TechnologyVendor: TechnologyVendor
    TechnologyVendor --> BusinessPartner: BusinessPartner
    BusinessPartner --> [*]
```
