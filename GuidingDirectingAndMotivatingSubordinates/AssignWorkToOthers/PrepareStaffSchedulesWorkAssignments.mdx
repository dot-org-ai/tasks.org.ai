...
```mermaid
erDiagram
    Employee }o--|| LaborRegulator : "relates to"
    Employee }o--|| StaffingAgency : "relates to"
    Employee }o--|| PayrollProvider : "relates to"
    LaborRegulator }o--|| StaffingAgency : "relates to"
    LaborRegulator }o--|| PayrollProvider : "relates to"
    StaffingAgency ||--o{ PayrollProvider : includes
```
...
stateDiagram-v2
    ...
    Employee --> LaborRegulator: LaborRegulator
    LaborRegulator --> StaffingAgency: StaffingAgency
    StaffingAgency --> PayrollProvider: PayrollProvider
    PayrollProvider --> [*]
```
