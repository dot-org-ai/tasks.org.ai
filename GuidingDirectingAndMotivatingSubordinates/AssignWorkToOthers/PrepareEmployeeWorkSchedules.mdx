...
```mermaid
erDiagram
    Employee ||--o{ LaborAuthority : includes
    Employee ||--o{ UnionRepresentative : contains
    LaborAuthority }o--|| UnionRepresentative : "relates to"
    LaborAuthority }o--|| PayrollSystem : "relates to"
    UnionRepresentative }o--|| PayrollSystem : "relates to"
```
...
stateDiagram-v2
    ...
    Employee --> LaborAuthority: LaborAuthority
    LaborAuthority --> UnionRepresentative: UnionRepresentative
    UnionRepresentative --> PayrollSystem: PayrollSystem
    PayrollSystem --> [*]
```
