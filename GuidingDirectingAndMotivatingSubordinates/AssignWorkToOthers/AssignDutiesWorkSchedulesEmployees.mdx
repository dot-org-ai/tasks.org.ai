...
```mermaid
erDiagram
    Employee ||--o{ HRDepartment : includes
    HRDepartment ||--o{ UnionSteward : includes
    UnionSteward }o--|| OperationsCenter : "relates to"
```
...
stateDiagram-v2
    ...
    Employee --> HRDepartment: HRDepartment
    HRDepartment --> UnionSteward: UnionSteward
    UnionSteward --> OperationsCenter: OperationsCenter
    OperationsCenter --> [*]
```
