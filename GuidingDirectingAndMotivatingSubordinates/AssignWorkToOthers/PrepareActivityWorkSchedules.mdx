...
```mermaid
erDiagram
    Stakeholder ||--o{ ExternalContractor : includes
    ExternalContractor ||--o{ FacilityManager : includes
    FacilityManager ||--o{ ClientOrganization : includes
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Stakeholder: Stakeholder
    Stakeholder --> ExternalContractor: ExternalContractor
    ExternalContractor --> FacilityManager: FacilityManager
    FacilityManager --> ClientOrganization: ClientOrganization
    ClientOrganization --> [*]
```
