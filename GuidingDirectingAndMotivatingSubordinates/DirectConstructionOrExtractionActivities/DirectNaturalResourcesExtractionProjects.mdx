...
```mermaid
erDiagram
    MiningRegulatoryAgency }o--|| EnvironmentalProtectionAgency : "relates to"
    MiningRegulatoryAgency }o--|| LandownerLeaseholder : "relates to"
    MiningRegulatoryAgency }o--|| EquipmentManufacturer : "relates to"
    MiningRegulatoryAgency }o--|| GeologicalSurveyFirm : "relates to"
    MiningRegulatoryAgency }o--|| TransportationCarrier : "relates to"
    EnvironmentalProtectionAgency }o--|| LandownerLeaseholder : "relates to"
    EnvironmentalProtectionAgency }o--|| EquipmentManufacturer : "relates to"
    EnvironmentalProtectionAgency }o--|| GeologicalSurveyFirm : "relates to"
    EnvironmentalProtectionAgency }o--|| TransportationCarrier : "relates to"
    LandownerLeaseholder }o--|| EquipmentManufacturer : "relates to"
    LandownerLeaseholder }o--|| GeologicalSurveyFirm : "relates to"
    LandownerLeaseholder }o--|| TransportationCarrier : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> MiningRegulatoryAgency: MiningRegulatoryAgency
    MiningRegulatoryAgency --> EnvironmentalProtectionAgency: EnvironmentalProtectionAgency
    EnvironmentalProtectionAgency --> LandownerLeaseholder: LandownerLeaseholder
    LandownerLeaseholder --> ValidationCheck: needs review
    ValidationCheck --> EnvironmentalProtectionAgency: corrections needed
    ValidationCheck --> EquipmentManufacturer: approved
    ValidationCheck --> EquipmentManufacturer: EquipmentManufacturer
    EquipmentManufacturer --> GeologicalSurveyFirm: GeologicalSurveyFirm
    GeologicalSurveyFirm --> TransportationCarrier: TransportationCarrier
