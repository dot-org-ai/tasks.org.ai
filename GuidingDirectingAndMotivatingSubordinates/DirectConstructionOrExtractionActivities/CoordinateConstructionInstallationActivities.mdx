...
erDiagram
    ...
    Subcontractor }o--|| PropertyOwner : "relates to"
    Subcontractor }o--|| UtilityProvider : "relates to"
    MaterialSupplier ||--o{ BuildingInspector : includes
    BuildingInspector }o--|| PropertyOwner : "relates to"
    BuildingInspector }o--|| UtilityProvider : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> Subcontractor: Subcontractor
    Subcontractor --> MaterialSupplier: MaterialSupplier
    MaterialSupplier --> BuildingInspector: BuildingInspector
    BuildingInspector --> ValidationCheck: needs review
    ValidationCheck --> MaterialSupplier: corrections needed
    ValidationCheck --> PropertyOwner: approved
    ValidationCheck --> PropertyOwner: PropertyOwner
    PropertyOwner --> UtilityProvider: UtilityProvider
    UtilityProvider --> [*]
```
