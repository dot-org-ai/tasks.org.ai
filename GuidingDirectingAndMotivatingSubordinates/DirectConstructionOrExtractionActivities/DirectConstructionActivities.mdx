...
```mermaid
erDiagram
    GeneralContractor ||--o{ Subcontractor : includes
    Subcontractor }o--|| BuildingInspector : "relates to"
    Subcontractor }o--|| ArchitectOfRecord : "relates to"
    Subcontractor }o--|| MaterialSupplier : "relates to"
    Subcontractor }o--|| ProjectOwner : "relates to"
    BuildingInspector }o--|| ArchitectOfRecord : "relates to"
    BuildingInspector }o--|| MaterialSupplier : "relates to"
    BuildingInspector }o--|| ProjectOwner : "relates to"
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> GeneralContractor: GeneralContractor
    GeneralContractor --> Subcontractor: Subcontractor
    Subcontractor --> BuildingInspector: BuildingInspector
    BuildingInspector --> ValidationCheck: needs review
    ValidationCheck --> Subcontractor: corrections needed
    ValidationCheck --> ArchitectOfRecord: approved
    ValidationCheck --> ArchitectOfRecord: ArchitectOfRecord
    ArchitectOfRecord --> MaterialSupplier: MaterialSupplier
    MaterialSupplier --> ProjectOwner: ProjectOwner
    ProjectOwner --> [*]
```
