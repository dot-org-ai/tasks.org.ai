...
```mermaid
erDiagram
    ArchitectOfRecord ||--o{ GeneralContractor : includes
    GeneralContractor }o--|| RegulatoryAgency : "relates to"
    GeneralContractor }o--|| Lender : "relates to"
    GeneralContractor }o--|| EngineeringConsultant : "relates to"
    RegulatoryAgency ||--o{ Lender : includes
```
...
stateDiagram-v2
    [*] --> Initiated
    Initiated --> ArchitectOfRecord: ArchitectOfRecord
    ArchitectOfRecord --> GeneralContractor: GeneralContractor
    GeneralContractor --> RegulatoryAgency: RegulatoryAgency
    RegulatoryAgency --> ValidationCheck: needs review
    ValidationCheck --> GeneralContractor: corrections needed
    ValidationCheck --> Lender: approved
    ValidationCheck --> Lender: Lender
    Lender --> EngineeringConsultant: EngineeringConsultant
