...
erDiagram
    ...
    RecoveryPlan ||--o{ Assessment : "evaluated via"
    Assessment ||--o{ WoundStatus : "includes"
    Assessment ||--o{ Complication : "may detect"
    Milestone }o--|| Assessment : "verified by"
    Complication }o--|| FollowUpVisit : "triggers"
    Milestone }o--|| FollowUpVisit : "scheduled at"
    RecoveryPlan ||--o{ FollowUpVisit : "includes"
```
...
stateDiagram-v2
    [*] --> PostProcedure
    PostProcedure --> Assessed : recoveryAssessed
    Assessed --> WoundChecked : woundInspected
    WoundChecked --> Recovering : complianceTracked
    WoundChecked --> ComplicationFound : complicationDetected
    Recovering --> MilestoneHit : milestoneAchieved
    ComplicationFound --> PlanRevised : planUpdated
    PlanRevised --> FollowUpSet : followUpScheduled
    MilestoneHit --> FullyRecovered : allMilestonesComplete
    MilestoneHit --> FollowUpSet : followUpScheduled
    Recovering --> FollowUpSet : followUpScheduled
    FollowUpSet --> Assessed : recoveryAssessed
```
