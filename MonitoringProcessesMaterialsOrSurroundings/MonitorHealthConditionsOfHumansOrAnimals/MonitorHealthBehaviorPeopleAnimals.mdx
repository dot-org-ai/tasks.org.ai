...
```mermaid
erDiagram
    Subject ||--|{ Observation : "subject of"
    Subject ||--o{ HealthMetric : "measured by"
    Subject ||--o{ BehaviorPattern : "exhibits"
    Observation ||--o{ HealthMetric : "captures"
    Observation }o--|| StudyProtocol : "guided by"
    BehaviorPattern }o--|| Observation : "identified from"
    Alert }o--|| HealthMetric : "triggered by"
    Alert }o--|| BehaviorPattern : "triggered by"
```
...
stateDiagram-v2
    ...
    Observed --> VitalsLogged : vitalsMeasured
    VitalsLogged --> Evaluated : wellbeingAssessed
    Evaluated --> Normal : noAnomaly
    Evaluated --> AnomalyFound : anomalyDetected
    Normal --> Compared : comparisonCompleted
    AnomalyFound --> Critical : criticalConditionRaised
    AnomalyFound --> ProtocolRevised : protocolUpdated
    Critical --> ProtocolRevised : protocolUpdated
    ProtocolRevised --> Monitoring : observationRecorded
    Compared --> Monitoring : observationRecorded
```
