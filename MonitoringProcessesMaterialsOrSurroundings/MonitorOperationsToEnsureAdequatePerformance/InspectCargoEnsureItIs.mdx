...
```mermaid
erDiagram
    CargoInspection ||--|{ InspectionFinding : "produces"
    CargoInspection ||--|| LoadingPlan : "verifies"
    LoadingPlan ||--|{ SecuringDevice : "specifies"
    InspectionFinding ||--o{ ViolationReport : "may escalate to"
    CargoInspection ||--o| InspectionCertificate : "may issue"
    SecuringDevice }o--|| InspectionFinding : "assessed in"
    ViolationReport }o--|| CargoInspection : "documented in"
```
...
stateDiagram-v2
    ...
    InspectionStarted --> SecuringChecked : securingVerified
    SecuringChecked --> WeightChecked : weightDistributionChecked
    WeightChecked --> IssueFound : findingRecorded
    WeightChecked --> ReadyForApproval : noIssues
    IssueFound --> CorrectionPending : correctionRequested
    CorrectionPending --> SecuringChecked : corrected
    CorrectionPending --> Rejected : loadRejected
    ReadyForApproval --> Approved : loadApproved
```
