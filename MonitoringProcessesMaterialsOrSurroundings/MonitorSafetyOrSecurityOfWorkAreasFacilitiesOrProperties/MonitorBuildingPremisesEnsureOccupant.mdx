...
```mermaid
erDiagram
    Patrol ||--o{ Incident : discovers
    Patrol }o--|| SafetyInspection : "part of"
    SafetyEquipment ||--|| SafetyInspection : "checked during"
    Incident ||--o{ HazardReport : generates
    OccupancyRecord }o--|| SafetyInspection : "reviewed during"
    HazardReport ||--|{ SafetyEquipment : "may involve"
```
...
stateDiagram-v2
    ...
    Scheduled --> Patrolling : patrolCompleted
    Patrolling --> Inspected : equipmentInspected
    Inspected --> HazardFound : hazardDetected
    Inspected --> Safe : patrolCompleted
    HazardFound --> Logged : incidentLogged
    Logged --> Evacuating : evacuationOrdered
    Logged --> Remediating : hazardDetected
    Remediating --> Patrolling : patrolCompleted
    Safe --> Monitoring : occupancyExceeded
    Monitoring --> Patrolling : patrolCompleted
    Evacuating --> [*]
```
