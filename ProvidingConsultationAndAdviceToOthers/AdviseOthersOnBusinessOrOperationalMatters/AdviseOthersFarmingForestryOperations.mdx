...
```mermaid
erDiagram
    Farm ||--o| CropPlan : "managed by"
    ForestLand ||--o| TimberHarvestPlan : "managed by"
    Farm ||--|{ Regulation : "subject to"
    ForestLand ||--|{ Regulation : "subject to"
    CropPlan ||--o{ EquipmentRecommendation : "may require"
    TimberHarvestPlan ||--o{ EquipmentRecommendation : "may require"
    Regulation ||--|| Farm : constrains
```
...
stateDiagram-v2
    [*] --> OperationAssessed
    OperationAssessed --> CropAdvised : cropManagementRecommended
    OperationAssessed --> TimberAdvised : timberManagementRecommended
    CropAdvised --> ComplianceAdvised : complianceAdvised
    TimberAdvised --> ComplianceAdvised : complianceAdvised
    ComplianceAdvised --> EquipmentAdvised : equipmentRecommended
    EquipmentAdvised --> SustainabilityPlanned : sustainabilityPlanDeveloped
    SustainabilityPlanned --> Implementing : implementationSupported
    Implementing --> [*]
```
