...
```mermaid
erDiagram
    ConveyorLine ||--o{ MaterialLoad : transports
    ConveyorLine ||--o{ RoutingPath : follows
    ConveyorLine ||--o{ SpeedProfile : operates-at
    RoutingPath ||--o{ TransferPoint : connects-via
    ConveyorLine ||--o{ FlowMetric : measures
```
...
stateDiagram-v2
    [*] --> ConveyorLineStarted
    ConveyorLineStarted --> RoutingPathConfigured : routingPathConfigured
    RoutingPathConfigured --> ConveyorSpeedAdjusted : conveyorSpeedAdjusted
    ConveyorSpeedAdjusted --> MaterialLoadedOntoConveyor : materialLoadedOntoConveyor
    MaterialLoadedOntoConveyor --> MaterialFlowMonitored : materialFlowMonitored
    MaterialFlowMonitored --> ConveyorBlockageCleared : conveyorBlockageCleared
    ConveyorBlockageCleared --> MaterialFlowMonitored : materialFlowMonitored
    MaterialFlowMonitored --> MaterialLoadedOntoConveyor : materialLoadedOntoConveyor
    MaterialFlowMonitored --> ConveyorLineStopped : conveyorLineStopped
    ConveyorLineStopped --> [*]
```
