...
```mermaid
erDiagram
    MaterialInflow ||--o{ SortingProfile : relates-to
    SortingProfile ||--o{ ProcessedBale : relates-to
    ProcessedBale ||--o{ ContaminationReading : relates-to
    ContaminationReading ||--o{ EquipmentRun : relates-to
    EquipmentRun ||--o{ CommodityGrade : relates-to
```
...
stateDiagram-v2
    ...
    Material Inflow Received --> Sorting Profile Configured : sortingProfileConfigured
    Sorting Profile Configured --> Processing Line Fed : processingLineFed
    Processing Line Fed --> Contamination Levels Monitored : contaminationLevelsMonitored
    Contamination Levels Monitored --> Processed Material Baled : processedMaterialBaled
    Processed Material Baled --> Output Quality Graded : outputQualityGraded
    Output Quality Graded --> Equipment Jam Cleared : equipmentJamCleared
    Contamination Levels Monitored --> Processing Line Fed : revisionRequired
    Equipment Jam Cleared --> [*]
```
