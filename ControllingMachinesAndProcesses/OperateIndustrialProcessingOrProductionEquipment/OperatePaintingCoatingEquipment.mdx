...
```mermaid
erDiagram
    CoatingJob ||--o{ CoatingMaterial : relates-to
    CoatingMaterial ||--o{ ApplicationParameter : relates-to
    ApplicationParameter ||--o{ CuringProfile : relates-to
    CuringProfile ||--o{ ThicknessReading : relates-to
    ThicknessReading ||--o{ SurfaceDefect : relates-to
```
...
```mermaid
stateDiagram-v2
    [*] --> Coating Material Prepared
    Coating Material Prepared --> Spray Equipment Configured : sprayEquipmentConfigured
    Spray Equipment Configured --> Coating Applied : coatingApplied
    Coating Applied --> Coating Cured : coatingCured
    Coating Cured --> Coating Thickness Measured : coatingThicknessMeasured
    Coating Thickness Measured --> Finish Quality Inspected : finishQualityInspected
    Finish Quality Inspected --> Application Equipment Cleaned : applicationEquipmentCleaned
    Coating Cured --> Coating Applied : revisionRequired
    Application Equipment Cleaned --> [*]
```
