...
```mermaid
erDiagram
    Equipment ||--o{ ProductionRun : relates-to
    ProductionRun ||--o{ OperatingParameter : relates-to
    OperatingParameter ||--o{ MaintenanceRecord : relates-to
    MaintenanceRecord ||--o{ SafetyChecklist : relates-to
    SafetyChecklist ||--o{ OutputUnit : relates-to
```
...
stateDiagram-v2
    ...
    Pre Start Checks Completed --> Equipment Started : equipmentStarted
    Equipment Started --> Operating Parameters Set : operatingParametersSet
    Operating Parameters Set --> Equipment Performance Monitored : equipmentPerformanceMonitored
    Equipment Performance Monitored --> Operating Conditions Adjusted : operatingConditionsAdjusted
    Operating Conditions Adjusted --> Production Run Completed : productionRunCompleted
    Production Run Completed --> Equipment Shut Down : equipmentShutDown
    Equipment Performance Monitored --> Operating Parameters Set : revisionRequired
    Equipment Shut Down --> [*]
```
