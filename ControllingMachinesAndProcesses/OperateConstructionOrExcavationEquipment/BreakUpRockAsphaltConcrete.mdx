...
```mermaid
erDiagram
    BreakingJob ||--o{ BreakerUnit : relates-to
    BreakerUnit ||--o{ MaterialFragment : relates-to
    MaterialFragment ||--o{ DebrisLoadout : relates-to
    DebrisLoadout ||--o{ DustControlPlan : relates-to
    DustControlPlan ||--o{ BreakingPermit : relates-to
```
...
stateDiagram-v2
    [*] --> Material Assessed
    Material Assessed --> Breaking Tool Selected : breakingToolSelected
    Breaking Tool Selected --> Breaking Executed : breakingExecuted
    Breaking Executed --> Dust Controlled : dustControlled
    Dust Controlled --> Debris Loaded : debrisLoaded
    Debris Loaded --> Progress Inspected : progressInspected
    Progress Inspected --> Reinforcement Encountered : reinforcementEncountered
    Dust Controlled --> Breaking Executed : revisionRequired
    Reinforcement Encountered --> [*]
```
