...
```mermaid
erDiagram
    PavingProject ||--o{ AsphaltBatch : relates-to
    AsphaltBatch ||--o{ PavingPass : relates-to
    PavingPass ||--o{ CompactionRecord : relates-to
    CompactionRecord ||--o{ MillingPlan : relates-to
    MillingPlan ||--o{ SurfaceProfile : relates-to
```
...
```mermaid
stateDiagram-v2
    [*] --> Existing Surface Milled
    Existing Surface Milled --> Paver Loaded : paverLoaded
    Paver Loaded --> Asphalt Laid : asphaltLaid
    Asphalt Laid --> Surface Compacted : surfaceCompacted
    Surface Compacted --> Temperature Checked : temperatureChecked
    Temperature Checked --> Seal Coat Applied : sealCoatApplied
    Seal Coat Applied --> Surface Profile Measured : surfaceProfileMeasured
    Surface Compacted --> Asphalt Laid : revisionRequired
