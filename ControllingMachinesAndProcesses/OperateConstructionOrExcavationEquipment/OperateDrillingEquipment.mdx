...
```mermaid
erDiagram
    DrillingPlan ||--o{ DrillRig : relates-to
    DrillRig ||--o{ Borehole : relates-to
    Borehole ||--o{ DrillBit : relates-to
    DrillBit ||--o{ MudCirculation : relates-to
    MudCirculation ||--o{ CoreSample : relates-to
```
...
stateDiagram-v2
    [*] --> Drill Rig Setup
    Drill Rig Setup --> Drilling Commenced : drillingCommenced
    Drilling Commenced --> Drill Progress Updated : drillProgressUpdated
    Drill Progress Updated --> Drilling Fluid Circulated : drillingFluidCirculated
    Drilling Fluid Circulated --> Drill Bit Changed : drillBitChanged
    Drill Bit Changed --> Core Sample Extracted : coreSampleExtracted
    Core Sample Extracted --> Borehole Completed : boreholeCompleted
    Drilling Fluid Circulated --> Drill Progress Updated : revisionRequired
    Borehole Completed --> [*]
```
