...
```mermaid
erDiagram
    RawImage ||--o{ ProcessedImage : relates-to
    ProcessedImage ||--o{ ImageMetadata : relates-to
    ImageMetadata ||--o{ PACSRecord : relates-to
    PACSRecord ||--o{ ProcessingProtocol : relates-to
    ProcessingProtocol ||--o{ RejectAnalysis : relates-to
```
...
stateDiagram-v2
    [*] --> Image Developed
    Image Developed --> Image Enhanced : imageEnhanced
    Image Enhanced --> Metadata Verified : metadataVerified
    Metadata Verified --> Image Archived : imageArchived
    Image Archived --> Image Distributed : imageDistributed
    Image Distributed --> Image Rejected : imageRejected
    Image Rejected --> Quality Report Generated : qualityReportGenerated
    Image Archived --> Metadata Verified : revisionRequired
