...
```mermaid
erDiagram
    GrindingMachine ||--o{ GrindingWheel : mounts
    GrindingMachine ||--o{ MachineSetup : configures
    WorkOrder ||--o{ Workpiece : specifies
    GrindingMachine ||--o{ Workpiece : grinds
    Workpiece ||--o{ InspectionRecord : validates
```
...
```mermaid
stateDiagram-v2
    [*] --> GrinderSetupCompleted
    GrinderSetupCompleted --> GrindingCycleStarted : grindingCycleStarted
    GrindingCycleStarted --> WorkpieceMeasured : workpieceMeasured
    WorkpieceMeasured --> QualityDeviationDetected : qualityDeviationDetected
    QualityDeviationDetected --> ParametersAdjusted : parametersAdjusted
    ParametersAdjusted --> GrindingCycleStarted : grindingCycleStarted
    GrindingCycleStarted --> WheelDressed : wheelDressed
    WheelDressed --> GrindingCycleStarted : grindingCycleStarted
    WorkpieceMeasured --> OperationCompleted : operationCompleted
    OperationCompleted --> [*]
```
