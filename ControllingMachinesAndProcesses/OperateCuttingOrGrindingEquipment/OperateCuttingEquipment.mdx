...
```mermaid
erDiagram
    CuttingMachine ||--o{ CuttingTool : mounts
    WorkOrder ||--o{ CutProgram : specifies
    CutProgram ||--o{ Material : cuts
    CuttingMachine ||--o{ CutRecord : produces
    WorkOrder ||--o{ CutRecord : fulfills
```
...
```mermaid
stateDiagram-v2
    [*] --> CutterSetupCompleted
    CutterSetupCompleted --> CutProgramLoaded : cutProgramLoaded
    CutProgramLoaded --> CuttingCycleStarted : cuttingCycleStarted
    CuttingCycleStarted --> CutPieceMeasured : cutPieceMeasured
    CutPieceMeasured --> CuttingCycleStarted : cuttingCycleStarted
    CutPieceMeasured --> CutQualityIssueDetected : cutQualityIssueDetected
    CutQualityIssueDetected --> CutterSetupCompleted : cutterSetupCompleted
    CuttingCycleStarted --> ToolingReplaced : toolingReplaced
    ToolingReplaced --> CuttingCycleStarted : cuttingCycleStarted
    CutPieceMeasured --> CutJobCompleted : cutJobCompleted
    CutJobCompleted --> [*]
```
