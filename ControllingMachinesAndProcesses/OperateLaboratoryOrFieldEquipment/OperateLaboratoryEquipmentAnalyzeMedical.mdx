...
```mermaid
erDiagram
    Specimen ||--o{ TestOrder : relates-to
    TestOrder ||--o{ AnalyzerRun : relates-to
    AnalyzerRun ||--o{ TestResult : relates-to
    TestResult ||--o{ QualityControl : relates-to
    QualityControl ||--o{ CriticalValue : relates-to
```
...
stateDiagram-v2
    ...
    Specimen Accessioned --> Analyzer Loaded : analyzerLoaded
    Analyzer Loaded --> Analysis Completed : analysisCompleted
    Analysis Completed --> Results Reviewed : resultsReviewed
    Results Reviewed --> Critical Value Flagged : criticalValueFlagged
    Critical Value Flagged --> Report Released : reportReleased
    Report Released --> Quality Control Passed : qualityControlPassed
    Results Reviewed --> Analysis Completed : revisionRequired
