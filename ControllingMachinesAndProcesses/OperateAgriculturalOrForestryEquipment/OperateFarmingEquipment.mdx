...
```mermaid
erDiagram
    Equipment ||--o{ FieldTask : relates-to
    FieldTask ||--o{ Field : relates-to
    Field ||--o{ OperationLog : relates-to
    OperationLog ||--o{ MaintenanceSchedule : relates-to
    MaintenanceSchedule ||--o{ YieldRecord : relates-to
```
...
stateDiagram-v2
    [*] --> Equipment Assigned
    Equipment Assigned --> Field Operation Started : fieldOperationStarted
    Field Operation Started --> Field Operation Completed : fieldOperationCompleted
    Field Operation Completed --> Operating Hours Logged : operatingHoursLogged
    Operating Hours Logged --> Equipment Calibrated : equipmentCalibrated
    Equipment Calibrated --> Breakdown Reported : breakdownReported
    Breakdown Reported --> Maintenance Scheduled : maintenanceScheduled
    Operating Hours Logged --> Field Operation Completed : revisionRequired
