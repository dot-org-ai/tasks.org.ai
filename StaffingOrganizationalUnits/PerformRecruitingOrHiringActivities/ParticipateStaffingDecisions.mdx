...
```mermaid
erDiagram
    StaffingRequisition ||--|{ CandidateEvaluation : "produces"
    CandidateEvaluation ||--|| InterviewScorecard : "recorded in"
    CandidateEvaluation }o--|| SelectionRecommendation : "informs"
    SelectionRecommendation ||--o| StaffingDecision : "results in"
    HeadcountPlan ||--|{ StaffingRequisition : "authorizes"
    StaffingDecision }o--|| HeadcountPlan : "fills"
```
...
stateDiagram-v2
    [*] --> RequisitionReviewed
    RequisitionReviewed --> CandidateEvaluated : candidateEvaluated
    CandidateEvaluated --> ScorecardSubmitted : scorecardSubmitted
    ScorecardSubmitted --> CandidateEvaluated : candidateEvaluated
    ScorecardSubmitted --> RecommendationMade : recommendationMade
    RecommendationMade --> DecisionApproved : staffingDecisionApproved
    RecommendationMade --> IssueEscalated : staffingIssueEscalated
    IssueEscalated --> DecisionApproved : staffingDecisionApproved
    DecisionApproved --> [*]
```
