...
```mermaid
erDiagram
    JobRequisition ||--|{ SourcingChannel : "sourced via"
    JobRequisition ||--o{ ApplicationSubmission : "receives"
    SourcingChannel ||--o{ OutreachCampaign : "targets"
    ApplicationSubmission ||--o| CandidateProfile : "creates"
    CandidateProfile }o--|| TalentPool : "nurtured in"
    Referral ||--|| CandidateProfile : "recommends"
    OutreachCampaign }o--|| CandidateProfile : "attracts"
```
...
stateDiagram-v2
    ...
    CandidateSourced --> OutreachLaunched : outreachCampaignLaunched
    OutreachLaunched --> ApplicationScreened : applicationScreened
    ApplicationScreened --> PhoneScreened : phoneScreenCompleted
    ApplicationScreened --> PooledForFuture : candidateAddedToPool
    PhoneScreened --> Advanced : candidateAdvanced
    PhoneScreened --> PooledForFuture : candidateAddedToPool
    Advanced --> [*]
    PooledForFuture --> CandidateSourced : candidateSourced
```
