...
```mermaid
erDiagram
    CuttingTool ||--o{ SharpeningRecord : "tracked in"
    CuttingTool ||--|| ToolGeometry : "defined by"
    CuttingTool ||--o{ WearMeasurement : "assessed by"
    GrindingWheel ||--o{ GrindingSetup : "used in"
    GrindingSetup ||--o{ SharpeningRecord : "produces"
    ToolGeometry ||--o{ WearMeasurement : "compared against"
    WearMeasurement ||--o{ SharpeningRecord : "triggers"
```
...
stateDiagram-v2
    [*] --> InProduction
    InProduction --> WearInspected : toolWearInspected
    WearInspected --> InProduction : within limits
    WearInspected --> MethodSelected : grindingMethodSelected
    WearInspected --> Retired : toolRetired
    MethodSelected --> MachineReady : grindingMachineSetup
    MachineReady --> Sharpened : toolSharpened
    Sharpened --> Measured : toolGeometryMeasured
    Measured --> InProduction : toolReturnedToService
    Measured --> Sharpened : out of spec, re-grind
    Measured --> Retired : toolRetired
    Retired --> [*]
```
