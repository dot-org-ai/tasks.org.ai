...
```mermaid
erDiagram
    FamilyConference ||--|| TreatmentPlan : reviews
    FamilyConference ||--o{ ProgressReport : presents
    FamilyConference ||--o{ FamilyConcern : surfaces
    TreatmentPlan ||--|{ CareGoal : contains
    FamilyConcern }o--|| ConferenceNote : "recorded in"
    FamilyConference ||--o| ActionPlan : produces
    ActionPlan }o--|| ConferenceNote : "documented in"
```
...
stateDiagram-v2
    ...
    Scheduled --> ProgressShared : progressPresented
    ProgressShared --> PlanReview : treatmentPlanReviewed
    PlanReview --> ConcernDiscussion : concernsAddressed
    ConcernDiscussion --> GoalAdjustment : goalsModified
    ConcernDiscussion --> FamilyRoles : noConcerns
    GoalAdjustment --> FamilyRoles : familyInvolvementCoordinated
    FamilyRoles --> Documented : conferenceDocumented
    Documented --> FollowUpSet : followUpScheduled
    FollowUpSet --> [*]
    FollowUpSet --> Scheduled : nextConference
```
