...
```mermaid
erDiagram
    SourceDocument ||--|| TranslatedDocument : "translated into"
    TranslatedDocument ||--o| CertificationStatement : "certified by"
    TranslationMemory }o--|{ TranslatedDocument : "built from"
    GlossaryEntry }o--|| TranslationMemory : "stored in"
    InterpretationSession }o--|| SourceDocument : "interprets"
    LocalizationKit ||--|{ TranslatedDocument : bundles
    GlossaryEntry }o--|| SourceDocument : "derived from"
```
...
```mermaid
stateDiagram-v2
    [*] --> ScopeAssessed : scopeAssessed
    ScopeAssessed --> GlossaryReady : glossaryBuilt
    GlossaryReady --> Translated : documentTranslated
    Translated --> Localized : contentLocalized
    Localized --> UnderReview : translationReviewed
    UnderReview --> Localized : revisionsNeeded
    UnderReview --> Certified : translationCertified
    UnderReview --> Delivered : translationDelivered
    Certified --> Delivered : translationDelivered
    Delivered --> [*]
```
