...
```mermaid
erDiagram
    MarketIntelligence ||--o{ BenchmarkReport : "feeds"
    OperationalProcess ||--|{ PerformanceMetric : "measured by"
    BenchmarkReport ||--o{ ProcessUpdate : "identifies need for"
    ComplianceRequirement ||--|{ OperationalProcess : "constrains"
    ProcessUpdate ||--|| OperationalProcess : "modifies"
    PerformanceMetric }o--|| BenchmarkReport : "compared in"
```
...
stateDiagram-v2
    [*] --> IntelGathered
    IntelGathered --> ProcessReviewed : operationalProcessReviewed
    ProcessReviewed --> Benchmarked : benchmarkAnalyzed
    Benchmarked --> ChangeDocumented : processChangeDocumented
    Benchmarked --> InsightsSynthesized : insightsSynthesized
    ChangeDocumented --> InsightsSynthesized : insightsSynthesized
    InsightsSynthesized --> Distributed : knowledgeDistributed
    Distributed --> IntelGathered : marketIntelligenceTracked
    Benchmarked --> ComplianceAssessed : complianceImpactAssessed
    ComplianceAssessed --> ChangeDocumented
```
