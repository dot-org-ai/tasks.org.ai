...
```mermaid
erDiagram
    Statute ||--|{ Regulation : "enacted via"
    Regulation ||--|{ ComplianceObligation : "creates"
    RegulatoryUpdate ||--|| Regulation : "amends"
    ComplianceObligation ||--o{ PolicyRevision : "triggers"
    PolicyRevision }o--|| ComplianceCalendar : "scheduled in"
    ComplianceCalendar ||--|{ ComplianceObligation : "tracks"
```
...
stateDiagram-v2
    [*] --> Monitoring
    Monitoring --> ChangeDetected : regulatoryChangeMonitored
    ChangeDetected --> Interpreted : regulationInterpreted
    Interpreted --> ImpactAssessed : complianceImpactAssessed
    ImpactAssessed --> PolicyUpdated : internalPolicyUpdated
    ImpactAssessed --> Documented : regulatoryKnowledgeDocumented
    PolicyUpdated --> DeadlineScheduled : complianceDeadlineScheduled
    DeadlineScheduled --> ReviewConducted : complianceReviewConducted
    Documented --> ReviewConducted
    ReviewConducted --> Monitoring
```
