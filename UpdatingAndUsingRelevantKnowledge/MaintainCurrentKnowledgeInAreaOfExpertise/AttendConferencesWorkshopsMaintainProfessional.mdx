...
erDiagram
    ...
    AttendanceRequest ||--|| Conference : "targets"
    Conference ||--|{ SessionNotes : "produces"
    Workshop ||--|{ SessionNotes : "produces"
    SessionNotes }o--|| NetworkingContact : "references"
    Conference ||--o{ ContinuingEducationCredit : "awards"
    AttendanceRequest }o--|| ContinuingEducationCredit : "justifies"
```
...
stateDiagram-v2
    [*] --> EventDiscovered
    EventDiscovered --> ApprovalPending : requestApproval
    ApprovalPending --> EventDiscovered : denied
    ApprovalPending --> Registered : approvalGranted
    Registered --> InSession : sessionAttended
    InSession --> InsightsCaptured : insightsCaptured
    InsightsCaptured --> InSession : additionalSessions
    InsightsCaptured --> FindingsShared : findingsReported
    FindingsShared --> CreditsClaimed : creditsClaimed
    CreditsClaimed --> [*]
```
