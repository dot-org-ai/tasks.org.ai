...
```mermaid
erDiagram
    PracticeGuideline ||--|{ InterventionMethod : "recommends"
    SocialPolicy ||--o{ PracticeGuideline : "shapes"
    EthicsStandard ||--|| PracticeGuideline : "constrains"
    ClinicalSupervisionRecord ||--|{ LicensureRequirement : "satisfies"
    LicensureRequirement ||--|{ PracticeGuideline : "mandates knowledge of"
    InterventionMethod }o--|| ClinicalSupervisionRecord : "practiced in"
```
...
stateDiagram-v2
    [*] --> CompetencyReview
    CompetencyReview --> GapsFound : competenciesAssessed
    CompetencyReview --> Current : noGaps
    GapsFound --> GuidelinesReviewed : practiceGuidelinesReviewed
    GuidelinesReviewed --> TrainingCompleted : trainingAttended
    TrainingCompleted --> SupervisionDone : clinicalSupervisionCompleted
    SupervisionDone --> Documented : learningDocumented
    Current --> PolicyTracked : policyChangeTracked
    PolicyTracked --> EthicsUpdated : ethicsKnowledgeUpdated
    EthicsUpdated --> Documented
    Documented --> CompetencyReview
```
