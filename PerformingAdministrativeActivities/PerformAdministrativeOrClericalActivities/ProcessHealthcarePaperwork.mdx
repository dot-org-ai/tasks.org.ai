...
```mermaid
erDiagram
    PatientIntakeForm ||--|| MedicalRecord : "populatesData"
    MedicalRecord ||--|{ InsuranceClaim : "generatesClaimsFor"
    InsuranceClaim ||--o| RemittanceAdvice : "respondedWith"
    MedicalRecord ||--o{ ConsentForm : "authorizedBy"
    InsuranceClaim ||--o| PreauthorizationRequest : "requiresApprovalVia"
    RemittanceAdvice }o--|| InsuranceClaim : "adjudicates"
```
...
stateDiagram-v2
    [*] --> IntakeProcessing
    IntakeProcessing --> InsuranceCheck : intakeFormProcessed
    InsuranceCheck --> PreAuth : insuranceVerified
    InsuranceCheck --> PatientNotified : notCovered
    PreAuth --> RecordUpdate : preauthorizationRequested
    PreAuth --> PatientNotified : preAuthDenied
    RecordUpdate --> ClaimSubmission : medicalRecordUpdated
    ClaimSubmission --> RemittanceReview : claimSubmitted
    RemittanceReview --> Archived : remittanceProcessed
    RemittanceReview --> ClaimSubmission : claimDeniedAppeal
