...
```mermaid
erDiagram
    Violation ||--o| Warning : "resultsIn"
    Violation ||--o| Citation : "resultsIn"
    Violation ||--|| InspectionReport : "documentedIn"
    Citation ||--o| Appeal : "contestedVia"
    Appeal ||--|| ResolutionRecord : "decidedIn"
    Violation ||--|| ResolutionRecord : "closedBy"
    Warning }o--|| Violation : "addressesInitially"
```
...
stateDiagram-v2
    [*] --> Documented
    Documented --> WarningIssued : violationDocumented
    Documented --> CitationIssued : highSeverity
    WarningIssued --> Resolved : violationResolved
    WarningIssued --> CitationIssued : repeatOffense
    CitationIssued --> UnderAppeal : appealSubmitted
    CitationIssued --> Escalated : violationEscalated
    UnderAppeal --> Upheld : appealResolved
    UnderAppeal --> Voided : citationVoided
    Upheld --> Escalated : violationEscalated
    Escalated --> Resolved : violationResolved
    Voided --> [*]
    Resolved --> [*]
```
